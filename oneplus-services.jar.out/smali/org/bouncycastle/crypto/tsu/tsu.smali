...
# static fields
.field public static final oOa:Ljava/lang/String; = "org.bouncycastle.pkcs1.strict"

.field public static final pOa:Ljava/lang/String; = "org.bouncycastle.pkcs1.not_strict"

.field private static final qOa:I = 0xa
...
.field private wCa:Lorg/bouncycastle/crypto/zta;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;)V
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->mOa:[B

    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->wCa:Lorg/bouncycastle/crypto/zta;

    invoke-direct {p0}, Lorg/bouncycastle/crypto/tsu/tsu;->Kw()Z

    move-result p1

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->kOa:Z
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;I)V
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;[B)V
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->mOa:[B

    array-length p1, p2

    iput p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I
...
.method private qbh([BII)[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->jOa:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->wCa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v0, p1, p2, p3}, Lorg/bouncycastle/crypto/zta;->you([BII)[B

    move-result-object p1

    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->mOa:[B

    if-nez p2, :cond_0

    iget p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I

    new-array p2, p2, [B

    iget-object p3, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nCa:Ljava/security/SecureRandom;

    invoke-virtual {p3, p2}, Ljava/security/SecureRandom;->nextBytes([B)V

    :cond_0
    iget-boolean p3, p0, Lorg/bouncycastle/crypto/tsu/tsu;->kOa:Z

    array-length v0, p1

    iget-object v1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->wCa:Lorg/bouncycastle/crypto/zta;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nOa:[B

    :cond_2
    iget p3, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I

    invoke-static {p1, p3}, Lorg/bouncycastle/crypto/tsu/tsu;->bvj([BI)I

    move-result p3

    iget v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I
    ...
    :goto_1
    iget v3, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I
...
.method private rtg([BII)[B
    ...
    iget-boolean p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->kOa:Z
...
.method private ssp([BII)[B
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->jOa:Z
    ...
    :cond_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nCa:Ljava/security/SecureRandom;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nCa:Ljava/security/SecureRandom;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->wCa:Lorg/bouncycastle/crypto/zta;
...
.method public c()I
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->PMa:Z
...
.method public you([BII)[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->PMa:Z
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/wtn/hmo;->Wj()Ljava/security/SecureRandom;

    move-result-object v1

    iput-object v1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nCa:Ljava/security/SecureRandom;
    ...
    iput-boolean p2, p0, Lorg/bouncycastle/crypto/tsu/tsu;->jOa:Z

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->PMa:Z

    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->wCa:Lorg/bouncycastle/crypto/zta;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nOa:[B

    iget p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->lOa:I

    if-lez p1, :cond_3

    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/tsu;->mOa:[B

    if-nez p1, :cond_3

    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/tsu;->nCa:Ljava/security/SecureRandom;
