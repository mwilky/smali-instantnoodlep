...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->JDa:Lorg/bouncycastle/crypto/rtg;

    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->JDa:Lorg/bouncycastle/crypto/rtg;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/rtg;->getBlockSize()I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I

    iget p1, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I

    new-array v0, p1, [B

    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->LNa:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->TNa:[B

    const/4 p1, 0x0

    iput p1, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
...
.method private Lw()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->LNa:[B

    array-length v0, v0

    iget v1, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I
    ...
    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/kth;->LNa:[B
...
.method private l(J)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I

    int-to-long v0, v0

    add-long/2addr v0, p1

    iget v2, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/bio/kth;->ad(I)V
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/bio/kth;->_c(I)V

    iget v2, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/bio/kth;->Zc(I)V
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/crypto/bio/kth;->Zc(I)V
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
    ...
    iget p2, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I

    add-int/2addr p2, p1

    iput p2, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
...
.method public getBlockSize()I
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/kth;->JDa:Lorg/bouncycastle/crypto/rtg;
...
.method public getPosition()J
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/kth;->LNa:[B
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->JDa:Lorg/bouncycastle/crypto/rtg;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/rtg;->reset()V

    iput v1, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
...
.method protected sis(B)B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/kth;->TNa:[B

    invoke-interface {v0, v2, v1, v3, v1}, Lorg/bouncycastle/crypto/rtg;->zta([BI[BI)I

    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->TNa:[B

    iget v1, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/bouncycastle/crypto/bio/kth;->QNa:I
    ...
    :cond_0
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/kth;->TNa:[B
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/bio/kth;->ad(I)V

    invoke-direct {p0}, Lorg/bouncycastle/crypto/bio/kth;->Lw()V
...
.method public skip(J)J
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/kth;->TNa:[B
...
.method public zta([BI[BI)I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/bio/kth;->tNa:I
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->LNa:[B
