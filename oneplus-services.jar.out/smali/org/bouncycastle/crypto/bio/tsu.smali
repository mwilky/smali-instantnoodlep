...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->JDa:Lorg/bouncycastle/crypto/rtg;

    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/tsu;->JDa:Lorg/bouncycastle/crypto/rtg;

    div-int/lit8 p2, p2, 0x8

    iput p2, p0, Lorg/bouncycastle/crypto/bio/tsu;->tNa:I
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/tsu;->LNa:[B
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/tsu;->MNa:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/tsu;->NNa:[B

    iget p1, p0, Lorg/bouncycastle/crypto/bio/tsu;->tNa:I

    new-array p1, p1, [B

    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/tsu;->ONa:[B
...
.method private rtg(B)B
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->QNa:I

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->JDa:Lorg/bouncycastle/crypto/rtg;

    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/tsu;->MNa:[B

    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/tsu;->NNa:[B

    invoke-interface {v0, v2, v1, v3, v1}, Lorg/bouncycastle/crypto/rtg;->zta([BI[BI)I

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->ONa:[B

    iget v2, p0, Lorg/bouncycastle/crypto/bio/tsu;->QNa:I

    aput-byte p1, v0, v2

    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->NNa:[B

    add-int/lit8 v3, v2, 0x1

    iput v3, p0, Lorg/bouncycastle/crypto/bio/tsu;->QNa:I
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/bio/tsu;->tNa:I

    if-ne v0, v2, :cond_1

    iput v1, p0, Lorg/bouncycastle/crypto/bio/tsu;->QNa:I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/bio/tsu;->tNa:I
...
.method public _j()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/tsu;->MNa:[B
...
.method public irq()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/tsu;->JDa:Lorg/bouncycastle/crypto/rtg;
...
.method public reset()V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/tsu;->MNa:[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/tsu;->JDa:Lorg/bouncycastle/crypto/rtg;
...
.method protected sis(B)B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/bio/tsu;->PNa:Z
...
.method public sis([BI[BI)I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/bio/tsu;->tNa:I
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/crypto/bio/tsu;->PNa:Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/tsu;->LNa:[B
