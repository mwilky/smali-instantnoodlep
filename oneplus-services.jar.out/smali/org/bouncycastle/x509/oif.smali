...
.field private final lWa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

.field private mWa:Lorg/bouncycastle/asn1/x509/k;

.field private nWa:Lorg/bouncycastle/asn1/bvj;

.field private rWa:Lorg/bouncycastle/asn1/x509/p;

.field private uGa:Lorg/bouncycastle/asn1/x509/zta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->lWa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

    new-instance v0, Lorg/bouncycastle/asn1/x509/k;

    invoke-direct {v0}, Lorg/bouncycastle/asn1/x509/k;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->mWa:Lorg/bouncycastle/asn1/x509/k;

    new-instance v0, Lorg/bouncycastle/asn1/x509/p;

    invoke-direct {v0}, Lorg/bouncycastle/asn1/x509/p;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->rWa:Lorg/bouncycastle/asn1/x509/p;

    return-void
.end method

.method private Uw()Lorg/bouncycastle/asn1/x509/f;
    .locals 2

    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->rWa:Lorg/bouncycastle/asn1/x509/p;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->mWa:Lorg/bouncycastle/asn1/x509/k;

    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->rWa:Lorg/bouncycastle/asn1/x509/p;
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->mWa:Lorg/bouncycastle/asn1/x509/k;
...
.method private zta(Lorg/bouncycastle/asn1/x509/f;[B)Ljava/security/cert/X509Certificate;
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/oif;->uGa:Lorg/bouncycastle/asn1/x509/zta;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->lWa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;
...
.method public fm()Ljava/util/Iterator;
    ...
    invoke-static {}, Lorg/bouncycastle/x509/dma;->em()Ljava/util/Iterator;
...
.method public reset()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->rWa:Lorg/bouncycastle/asn1/x509/p;
...
.method public setSignatureAlgorithm(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/oif;->YFa:Ljava/lang/String;
    ...
    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->nWa:Lorg/bouncycastle/asn1/bvj;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->nWa:Lorg/bouncycastle/asn1/bvj;
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/oif;->uGa:Lorg/bouncycastle/asn1/x509/zta;

    iget-object p1, p0, Lorg/bouncycastle/x509/oif;->mWa:Lorg/bouncycastle/asn1/x509/k;

    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->uGa:Lorg/bouncycastle/asn1/x509/zta;
...
.method public you(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0}, Lorg/bouncycastle/x509/oif;->Uw()Lorg/bouncycastle/asn1/x509/f;

    move-result-object v0

    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->nWa:Lorg/bouncycastle/asn1/bvj;

    iget-object v2, p0, Lorg/bouncycastle/x509/oif;->YFa:Ljava/lang/String;
...
.method public zta(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->YFa:Ljava/lang/String;
