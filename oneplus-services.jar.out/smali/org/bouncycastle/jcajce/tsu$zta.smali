...
.method public constructor <init>(Ljava/security/cert/CRLSelector;)V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->UEa:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->VEa:Ljava/math/BigInteger;

    iput-object v1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->WEa:[B

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->XEa:Z
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->TSa:Ljava/security/cert/CRLSelector;
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/tsu$zta;)[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->WEa:[B
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/tsu$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->UEa:Z
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/tsu$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->XEa:Z
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/tsu$zta;)Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->VEa:Ljava/math/BigInteger;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/tsu$zta;)Ljava/security/cert/CRLSelector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/tsu$zta;->TSa:Ljava/security/cert/CRLSelector;
...
.method public cno([B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->WEa:[B
...
.method public ja(Z)Lorg/bouncycastle/jcajce/tsu$zta;
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->UEa:Z
...
.method public la(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->XEa:Z
...
.method public sis(Ljava/math/BigInteger;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/tsu$zta;->VEa:Ljava/math/BigInteger;
