...
.field private final DEa:Z

.field private final LSa:Ljava/security/cert/PKIXParameters;

.field private final MSa:Lorg/bouncycastle/jcajce/cno;

.field private final NSa:Ljava/util/List;
...
.field private final OSa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private final QSa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/bouncycastle/asn1/x509/zgw;",
...
.field private final SSa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method private constructor <init>(Lorg/bouncycastle/jcajce/wtn$zta;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->LSa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->NSa:Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->OSa:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->PSa:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn;->SSa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn;->CEa:I
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->QSa:Ljava/util/Map;
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->DEa:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->OSa:Ljava/util/Map;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->MSa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->PSa:Ljava/util/List;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->NSa:Ljava/util/List;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->LSa:Ljava/security/cert/PKIXParameters;
...
# virtual methods
.method public _g()Lorg/bouncycastle/jcajce/cno;
    .locals 0
...
.method public getTrustAnchors()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->SSa:Ljava/util/Set;
...
.method public isRevocationEnabled()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->RSa:Z
