...
.field private final VSa:Lorg/bouncycastle/jcajce/cno;

.field private final WSa:Ljava/util/List;
...
.field private final XSa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private final YSa:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private final ZSa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/bouncycastle/asn1/x509/zgw;",
...
.field private final _Sa:Z

.field private final aTa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method private constructor <init>(Lorg/bouncycastle/jcajce/wtn$zta;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->USa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->WSa:Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->XSa:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->YSa:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn;->aTa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn;->LEa:I
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->ZSa:Ljava/util/Map;
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->MEa:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->XSa:Ljava/util/Map;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->VSa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->YSa:Ljava/util/List;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->WSa:Ljava/util/List;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->USa:Ljava/security/cert/PKIXParameters;
...
# virtual methods
.method public ah()Lorg/bouncycastle/jcajce/cno;
    .locals 0
...
.method public getTrustAnchors()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->aTa:Ljava/util/Set;
...
.method public isRevocationEnabled()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->_Sa:Z
...
.method public yk()Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
