...
.method constructor <init>(Lcom/android/server/policy/OpQuickPay;I)V
    ...
    iput p2, p0, Lcom/android/server/policy/cgv;->yP:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget v1, v8, Lcom/android/server/policy/cgv;->uP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/cgv;->wP:F
    ...
    iget v1, v8, Lcom/android/server/policy/cgv;->vP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/cgv;->xP:F
    ...
    iget v2, v8, Lcom/android/server/policy/cgv;->vP:I
    ...
    :cond_5
    iget-object v2, v2, Lcom/android/server/policy/OpQuickPay$zta;->CP:Ljava/lang/String;
    ...
    iget v0, v8, Lcom/android/server/policy/cgv;->yP:I
    ...
    iget v1, v8, Lcom/android/server/policy/cgv;->yP:I
    ...
    iput v1, v8, Lcom/android/server/policy/cgv;->uP:I

    iget v0, v0, Landroid/view/WindowManager$LayoutParams;->y:I

    iput v0, v8, Lcom/android/server/policy/cgv;->vP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/cgv;->wP:F

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/cgv;->xP:F
