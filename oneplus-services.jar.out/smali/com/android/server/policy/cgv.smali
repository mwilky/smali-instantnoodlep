...
.method constructor <init>(Lcom/android/server/policy/OpQuickPay;I)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/cgv;->this$0:Lcom/android/server/policy/OpQuickPay;

    iput p2, p0, Lcom/android/server/policy/cgv;->JP:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, v8, Lcom/android/server/policy/cgv;->this$0:Lcom/android/server/policy/OpQuickPay;

    iget-object v0, v0, Lcom/android/server/policy/OpQuickPay;->mWindowParams:Landroid/view/WindowManager$LayoutParams;

    iget v1, v8, Lcom/android/server/policy/cgv;->EP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/cgv;->GP:F
    ...
    iget v1, v8, Lcom/android/server/policy/cgv;->FP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/cgv;->HP:F
    ...
    iget-object v1, v8, Lcom/android/server/policy/cgv;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    iget v2, v8, Lcom/android/server/policy/cgv;->FP:I
    ...
    iget-object v2, v8, Lcom/android/server/policy/cgv;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    iget-object v4, v8, Lcom/android/server/policy/cgv;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    :cond_5
    iget-object v2, v2, Lcom/android/server/policy/OpQuickPay$zta;->NP:Ljava/lang/String;
    ...
    iget v0, v8, Lcom/android/server/policy/cgv;->JP:I
    ...
    iget v1, v8, Lcom/android/server/policy/cgv;->JP:I
    ...
    iput v1, v8, Lcom/android/server/policy/cgv;->EP:I

    iget v0, v0, Landroid/view/WindowManager$LayoutParams;->y:I

    iput v0, v8, Lcom/android/server/policy/cgv;->FP:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/cgv;->GP:F

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/cgv;->HP:F
