...
.field private mHandler:Lcom/android/server/obl$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/obl;->gf:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/obl;->hf:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/obl;->if:Landroid/util/ArrayMap;

    const-class v0, Lcom/android/server/obl;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/server/obl;->TAG:Ljava/lang/String;

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/obl;->DEBUG:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/obl;->We:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/obl;->bf:Ljava/util/ArrayList;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/android/server/obl;->cf:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/obl;->df:Z

    iput v0, p0, Lcom/android/server/obl;->ef:I

    const-string v0, "android.intent.oneplus.gpsforcestop"

    iput-object v0, p0, Lcom/android/server/obl;->mAction:Ljava/lang/String;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/obl;->mLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/obl;->ff:Landroid/content/Intent;

    iput-object v0, p0, Lcom/android/server/obl;->mPendingIntent:Landroid/app/PendingIntent;

    new-instance v0, Lcom/android/server/zgw;

    invoke-direct {v0, p0}, Lcom/android/server/zgw;-><init>(Lcom/android/server/obl;)V

    iput-object v0, p0, Lcom/android/server/obl;->mReceiver:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, Lcom/android/server/obl;->DEBUG:Z
...
.method static synthetic access$200()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/obl;->TAG:Ljava/lang/String;
...
.method private qm()Z
    ...
    iget-object v0, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/obl;->mLocationManager:Landroid/location/LocationManager;
...
.method static synthetic sis(Lcom/android/server/obl;)Lcom/android/server/obl$zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/obl;->mHandler:Lcom/android/server/obl$zta;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/obl;)Landroid/app/NotificationManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/obl;->mNotificationManager:Landroid/app/NotificationManager;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/obl;)Landroid/app/ActivityManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/obl;->mActivityManager:Landroid/app/ActivityManager;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/obl;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/obl;->cf:J

    return-wide p1
.end method

.method static synthetic zta(Lcom/android/server/obl;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lcom/android/server/obl;->mAction:Ljava/lang/String;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/obl;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/obl;->df:Z
...
.method public O()V
    ...
    iget-object v0, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/obl;->bf:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/android/server/obl;->bf:Ljava/util/ArrayList;

    iget-object v2, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v1, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v7, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;
    ...
    :try_start_3
    sget-object v8, Lcom/android/server/obl;->TAG:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;
    ...
    :try_start_4
    sget-object v4, Lcom/android/server/obl;->TAG:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/server/obl;->af:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;

    const/4 v8, 0x0

    iget-object v9, p0, Lcom/android/server/obl;->ff:Landroid/content/Intent;
    ...
    iput-object v4, p0, Lcom/android/server/obl;->mPendingIntent:Landroid/app/PendingIntent;
    ...
    iget-object v7, p0, Lcom/android/server/obl;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iget-object v2, p0, Lcom/android/server/obl;->mPendingIntent:Landroid/app/PendingIntent;
...
.method public getCurrentProviderPackageList(Ljava/lang/String;ZLjava/util/HashMap;)Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->mLocationManagerService:Lcom/android/server/LocationManagerService;
    ...
    iput-object v1, p0, Lcom/android/server/obl;->mLocationManagerService:Lcom/android/server/LocationManagerService;
    ...
    sget-object v1, Lcom/android/server/obl;->TAG:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/obl;->mUserManager:Landroid/os/UserManager;
    ...
    sget-object v2, Lcom/android/server/obl;->We:Ljava/util/ArrayList;
...
.method public systemReady()V
    ...
    iput-object v0, p0, Lcom/android/server/obl;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lcom/android/server/obl;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    iput-object v0, p0, Lcom/android/server/obl;->mActivityManager:Landroid/app/ActivityManager;
    ...
    iput-object v0, p0, Lcom/android/server/obl;->mUserManager:Landroid/os/UserManager;
    ...
    iget-object v1, p0, Lcom/android/server/obl;->mAction:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/server/obl;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/obl;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/obl$zta;-><init>(Lcom/android/server/obl;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/obl;->mHandler:Lcom/android/server/obl$zta;
    ...
    iget-object v0, p0, Lcom/android/server/obl;->ff:Landroid/content/Intent;

    const/high16 v1, 0x4000000

    invoke-virtual {v0, v1}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;

    iget-object p0, p0, Lcom/android/server/obl;->ff:Landroid/content/Intent;
