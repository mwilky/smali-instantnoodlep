...
# static fields
.field private static Lf:Ljava/util/HashMap; = null
...
.field private static Mf:Ljava/util/HashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Integer;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/OnePlusUtil$you;->Lf:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/server/OnePlusUtil$you;->Mf:Ljava/util/HashMap;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Jf:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Kf:Ljava/util/ArrayList;

    return-void
.end method

.method private ear(II)Z
    .locals 2
    ...
    sget-object p0, Lcom/android/server/OnePlusUtil$you;->Lf:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/OnePlusUtil$you$zta;->dma(I)Z
...
.method private you(IILjava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Jf:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/OnePlusUtil$you;->Jf:Ljava/util/ArrayList;
    ...
    sget-object p2, Lcom/android/server/OnePlusUtil$you;->mLock:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Kf:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_2
    iget-object p0, p0, Lcom/android/server/OnePlusUtil$you;->Kf:Ljava/util/ArrayList;
    ...
    invoke-interface {p2, p1, p3, v3}, Lcom/android/server/OnePlusUtil$you$you;->sis(ILjava/lang/String;Z)V
...
.method private zta(Lcom/android/server/OnePlusUtil$you$tsu;ILjava/lang/String;)V
    ...
    iget v1, p1, Lcom/android/server/OnePlusUtil$you$tsu;->mPid:I
    ...
    iget v4, p1, Lcom/android/server/OnePlusUtil$you$tsu;->mPid:I
    ...
    sget-object p1, Lcom/android/server/OnePlusUtil$you;->mLock:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    sget-object v0, Lcom/android/server/OnePlusUtil$you;->Lf:Ljava/util/HashMap;
    ...
    invoke-interface {p1, p2, p3, v3}, Lcom/android/server/OnePlusUtil$you$you;->sis(ILjava/lang/String;Z)V
...
.method private zta(Lcom/android/server/OnePlusUtil$you$zta;)V
    .locals 4

    iget-object v0, p1, Lcom/android/server/OnePlusUtil$you$zta;->mWindows:Ljava/util/ArrayList;
    ...
    iget v2, p1, Lcom/android/server/OnePlusUtil$you$zta;->mUid:I

    iget-object v3, p1, Lcom/android/server/OnePlusUtil$you$zta;->mPkgName:Ljava/lang/String;

    invoke-direct {p0, v1, v2, v3}, Lcom/android/server/OnePlusUtil$you;->zta(Lcom/android/server/OnePlusUtil$you$tsu;ILjava/lang/String;)V
...
.method public addUidtoTouchWindowUids(IILjava/lang/String;III)V
    ...
    sget-object v10, Lcom/android/server/OnePlusUtil$you;->mLock:Ljava/lang/Object;

    monitor-enter v10

    :try_start_0
    sget-object v2, Lcom/android/server/OnePlusUtil$you;->Lf:Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v0, v5, v6, v7}, Lcom/android/server/OnePlusUtil$you$zta;->you(IIII)Z
    ...
    sget-object v12, Lcom/android/server/OnePlusUtil$you;->Lf:Ljava/util/HashMap;
    ...
    :goto_1
    invoke-direct/range {p0 .. p2}, Lcom/android/server/OnePlusUtil$you;->ear(II)Z
    ...
    invoke-direct/range {p0 .. p3}, Lcom/android/server/OnePlusUtil$you;->you(IILjava/lang/String;)V
...
.method public dma(I)Z
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/OnePlusUtil$you$zta;->dma(I)Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v2, p0, Lcom/android/server/OnePlusUtil$you;->Jf:Ljava/util/ArrayList;
...
.method public onFindFocusedWindow()V
    ...
    sput-object p0, Lcom/android/server/OnePlusUtil$you;->Mf:Ljava/util/HashMap;
...
.method public you(Lcom/android/server/OnePlusUtil$you$sis;)V
    .locals 1
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/OnePlusUtil$you;->Jf:Ljava/util/ArrayList;
...
.method public zta(Lcom/android/server/OnePlusUtil$you$sis;)V
    .locals 2
...
.method public zta(Lcom/android/server/OnePlusUtil$you$you;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/OnePlusUtil$you;->Kf:Ljava/util/ArrayList;
