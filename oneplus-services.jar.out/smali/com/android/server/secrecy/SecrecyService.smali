...
.field private final qm:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private sm:Lcom/android/server/secrecy/you/you;

.field private tm:Lcom/android/server/secrecy/you/sis;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->qm:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->lm:Lcom/android/server/ServiceThread;

    iget-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->lm:Lcom/android/server/ServiceThread;

    invoke-virtual {p1}, Lcom/android/server/ServiceThread;->start()V

    invoke-direct {p0}, Lcom/android/server/secrecy/SecrecyService;->Zm()V
...
.method private Zm()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->sm:Lcom/android/server/secrecy/you/you;
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->tm:Lcom/android/server/secrecy/you/sis;
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/android/server/secrecy/zta/sis;->ne()Lcom/android/server/secrecy/zta/zta;
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/sis;->ne()Lcom/android/server/secrecy/zta/zta;
    ...
    iget-boolean v0, p0, Lcom/android/server/secrecy/SecrecyService;->rm:Z
    ...
    invoke-static {}, Lcom/android/server/secrecy/zta/zta/zta;->ye()Ljava/lang/String;
    ...
    iget-object p3, p0, Lcom/android/server/secrecy/SecrecyService;->sm:Lcom/android/server/secrecy/you/you;
    ...
    :cond_12
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->tm:Lcom/android/server/secrecy/you/sis;
...
.method private initPolicy()V
    ...
    iget-object v2, p0, Lcom/android/server/secrecy/SecrecyService;->lm:Lcom/android/server/ServiceThread;
...
.method static synthetic zta(Lcom/android/server/secrecy/SecrecyService;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->qm:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private zta(Landroid/content/pm/ActivityInfo;)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->sm:Lcom/android/server/secrecy/you/you;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->sm:Lcom/android/server/secrecy/you/you;
...
.method public La()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/secrecy/SecrecyService;->rm:Z
...
.method public obl(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/SecrecyService;->rm:Z
