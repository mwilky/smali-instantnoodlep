...
.field public static final WV:Z = false

.field public static final XV:Z = true
...
# instance fields
.field private final MV:Lcom/android/server/secrecy/sis;

.field private OV:Lcom/android/server/secrecy/SecrecyService;
...
.field private SV:Lcom/android/server/secrecy/zta/you;

.field private UV:Lcom/android/server/secrecy/zta/zta;

.field private VV:Lcom/android/server/secrecy/zta/rtg;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/zta/sis;->MV:Lcom/android/server/secrecy/sis;
...
.method private Fq()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->SV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ke()J

    move-result-wide v0

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->SV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/you;->le()J

    move-result-wide v2

    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->SV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/you;->me()Z
...
.method private Gq()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->MV:Lcom/android/server/secrecy/sis;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->MV:Lcom/android/server/secrecy/sis;
...
.method private you(Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->RV:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->RV:Z
    ...
    iget-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->RV:Z
...
.method public A(I)Z
    ...
    :cond_1
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    :cond_2
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
...
.method public ea(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/secrecy/zta/sis;->Fq()V
...
.method public hmo()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->ye()Z

    move-result v0

    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v1}, Lcom/android/server/secrecy/zta/rtg;->te()Z

    move-result v1

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/rtg;->we()Z

    move-result v2

    iget-object v3, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v3}, Lcom/android/server/secrecy/zta/rtg;->ue()Z
    ...
    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/rtg;->xe()J

    move-result-wide v4

    iget-object v6, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/rtg;->ve()J
...
.method public ke()Ljava/lang/Long;
    .locals 2

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->SV:Lcom/android/server/secrecy/zta/you;
...
.method public oe()Lcom/android/server/secrecy/zta/zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->UV:Lcom/android/server/secrecy/zta/zta;
...
.method public pe()Z
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->OV:Lcom/android/server/secrecy/SecrecyService;
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->me()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->le()J
...
.method public systemReady(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ne()V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->xe()J

    move-result-wide v0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/rtg;->ve()J
...
.method public zta(Landroid/content/Context;Lcom/android/server/secrecy/SecrecyService;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->OV:Lcom/android/server/secrecy/SecrecyService;

    new-instance p2, Lcom/android/server/secrecy/zta/you;

    invoke-direct {p2}, Lcom/android/server/secrecy/zta/you;-><init>()V

    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->SV:Lcom/android/server/secrecy/zta/you;
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->UV:Lcom/android/server/secrecy/zta/zta;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/zta/sis;->VV:Lcom/android/server/secrecy/zta/rtg;
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->OV:Lcom/android/server/secrecy/SecrecyService;
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->PV:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->QV:Z
