...
.field private static sInstance:Lcom/android/server/secrecy/zta/sis; = null

.field public static final xV:Z = false

.field public static final yV:Z = true
...
.field private final pV:Lcom/android/server/secrecy/sis;

.field private qV:Lcom/android/server/secrecy/SecrecyService;
...
.field private uV:Lcom/android/server/secrecy/zta/you;

.field private vV:Lcom/android/server/secrecy/zta/zta;

.field private wV:Lcom/android/server/secrecy/zta/rtg;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/zta/sis;->pV:Lcom/android/server/secrecy/sis;
...
.method private Cq()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->uV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ie()J

    move-result-wide v0

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->uV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/you;->je()J

    move-result-wide v2

    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->uV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/you;->ke()Z
...
.method private Dq()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->pV:Lcom/android/server/secrecy/sis;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->pV:Lcom/android/server/secrecy/sis;

    invoke-virtual {p0}, Lcom/android/server/secrecy/sis;->les()V
...
.method private ssp(Ljava/lang/String;Z)V
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->rtg:Lcom/android/server/secrecy/zta/tsu;

    invoke-virtual {p0, p1}, Lcom/android/server/secrecy/zta/tsu;->ha(Ljava/lang/String;)V
...
.method private you(Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
    ...
    iget-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
...
.method public A(I)Z
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
    ...
    :cond_1
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    :cond_2
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z
...
.method public ea(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/zta/you;->ea(Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/android/server/secrecy/zta/sis;->Cq()V
...
.method public fa(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/secrecy/sis;->ca(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->pV:Lcom/android/server/secrecy/sis;

    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/sis;->da(Ljava/lang/String;)V
...
.method public hmo()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->we()Z

    move-result v0

    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v1}, Lcom/android/server/secrecy/zta/rtg;->re()Z

    move-result v1

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/rtg;->ue()Z

    move-result v2

    iget-object v3, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v3}, Lcom/android/server/secrecy/zta/rtg;->se()Z
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->rtg:Lcom/android/server/secrecy/zta/tsu;

    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/rtg;->ve()J

    move-result-wide v4

    iget-object v6, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/rtg;->te()J
...
.method public ie()Ljava/lang/Long;
    .locals 2

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->uV:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->ie()J
...
.method public me()Lcom/android/server/secrecy/zta/zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->vV:Lcom/android/server/secrecy/zta/zta;
...
.method public ne()Z
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->qV:Lcom/android/server/secrecy/SecrecyService;

    invoke-virtual {v0}, Lcom/android/server/secrecy/SecrecyService;->Ka()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->ke()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->je()J
...
.method public systemReady(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->le()V

    invoke-direct {p0}, Lcom/android/server/secrecy/zta/sis;->Dq()V

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/sis;->yd()V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/secrecy/zta/sis;->rtg:Lcom/android/server/secrecy/zta/tsu;

    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->ve()J

    move-result-wide v0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/rtg;->te()J
...
.method public zta(Landroid/content/Context;Lcom/android/server/secrecy/SecrecyService;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->qV:Lcom/android/server/secrecy/SecrecyService;

    new-instance p2, Lcom/android/server/secrecy/zta/you;

    invoke-direct {p2}, Lcom/android/server/secrecy/zta/you;-><init>()V

    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->uV:Lcom/android/server/secrecy/zta/you;
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->vV:Lcom/android/server/secrecy/zta/zta;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/zta/sis;->rtg:Lcom/android/server/secrecy/zta/tsu;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/zta/sis;->wV:Lcom/android/server/secrecy/zta/rtg;
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->qV:Lcom/android/server/secrecy/SecrecyService;

    invoke-virtual {v1}, Lcom/android/server/secrecy/SecrecyService;->Ka()Z
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->rV:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->sV:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->tV:Z
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/secrecy/zta/sis;->A(I)Z
