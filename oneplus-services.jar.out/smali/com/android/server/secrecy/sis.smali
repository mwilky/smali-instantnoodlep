...
.field private static final UU:I = 0x3

.field private static final VU:Ljava/lang/String; = "imei"

.field private static final WU:Ljava/lang/String; = "rc4_key"

.field private static final XU:Ljava/lang/String; = "last_download_time"

.field private static final YU:Ljava/lang/String; = "encrypt_app"

.field private static final ZU:Ljava/lang/String; = "encrypt_log"

.field private static final _U:Ljava/lang/String; = "encrypt_adb"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/sis;->NU:Ljava/lang/String;

    const/16 v0, 0x100

    new-array v0, v0, [B

    iput-object v0, p0, Lcom/android/server/secrecy/sis;->PU:[B
...
.method private Bq()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/sis;->QU:[B
    ...
    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->ie()Ljava/lang/Long;
    ...
    iget-object v7, p0, Lcom/android/server/secrecy/sis;->RU:Ljava/lang/String;

    if-eqz v7, :cond_1

    const-string v7, "imei"

    iget-object v8, p0, Lcom/android/server/secrecy/sis;->RU:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/server/secrecy/sis;->QU:[B
...
.method static synthetic sis(Lcom/android/server/secrecy/sis;)V
    ...
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->Bq()V
...
.method private zq()V
    ...
    invoke-static {}, Lcom/android/server/secrecy/zta/zta/tsu;->ze()Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->Aq()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->ne()Z
    ...
    iput-object v1, p0, Lcom/android/server/secrecy/sis;->QU:[B

    iget-object v1, p0, Lcom/android/server/secrecy/sis;->PU:[B

    iget-object v9, p0, Lcom/android/server/secrecy/sis;->QU:[B
    ...
    iput-object v1, p0, Lcom/android/server/secrecy/sis;->RU:Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/secrecy/sis;)V
    ...
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->zq()V
...
.method public ca(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/sis;->RU:Ljava/lang/String;
...
.method public da(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/sis;->QU:[B
...
.method public fto(J)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/sis;->PU:[B
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/sis;->PU:[B
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/sis;->RU:Ljava/lang/String;
