...
.method constructor <init>(Lcom/android/server/OnePlusExService;Landroid/app/Notification$Builder;Landroid/content/Context;III)V
    ...
    iput-object p1, p0, Lcom/android/server/ugm;->this$0:Lcom/android/server/OnePlusExService;

    iput-object p2, p0, Lcom/android/server/ugm;->val$n:Landroid/app/Notification$Builder;

    iput-object p3, p0, Lcom/android/server/ugm;->val$context:Landroid/content/Context;

    iput p4, p0, Lcom/android/server/ugm;->Ee:I

    iput p5, p0, Lcom/android/server/ugm;->Fe:I

    iput p6, p0, Lcom/android/server/ugm;->Ge:I
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/android/server/ugm;->val$n:Landroid/app/Notification$Builder;

    iget-object v1, p0, Lcom/android/server/ugm;->val$context:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/ugm;->this$0:Lcom/android/server/OnePlusExService;

    invoke-static {v2}, Lcom/android/server/OnePlusExService;->access$900(Lcom/android/server/OnePlusExService;)[I

    move-result-object v2

    iget v3, p0, Lcom/android/server/ugm;->Ee:I
    ...
    iget-object v0, p0, Lcom/android/server/ugm;->this$0:Lcom/android/server/OnePlusExService;

    iget-object v1, p0, Lcom/android/server/ugm;->val$context:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/ugm;->val$n:Landroid/app/Notification$Builder;
    ...
    iget-object v1, p0, Lcom/android/server/ugm;->this$0:Lcom/android/server/OnePlusExService;
    ...
    iget v2, p0, Lcom/android/server/ugm;->Fe:I

    invoke-virtual {v1, v2, v0}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V

    iget v0, p0, Lcom/android/server/ugm;->Ee:I

    iget v5, p0, Lcom/android/server/ugm;->Ge:I
    ...
    iget-object v3, p0, Lcom/android/server/ugm;->val$context:Landroid/content/Context;

    iget v4, p0, Lcom/android/server/ugm;->Fe:I
