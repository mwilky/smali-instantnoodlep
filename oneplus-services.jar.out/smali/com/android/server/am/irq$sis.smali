.class public Lcom/android/server/am/irq$sis;
...
.field private static mInstance:Lcom/android/server/am/irq$sis;
...
.method static final checkAppInLaunchingProviders(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-static {}, Lcom/android/server/am/irq;->access$500()Lcom/android/server/am/ActivityManagerService;
...
.method static final checkProcessCanRestart(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_1
    invoke-static {}, Lcom/android/server/am/irq$sis;->getInstance()Lcom/android/server/am/irq$sis;

    move-result-object v0

    invoke-direct {v0, p0}, Lcom/android/server/am/irq$sis;->vdb(Lcom/android/server/am/ProcessRecord;)Z
...
.method private static getInstance()Lcom/android/server/am/irq$sis;
    .locals 1

    sget-object v0, Lcom/android/server/am/irq$sis;->mInstance:Lcom/android/server/am/irq$sis;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/irq$sis;

    invoke-direct {v0}, Lcom/android/server/am/irq$sis;-><init>()V

    sput-object v0, Lcom/android/server/am/irq$sis;->mInstance:Lcom/android/server/am/irq$sis;
