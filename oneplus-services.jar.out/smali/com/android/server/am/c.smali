...
.field private static final ov:Ljava/lang/String; = "com.S5G.action.debug"

.field private static sEnable:Z = false

.field private static sInstance:Lcom/android/server/am/C; = null

.field private static final sq:Ljava/lang/String; = ""

.field private static xG:Landroid/os/Handler; = null

.field private static final yG:I = 0x1

.field private static final zG:I = 0x2
...
.field private wG:Ljava/util/HashSet;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/C;->sInstance:Lcom/android/server/am/C;

    sput-object v0, Lcom/android/server/am/C;->xG:Landroid/os/Handler;
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/C;->uG:Z

    const-string v0, ""

    iput-object v0, p0, Lcom/android/server/am/C;->vG:Ljava/lang/String;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/C;->mLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/am/C;->mContext:Landroid/content/Context;

    iput-object v0, p0, Lcom/android/server/am/C;->mObserver:Lcom/oneplus/config/ConfigObserver;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;

    iput-object v0, p0, Lcom/android/server/am/C;->method:Ljava/lang/reflect/Method;

    iput-object v0, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;

    new-instance v1, Lcom/android/server/am/B;

    invoke-direct {v1, p0}, Lcom/android/server/am/B;-><init>(Lcom/android/server/am/C;)V

    iput-object v1, p0, Lcom/android/server/am/C;->av:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/am/C$you;-><init>(Lcom/android/server/am/C;Landroid/os/Looper;)V

    sput-object p1, Lcom/android/server/am/C;->xG:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lcom/android/server/am/C;->av:Landroid/content/BroadcastReceiver;

    sget-object v3, Lcom/android/server/am/C;->xG:Landroid/os/Handler;
    ...
    invoke-direct {p0}, Lcom/android/server/am/C;->qo()V

    invoke-direct {p0}, Lcom/android/server/am/C;->initOnlineConfig()V

    invoke-direct {p0}, Lcom/android/server/am/C;->Hd()V

    sput-object p0, Lcom/android/server/am/C;->sInstance:Lcom/android/server/am/C;
...
.method private Fp()V
    ...
    iget-object v0, p0, Lcom/android/server/am/C;->mLock:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/C;->vG:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/server/am/C;->vG:Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lcom/android/server/am/C;->uG:Z
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/C;->hmo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/server/am/C;->sis(ZLjava/lang/String;)V
...
.method private Hd()V
    ...
    iget-object v2, p0, Lcom/android/server/am/C;->vG:Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/android/server/am/C;->uG:Z
    ...
    iget-object p0, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
...
.method private Lo()V
    ...
    iget-object v0, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
...
.method static synthetic access$100()Lcom/android/server/am/C;
    .locals 1

    sget-object v0, Lcom/android/server/am/C;->sInstance:Lcom/android/server/am/C;
...
.method private getIExtTelephony()Ljava/lang/Object;
    ...
    iput-object v1, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0

    iget-object p0, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
...
.method private hmo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p1, Lcom/android/server/am/C;->xG:Landroid/os/Handler;
...
.method public static final init(Landroid/content/Context;)Lcom/android/server/am/C;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/am/C;->sInstance:Lcom/android/server/am/C;
...
.method private initOnlineConfig()V
    ...
    iget-object v2, p0, Lcom/android/server/am/C;->mContext:Landroid/content/Context;

    sget-object v3, Lcom/android/server/am/C;->xG:Landroid/os/Handler;

    new-instance v4, Lcom/android/server/am/C$zta;

    invoke-direct {v4, p0}, Lcom/android/server/am/C$zta;-><init>(Lcom/android/server/am/C;)V
    ...
    iput-object v1, p0, Lcom/android/server/am/C;->mObserver:Lcom/oneplus/config/ConfigObserver;

    sget-object p0, Lcom/android/server/am/C;->xG:Landroid/os/Handler;
...
.method private ire(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    sget-boolean v4, Lcom/android/server/am/C;->sEnable:Z

    if-eq v3, v4, :cond_2

    sput-boolean v3, Lcom/android/server/am/C;->sEnable:Z
    ...
    invoke-direct {p0}, Lcom/android/server/am/C;->Fp()V
    ...
    iget-object v3, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
    ...
    iget-object v5, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
    ...
    :try_start_3
    iget-object v6, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
...
.method static synthetic sis(Lcom/android/server/am/C;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/C;->mObserver:Lcom/oneplus/config/ConfigObserver;
...
.method private sis(ZLjava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object p2, p0, Lcom/android/server/am/C;->method:Ljava/lang/reflect/Method;
    ...
    iput-object p2, p0, Lcom/android/server/am/C;->method:Ljava/lang/reflect/Method;

    :cond_1
    iget-object p2, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
    ...
    iput-object p2, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/server/am/C;->method:Ljava/lang/reflect/Method;
    ...
    iget-object v3, p0, Lcom/android/server/am/C;->Wg:Ljava/lang/Object;
    ...
    iput-boolean p1, p0, Lcom/android/server/am/C;->uG:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic tsu(Lcom/android/server/am/C;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/C;->uG:Z

    return p0
.end method

.method static synthetic you(Lcom/android/server/am/C;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/am/C;Ljava/lang/Object;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/C;->bio(Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/am/C;Ljava/lang/String;Ljava/lang/Boolean;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/C;->zta(Ljava/lang/String;Ljava/lang/Boolean;)V
...
.method static synthetic zta(Lcom/android/server/am/C;ZLjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/C;->sis(ZLjava/lang/String;)V
...
.method private zta(Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    iget-object p2, p0, Lcom/android/server/am/C;->wG:Ljava/util/HashSet;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    sget-object p3, Lcom/android/server/am/C;->sInstance:Lcom/android/server/am/C;
    ...
    iget-object p2, p0, Lcom/android/server/am/C;->mLock:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iput-object p1, p0, Lcom/android/server/am/C;->vG:Ljava/lang/String;

    monitor-exit p2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-boolean p2, Lcom/android/server/am/C;->sEnable:Z
    ...
    :cond_1
    invoke-direct {p0, p1, p4}, Lcom/android/server/am/C;->ire(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/C;->hmo(Ljava/lang/String;Ljava/lang/String;)V
