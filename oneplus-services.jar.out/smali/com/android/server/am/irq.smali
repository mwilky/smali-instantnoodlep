...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/irq;->DEBUG:Z
    ...
    sput-object v1, Lcom/android/server/am/irq;->mInstance:Lcom/android/server/am/irq;
...
.method private Bo()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/irq;->cjf(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic access$500()Lcom/android/server/am/ActivityManagerService;
    ...
    sget-object v0, Lcom/android/server/am/irq;->mActivityManager:Lcom/android/server/am/ActivityManagerService;
...
.method public static declared-synchronized getInstance()Lcom/android/server/am/irq;
    .locals 2

    const-class v0, Lcom/android/server/am/irq;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/irq;->mInstance:Lcom/android/server/am/irq;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/am/irq;

    invoke-direct {v1}, Lcom/android/server/am/irq;-><init>()V
...
.method private initOnlineConfig()V
    ...
    iput-object v0, p0, Lcom/android/server/am/irq;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, Lcom/android/server/am/irq;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public static r(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    :goto_2
    sget-boolean v1, Lcom/android/server/am/irq;->DEBUG:Z
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :cond_1
    invoke-static {v6}, Lcom/android/server/am/irq$zta;->tsu(Ljava/util/List;)V
    ...
    invoke-static {v6, v4}, Lcom/android/server/am/irq;->zta(Ljava/util/List;Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-static {v6}, Lcom/android/server/am/irq$zta;->rtg(Ljava/util/List;)V
    ...
    :cond_5
    invoke-static {v6}, Lcom/android/server/am/irq$zta;->ssp(Ljava/util/List;)V
    ...
    invoke-static {v7, v4}, Lcom/android/server/am/irq;->zta(Ljava/util/List;Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/android/server/am/irq$zta;->access$200()Ljava/util/List;
...
.method public static you(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_2
    invoke-static {p0}, Lcom/android/server/am/irq;->zgw(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-static {v1}, Lcom/android/server/am/les;->k(I)Z
    ...
    invoke-static {v1}, Lcom/android/server/am/les;->l(I)Z
...
.method private static zgw(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-object v0, Lcom/android/server/am/irq;->mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method private static zta(Ljava/util/List;Ljava/lang/String;)Z
    ...
    sget-boolean v8, Lcom/android/server/am/irq;->DEBUG:Z
