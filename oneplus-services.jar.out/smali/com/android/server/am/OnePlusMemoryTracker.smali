...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/OnePlusMemoryTracker;->DEBUG_MODE:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v1, Lcom/android/server/am/OnePlusMemoryTracker;->sDebug:Z

    const/4 v1, 0x1

    sput-boolean v1, Lcom/android/server/am/OnePlusMemoryTracker;->sInUsing:Z

    sput-boolean v1, Lcom/android/server/am/OnePlusMemoryTracker;->sMdm:Z

    sput-boolean v0, Lcom/android/server/am/OnePlusMemoryTracker;->sDropbox:Z

    sput-boolean v1, Lcom/android/server/am/OnePlusMemoryTracker;->sReport:Z
    ...
    sput-object v1, Lcom/android/server/am/OnePlusMemoryTracker;->DUMP_MEM_OOM_LABEL:[Ljava/lang/String;
    ...
    sput-object v1, Lcom/android/server/am/OnePlusMemoryTracker;->DUMP_MEM_OOM_ADJ:[I

    const/high16 v1, 0x40000

    sput v1, Lcom/android/server/am/OnePlusMemoryTracker;->sDropboxMaxSize:I

    const/16 v1, 0x800

    sput v1, Lcom/android/server/am/OnePlusMemoryTracker;->sLogcatLineNum:I

    const-wide/32 v1, 0x493e0

    sput-wide v1, Lcom/android/server/am/OnePlusMemoryTracker;->sSwitchBackgroundTimeount:J
    ...
    :goto_0
    sput-wide v1, Lcom/android/server/am/OnePlusMemoryTracker;->sReportInterval:J

    sput-boolean v0, Lcom/android/server/am/OnePlusMemoryTracker;->sKillLeakProcess:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/android/server/am/h;

    invoke-direct {p1, p0}, Lcom/android/server/am/h;-><init>(Lcom/android/server/am/OnePlusMemoryTracker;)V
...
.method private doWriteLogToDropbox(Lcom/android/server/am/OnePlusMemoryTracker$zta;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/am/f;-><init>(Lcom/android/server/am/OnePlusMemoryTracker;Lcom/android/server/am/OnePlusMemoryTracker$zta;)V
...
.method private getAllProcessMeminfo(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    iget-object v2, v1, Lcom/android/server/am/OnePlusMemoryTracker$you;->uC:Ljava/util/ArrayList;

    if-eqz v2, :cond_0

    invoke-static {v2}, Lcom/android/server/am/OnePlusMemoryTracker;->sortMemItems(Ljava/util/List;)V

    iget-object v1, v1, Lcom/android/server/am/OnePlusMemoryTracker$you;->uC:Ljava/util/ArrayList;
...
.method private getMemoryInfo(Z)Ljava/lang/String;
    ...
    iget-boolean v1, v15, Lcom/android/server/am/OnePlusMemoryTracker$zta;->pC:Z
    ...
    iput-object v6, v3, Lcom/android/server/am/OnePlusMemoryTracker$you;->uC:Ljava/util/ArrayList;
...
.method private reportAppEvent(Lcom/android/server/am/OnePlusMemoryTracker$zta;)V
    ...
    iget-object v0, p1, Lcom/android/server/am/OnePlusMemoryTracker$zta;->mProcessName:Ljava/lang/String;
...
# virtual methods
.method public checkIfNeedReport(II)V
    .locals 8
...
.method public checkIfNeedReport(Lcom/android/server/am/ProcessRecord;)V
    ...
    :cond_4
    invoke-virtual {v1}, Lcom/android/server/am/OnePlusMemoryTracker$rtg;->Kc()Z
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_1
    invoke-virtual {p3}, Lcom/android/server/am/OnePlusMemoryTracker$rtg;->Lc()V
...
.method public initAms(Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/am/OnePlusMemoryTracker$sis;-><init>(Lcom/android/server/am/OnePlusMemoryTracker;Lcom/android/server/am/f;)V
