...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v0, Lcom/android/server/am/v;->BETA_OR_ALPHA_ROM:Z

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/am/v;->DEBUG_ONEPLUS:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v1, p0, Lcom/android/server/am/v;->mLastResetTime:J
    ...
    iput-object p1, p0, Lcom/android/server/am/v;->mHandler:Lcom/android/server/am/v$you;

    iget-object p1, p0, Lcom/android/server/am/v;->mHandler:Lcom/android/server/am/v$you;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p1

    iget-object p0, p0, Lcom/android/server/am/v;->mHandler:Lcom/android/server/am/v$you;
...
.method static synthetic you(Lcom/android/server/am/v;)Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p0, p0, Lcom/android/server/am/v;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method static synthetic zta(Lcom/android/server/am/v;)Lcom/android/server/am/v$zta;
    ...
    iget-object p0, p0, Lcom/android/server/am/v;->mConfigUpdater:Lcom/android/server/am/v$zta;
...
.method static synthetic zta(Lcom/android/server/am/v;Lcom/android/server/am/v$zta;)Lcom/android/server/am/v$zta;
    ...
    iput-object p1, p0, Lcom/android/server/am/v;->mConfigUpdater:Lcom/android/server/am/v$zta;
...
.method static synthetic zta(Lcom/android/server/am/v;Lcom/oneplus/config/ConfigObserver;)Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/am/v;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public collectBatteryStats(Lcom/android/internal/os/BatteryStatsImpl;IIIZ)V
    ...
    :cond_0
    sget-boolean p2, Lcom/android/server/am/v;->DEBUG_ONEPLUS:Z
    ...
    iget-wide p4, p0, Lcom/android/server/am/v;->mLastResetTime:J

    cmp-long p2, p2, p4

    if-eqz p2, :cond_2

    iget-object p2, p0, Lcom/android/server/am/v;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p3, p2}, Lcom/android/server/am/v;->zta(Ljava/lang/String;Landroid/os/DropBoxManager;)V

    invoke-virtual {p1}, Lcom/android/internal/os/BatteryStatsImpl;->getResetTime()J

    move-result-wide p1

    iput-wide p1, p0, Lcom/android/server/am/v;->mLastResetTime:J
...
.method public zta(Ljava/lang/String;Landroid/os/DropBoxManager;)V
    ...
    sget-boolean v11, Lcom/android/server/am/v;->DEBUG_ONEPLUS:Z
    ...
    sget-boolean v10, Lcom/android/server/am/v;->DEBUG_ONEPLUS:Z
    ...
    :cond_5
    sget-boolean v0, Lcom/android/server/am/v;->DEBUG_ONEPLUS:Z
