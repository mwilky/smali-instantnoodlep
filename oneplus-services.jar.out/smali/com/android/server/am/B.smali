...
.field private static UE:J = 0x493e0L

.field private static VE:J = 0xa4cb800L

.field private static final VERSION:I = 0x123c5c1

.field private static WE:J = 0xea60L

.field private static XE:I = 0x0

.field private static Xv:J = 0xafc8L

.field private static final YE:I = 0x2

.field private static final ZE:I = 0x64
...
.field private static final ov:Ljava/lang/String; = "persist.sys.opjc.debug_detail"

.field private static ow:Landroid/os/HandlerThread; = null

.field private static final pv:Ljava/lang/String; = "persist.sys.opjc.debug_loglevel"
...
.field private static final xv:Ljava/lang/String; = "com.OPJC.action.debug"


# instance fields
.field private KE:I

.field private LE:Lcom/oneplus/config/ConfigObserver;

.field private ME:Ljava/util/HashSet;
...
.field private NE:Ljava/lang/Object;
...
.field private SE:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private TE:Lcom/android/server/am/B$you;
...
.method static constructor <clinit>()V
    ...
    sput v1, Lcom/android/server/am/B;->XE:I

    sput-boolean v0, Lcom/android/server/am/B;->_v:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v1, Lcom/android/server/am/B;->aw:Z
    ...
    sput-boolean v2, Lcom/android/server/am/B;->cw:Z
    ...
    sput-boolean v0, Lcom/android/server/am/B;->Qv:Z

    sget-boolean v0, Lcom/android/server/am/B;->Qv:Z

    sput-boolean v0, Lcom/android/server/am/B;->sw:Z

    sget-boolean v0, Lcom/android/server/am/B;->sw:Z
    ...
    sput-object v0, Lcom/android/server/am/B;->ow:Landroid/os/HandlerThread;

    sput-object v0, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
...
.method protected constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput v0, p0, Lcom/android/server/am/B;->KE:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/am/B;->LE:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v1, p0, Lcom/android/server/am/B;->ME:Ljava/util/HashSet;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/B;->NE:Ljava/lang/Object;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/B;->OE:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/B;->QE:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/B;->RE:Ljava/util/ArrayList;

    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;
    ...
    iput-object v1, p0, Lcom/android/server/am/B;->TE:Lcom/android/server/am/B$you;
    ...
    iput-object v1, p0, Lcom/android/server/am/B;->kv:Landroid/content/BroadcastReceiver;
    ...
    sput-object p1, Lcom/android/server/am/B;->ow:Landroid/os/HandlerThread;

    sget-object p1, Lcom/android/server/am/B;->ow:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance p1, Lcom/android/server/am/B$zta;

    sget-object v1, Lcom/android/server/am/B;->ow:Landroid/os/HandlerThread;
    ...
    sput-object p1, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lcom/android/server/am/B;->kv:Landroid/content/BroadcastReceiver;

    sget-object v3, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
...
.method private Gd()V
    ...
    sget-boolean v1, Lcom/android/server/am/B;->Qv:Z
    ...
    sget-wide v1, Lcom/android/server/am/B;->Xv:J
    ...
    sget-wide v1, Lcom/android/server/am/B;->UE:J
    ...
    sget-wide v1, Lcom/android/server/am/B;->VE:J
    ...
    sget-wide v1, Lcom/android/server/am/B;->WE:J
    ...
    sget v1, Lcom/android/server/am/B;->XE:I
...
.method static synthetic access$1000()J
    ...
    sget-wide v0, Lcom/android/server/am/B;->VE:J
...
.method static synthetic cno(Lcom/android/server/am/B;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->ME:Ljava/util/HashSet;
...
.method private fto(II)V
    ...
    iget-object v1, p0, Lcom/android/server/am/B;->NE:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/B;->QE:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/am/B;->RE:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->OE:Ljava/util/ArrayList;
    ...
    sget p1, Lcom/android/server/am/B;->XE:I
    ...
    sget-object p0, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
    ...
    sget-object p1, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
    ...
    sget-wide v2, Lcom/android/server/am/B;->WE:J
...
.method private static getLogLevel()I
    ...
    sget-boolean v0, Lcom/android/server/am/B;->cw:Z
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/am/B;->aw:Z
    ...
    :cond_1
    sget-boolean v0, Lcom/android/server/am/B;->_v:Z
...
.method private handleUidGone(I)V
    ...
    iget-object v0, p0, Lcom/android/server/am/B;->NE:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/B;->QE:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/am/B;->RE:Ljava/util/ArrayList;
    ...
    sget-object v2, Lcom/android/server/am/B;->nw:Landroid/os/Handler;

    invoke-virtual {v2, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object v1, p0, Lcom/android/server/am/B;->OE:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->RE:Ljava/util/ArrayList;
...
.method static synthetic ic()Landroid/os/Handler;
    ...
    sget-object v0, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
...
.method private init()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/B;->tp()V
...
.method private initOnlineConfig()V
    ...
    sget-wide v0, Lcom/android/server/am/B;->Xv:J
...
.method private nb(I)Lcom/android/server/am/B$tsu;
    ...
    iget-object v0, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    sput-wide v4, Lcom/android/server/am/B;->WE:J
    ...
    sput-wide v4, Lcom/android/server/am/B;->UE:J
    ...
    sput-wide v4, Lcom/android/server/am/B;->VE:J
    ...
    sput v4, Lcom/android/server/am/B;->XE:I
    ...
    iget-object v4, p0, Lcom/android/server/am/B;->ME:Ljava/util/HashSet;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/am/B;->ME:Ljava/util/HashSet;
    ...
    iget-object v6, p0, Lcom/android/server/am/B;->ME:Ljava/util/HashSet;
    ...
    sget-wide v0, Lcom/android/server/am/B;->WE:J
    ...
    sget-wide v0, Lcom/android/server/am/B;->UE:J
    ...
    sget v0, Lcom/android/server/am/B;->XE:I
    ...
    sget-wide v3, Lcom/android/server/am/B;->WE:J
    ...
    sget-wide v3, Lcom/android/server/am/B;->UE:J
    ...
    sget-wide v3, Lcom/android/server/am/B;->VE:J
...
.method private sis(Lcom/android/server/job/controllers/JobStatus;)Lcom/android/server/am/B$tsu;
    ...
    iget-object v2, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;
...
.method static synthetic sis(Lcom/android/server/am/B;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->NE:Ljava/lang/Object;
...
.method static synthetic ssp(Lcom/android/server/am/B;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->QE:Ljava/util/ArrayList;
...
.method private tsu(Lcom/android/server/am/B$you;)V
    ...
    iget-wide v4, p1, Lcom/android/server/am/B$you;->DE:J

    iget-object v7, p0, Lcom/android/server/am/B;->mAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    sget-object v8, Lcom/android/server/am/B;->nw:Landroid/os/Handler;
...
.method private vp()V
    ...
    iget-object v1, p0, Lcom/android/server/am/B;->SE:Landroid/util/SparseArray;
    ...
    iget-wide v4, v0, Lcom/android/server/am/B$you;->DE:J
    ...
    iget-object v1, p0, Lcom/android/server/am/B;->TE:Lcom/android/server/am/B$you;
    ...
    iget-wide v1, v0, Lcom/android/server/am/B$you;->DE:J

    iget-object v3, p0, Lcom/android/server/am/B;->TE:Lcom/android/server/am/B$you;

    iget-wide v3, v3, Lcom/android/server/am/B$you;->DE:J
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->TE:Lcom/android/server/am/B$you;
...
.method static synthetic you(Lcom/android/server/am/B;)Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p0, p0, Lcom/android/server/am/B;->LE:Lcom/oneplus/config/ConfigObserver;
...
.method private zta(Lcom/android/server/job/JobServiceContext;Lcom/android/server/job/controllers/JobStatus;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/B;->OE:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/server/am/B;->QE:Ljava/util/ArrayList;
    ...
    sget-object p2, Lcom/android/server/am/B;->nw:Landroid/os/Handler;

    invoke-virtual {p2, p0}, Landroid/os/Handler;->removeMessages(I)V

    sget p2, Lcom/android/server/am/B;->XE:I
    ...
    iget-object p2, p0, Lcom/android/server/am/B;->RE:Ljava/util/ArrayList;

    iget v2, p0, Lcom/android/server/am/B;->KE:I
    ...
    iget v0, p0, Lcom/android/server/am/B;->KE:I
    ...
    :cond_2
    iget p1, p0, Lcom/android/server/am/B;->KE:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Lcom/android/server/am/B;->KE:I
