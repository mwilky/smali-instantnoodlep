...
.field private kE:Ljava/util/regex/Pattern;

.field private lE:Ljava/util/regex/Pattern;

.field private mConfigObserver:Lcom/oneplus/config/ConfigObserver;

.field private mConfigUpdater:Lcom/android/server/am/r$zta;

.field private mContext:Landroid/content/Context;

.field private mE:Ljava/util/regex/Pattern;

.field private mHandler:Lcom/android/server/am/r$you;
...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v0, Lcom/android/server/am/r;->BETA_OR_ALPHA_ROM:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/r;->rk:Z

    const-wide/32 v1, 0x6ddd00

    iput-wide v1, p0, Lcom/android/server/am/r;->iE:J

    iput-boolean v0, p0, Lcom/android/server/am/r;->jE:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/am/r;->mLastResetTime:J
    ...
    iput-object v1, p0, Lcom/android/server/am/r;->kE:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, Lcom/android/server/am/r;->lE:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, Lcom/android/server/am/r;->mE:Ljava/util/regex/Pattern;

    iput-object p1, p0, Lcom/android/server/am/r;->mContext:Landroid/content/Context;

    new-instance p1, Lcom/android/server/am/r$you;
    ...
    invoke-direct {p1, p0, v1}, Lcom/android/server/am/r$you;-><init>(Lcom/android/server/am/r;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/am/r;->mHandler:Lcom/android/server/am/r$you;

    iget-object p1, p0, Lcom/android/server/am/r;->mHandler:Lcom/android/server/am/r$you;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p1

    iget-object p0, p0, Lcom/android/server/am/r;->mHandler:Lcom/android/server/am/r$you;
...
.method static synthetic rtg(Lcom/android/server/am/r;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/r;->jE:Z

    return p0
.end method

.method static synthetic sis(Lcom/android/server/am/r;)Landroid/content/Context;
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/am/r;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/am/r;->iE:J

    return-wide v0
.end method

.method static synthetic tsu(Lcom/android/server/am/r;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/r;->rk:Z

    return p0
.end method

.method static synthetic you(Lcom/android/server/am/r;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/r;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/am/r;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/am/r;->iE:J

    return-wide p1
.end method

.method static synthetic zta(Lcom/android/server/am/r;)Lcom/android/server/am/r$zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/r;->mConfigUpdater:Lcom/android/server/am/r$zta;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/am/r;Lcom/android/server/am/r$zta;)Lcom/android/server/am/r$zta;
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/r;->mConfigUpdater:Lcom/android/server/am/r$zta;

    return-object p1
.end method

.method static synthetic zta(Lcom/android/server/am/r;Lcom/oneplus/config/ConfigObserver;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/r;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    return-object p1
.end method

.method static synthetic zta(Lcom/android/server/am/r;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/am/r;->rk:Z
...
.method public collectBatteryStats(Lcom/android/internal/os/BatteryStatsImpl;IIIZ)V
    ...
    :cond_0
    sget-boolean p2, Lcom/android/server/am/r;->DEBUG_ONEPLUS:Z
    ...
    iget-boolean p4, p0, Lcom/android/server/am/r;->rk:Z

    if-eqz p4, :cond_2

    iget-wide p4, p0, Lcom/android/server/am/r;->mLastResetTime:J

    cmp-long p2, p2, p4

    if-eqz p2, :cond_2

    iget-object p2, p0, Lcom/android/server/am/r;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p3, p2}, Lcom/android/server/am/r;->zta(Ljava/lang/String;Landroid/os/DropBoxManager;)V

    invoke-virtual {p1}, Lcom/android/internal/os/BatteryStatsImpl;->getResetTime()J

    move-result-wide p1

    iput-wide p1, p0, Lcom/android/server/am/r;->mLastResetTime:J
...
.method public zta(Ljava/lang/String;Landroid/os/DropBoxManager;)V
    ...
    iget-boolean v3, v1, Lcom/android/server/am/r;->jE:Z
    ...
    iget-object v10, v1, Lcom/android/server/am/r;->kE:Ljava/util/regex/Pattern;
    ...
    sget-boolean v11, Lcom/android/server/am/r;->DEBUG_ONEPLUS:Z
    ...
    iget-object v10, v1, Lcom/android/server/am/r;->lE:Ljava/util/regex/Pattern;
    ...
    iget-object v10, v1, Lcom/android/server/am/r;->mE:Ljava/util/regex/Pattern;
    ...
    sget-boolean v10, Lcom/android/server/am/r;->DEBUG_ONEPLUS:Z
