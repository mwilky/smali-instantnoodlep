...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/OpForceDarkController;->sDevHighFreqLogEnable:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    if-eqz v1, :cond_0

    sget-boolean v1, Lcom/android/server/am/OpForceDarkController;->sDevHighFreqLogEnable:Z
    ...
    :cond_0
    sput-boolean v0, Lcom/android/server/am/OpForceDarkController;->DBG_DETAIL:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/OpForceDarkController;->mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;
    ...
    iput-object v0, p0, Lcom/android/server/am/OpForceDarkController;->mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;
    ...
    new-instance v0, Lcom/android/server/am/OpForceDarkController$1;

    invoke-direct {v0, p0}, Lcom/android/server/am/OpForceDarkController$1;-><init>(Lcom/android/server/am/OpForceDarkController;)V
...
.method static synthetic access$000(Lcom/android/server/am/OpForceDarkController;)Lcom/android/server/am/ActivityManagerService;
    .locals 0
...
.method static synthetic access$100(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;I)Ljava/util/List;
    .locals 0
...
.method static synthetic access$1000(Lcom/android/server/am/OpForceDarkController;)Landroid/os/Handler;
    .locals 0
...
.method static synthetic access$1100(Lcom/android/server/am/OpForceDarkController;)V
    .locals 0
...
.method static synthetic access$1200(Lcom/android/server/am/OpForceDarkController;Landroid/os/Message;)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;I)I
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/am/OpForceDarkController;I)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$1600(Lcom/android/server/am/OpForceDarkController;Lcom/android/server/am/OpForceDarkController$zta;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/OpForceDarkController;->scheduleNotifyChangedApp(Lcom/android/server/am/OpForceDarkController$zta;I)V

    return-void
.end method

.method static synthetic access$1700(Lcom/android/server/am/OpForceDarkController;)Lcom/android/server/am/OpForceDarkController$you;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/OpForceDarkController;->mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;

    return-object p0
.end method

.method static synthetic access$1800(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;)I
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/OpForceDarkController;->getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
...
.method static synthetic access$600(Lcom/android/server/am/OpForceDarkController;)Landroid/app/AppOpsManager;
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;)Z
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/am/OpForceDarkController;Z)V
    .locals 0
...
.method static synthetic access$900(Lcom/android/server/am/OpForceDarkController;Ljava/lang/String;)V
    .locals 0
...
.method private cacheEffectiveConfig(Lcom/android/server/am/OpForceDarkController$zta;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/OpForceDarkController$zta;->tb()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/server/am/OpForceDarkController$zta;->Lc()Ljava/lang/String;
...
.method private getCopyOfRawConfigForApp(Ljava/lang/String;)Lcom/android/server/am/OpForceDarkController$zta;
    ...
    iget-object p0, p0, Lcom/android/server/am/OpForceDarkController;->mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/OpForceDarkController$zta;->z(Ljava/lang/String;)V
...
.method private getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/OpForceDarkController$zta;->z(Ljava/lang/String;)V
...
.method private handlePackageChange(Landroid/os/Message;)V
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/server/am/OpForceDarkController;->mRefinedEffectiveConfigs:Landroid/util/LruCache;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, Lcom/android/server/am/OpForceDarkController;->mRefinedEffectiveConfigs:Landroid/util/LruCache;
    ...
    invoke-virtual {p0, v1, p1, v0, v6}, Landroid/app/AppOpsManager;->setMode(IILjava/lang/String;I)V
    ...
    invoke-virtual {v2, v1, p1, v0, v6}, Landroid/app/AppOpsManager;->setMode(IILjava/lang/String;I)V
...
.method private initAppOps()V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/am/r;-><init>(Lcom/android/server/am/OpForceDarkController;)V
...
.method private initOnlineConfig()V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/am/s;-><init>(Lcom/android/server/am/OpForceDarkController;)V
...
.method private parseAppsConfig(Lorg/json/JSONArray;)V
    ...
    invoke-virtual {v4}, Lcom/android/server/am/OpForceDarkController$zta;->tb()Ljava/lang/String;
...
.method private parseGlobalDefConfig(Lorg/json/JSONArray;)V
    ...
    iget-object p1, p0, Lcom/android/server/am/OpForceDarkController;->mGeneralAppConfig:Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-virtual {v1}, Lcom/android/server/am/OpForceDarkController$zta;->Lc()Ljava/lang/String;
...
.method private scheduleUpdateAppOpsDelay(J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/OpForceDarkController;->mHandler:Landroid/os/Handler;
...
.method private shouldForceDarkStartingWindow(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/am/OpForceDarkController;->getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/OpForceDarkController$zta;->s(I)Lcom/android/server/am/OpForceDarkController$you;
...
.method private updatePkgAppOps(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/OpForceDarkController;->getCopyOfRawConfigForApp(Ljava/lang/String;)Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object v2

    invoke-virtual {v2, v0, p2}, Lcom/android/server/am/OpForceDarkController$zta;->bvj(II)I

    move-result v3

    if-ne v3, v0, :cond_3

    invoke-direct {p0, v2}, Lcom/android/server/am/OpForceDarkController;->isNewDifferentConfig(Lcom/android/server/am/OpForceDarkController$zta;)Z
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, v2}, Lcom/android/server/am/OpForceDarkController;->cacheEffectiveConfig(Lcom/android/server/am/OpForceDarkController$zta;)V

    :goto_1
    invoke-direct {p0, v2, p2}, Lcom/android/server/am/OpForceDarkController;->scheduleNotifyChangedApp(Lcom/android/server/am/OpForceDarkController$zta;I)V
    ...
    :cond_5
    invoke-virtual {v2}, Lcom/android/server/am/OpForceDarkController$zta;->Oc()Z
...
.method public dispatchForceDarkConfig(Landroid/app/IApplicationThread;Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/OpForceDarkController;->getEffectiveConfigForApp(Ljava/lang/String;Z)Lcom/android/server/am/OpForceDarkController$zta;

    move-result-object v1

    iget v3, p2, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {v1, v3}, Lcom/android/server/am/OpForceDarkController$zta;->r(I)Ljava/lang/String;
...
.method public handleStartingWindow(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_2
    new-instance p2, Lcom/android/server/am/q;

    invoke-direct {p2, p0, v0, p1}, Lcom/android/server/am/q;-><init>(Lcom/android/server/am/OpForceDarkController;ZLandroid/view/View;)V
...
.method public init(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/IPackageManager;)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/OpForceDarkController$zta;->z(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/android/server/am/OpForceDarkController;->mGlobalFallbackConfig:Lcom/android/server/am/OpForceDarkController$you;

    const/4 p2, 0x1

    iput-boolean p2, p1, Lcom/android/server/am/OpForceDarkController$you;->KD:Z
