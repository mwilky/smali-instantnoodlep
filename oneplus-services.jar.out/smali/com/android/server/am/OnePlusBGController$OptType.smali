...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1, v3}, Lcom/android/server/am/OnePlusBGController$OptType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/android/server/am/OnePlusBGController$OptType;->S:Lcom/android/server/am/OnePlusBGController$OptType;
    ...
    invoke-direct {v0, v3, v2, v4}, Lcom/android/server/am/OnePlusBGController$OptType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/android/server/am/OnePlusBGController$OptType;->N:Lcom/android/server/am/OnePlusBGController$OptType;
    ...
    invoke-direct {v0, v4, v3, v5}, Lcom/android/server/am/OnePlusBGController$OptType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/android/server/am/OnePlusBGController$OptType;->O:Lcom/android/server/am/OnePlusBGController$OptType;

    const/4 v0, 0x3

    new-array v0, v0, [Lcom/android/server/am/OnePlusBGController$OptType;

    sget-object v4, Lcom/android/server/am/OnePlusBGController$OptType;->S:Lcom/android/server/am/OnePlusBGController$OptType;

    aput-object v4, v0, v1

    sget-object v1, Lcom/android/server/am/OnePlusBGController$OptType;->N:Lcom/android/server/am/OnePlusBGController$OptType;

    aput-object v1, v0, v2

    sget-object v1, Lcom/android/server/am/OnePlusBGController$OptType;->O:Lcom/android/server/am/OnePlusBGController$OptType;

    aput-object v1, v0, v3

    sput-object v0, Lcom/android/server/am/OnePlusBGController$OptType;->$VALUES:[Lcom/android/server/am/OnePlusBGController$OptType;
...
.method public static values()[Lcom/android/server/am/OnePlusBGController$OptType;
    ...
    sget-object v0, Lcom/android/server/am/OnePlusBGController$OptType;->$VALUES:[Lcom/android/server/am/OnePlusBGController$OptType;
