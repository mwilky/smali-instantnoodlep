.class public Lcom/android/server/am/irq$zta;
...
.method static final checkBroadcastIsPackageCanStart(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, v1, p2}, Lcom/android/server/am/irq$zta;->zta(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-static {}, Lcom/android/server/am/irq;->access$300()Z
...
.method private static getInstance()Lcom/android/server/am/irq$zta;
    .locals 1

    sget-object v0, Lcom/android/server/am/irq$zta;->mInstance:Lcom/android/server/am/irq$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/irq$zta;

    invoke-direct {v0}, Lcom/android/server/am/irq$zta;-><init>()V

    sput-object v0, Lcom/android/server/am/irq$zta;->mInstance:Lcom/android/server/am/irq$zta;
...
.method private setBlackAlarm(Ljava/util/List;)V
    ...
    sget-boolean p0, Lcom/android/server/am/irq;->DEBUG:Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {v2, v3, p1, p2}, Lcom/android/server/am/irq$zta;->zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, p1, p2, v3}, Lcom/android/server/am/irq$zta;->zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method private zta(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {p0}, Lcom/android/server/am/les;->k(I)Z
    ...
    invoke-static {p0}, Lcom/android/server/am/les;->l(I)Z
...
.method private zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    :cond_3
    invoke-static {p1}, Lcom/android/server/am/irq;->you(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {p0, v0, v4}, Lcom/android/server/am/irq$zta;->ear(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_c
    :goto_0
    invoke-static {}, Lcom/android/server/am/irq;->access$400()Z
    ...
    :cond_e
    invoke-direct {p0, v0}, Lcom/android/server/am/irq$zta;->Pb(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/irq$zta;->Ob(Ljava/lang/String;)Z
