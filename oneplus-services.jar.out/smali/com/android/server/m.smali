...
.method constructor <init>(Lcom/android/server/OpPowerControllerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p2, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object v0, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object p1, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object v1, p0, Lcom/android/server/m;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-static {p0}, Lcom/android/server/OpPowerControllerService;->access$1802(I)I

    :cond_12
    if-lez p1, :cond_13

    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$1902(I)I

    :cond_13
    if-lez v0, :cond_14

    invoke-static {v0}, Lcom/android/server/OpPowerControllerService;->access$2002(I)I

    :cond_14
    if-lez v2, :cond_15

    invoke-static {v2}, Lcom/android/server/OpPowerControllerService;->access$2102(I)I

    :cond_15
    if-lez v3, :cond_16

    invoke-static {v3}, Lcom/android/server/OpPowerControllerService;->access$2202(I)I

    :cond_16
    if-lez v4, :cond_17

    invoke-static {v4}, Lcom/android/server/OpPowerControllerService;->access$2302(I)I

    :cond_17
    if-lez v5, :cond_18

    invoke-static {v5}, Lcom/android/server/OpPowerControllerService;->access$2402(I)I

    :cond_18
    if-lez p2, :cond_1a

    invoke-static {p2}, Lcom/android/server/OpPowerControllerService;->access$2502(I)I
