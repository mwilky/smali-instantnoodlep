...
.field private static bI:Z = true

.field private static cI:Z = false

.field public static final dI:I = -0x63
...
# instance fields
.field private final BH:Ljava/util/HashSet;
...
.field private final CH:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private XH:Ljava/lang/Runnable;

.field private YH:Ljava/lang/Runnable;

.field private ZH:Ljava/lang/Runnable;

.field private _H:Landroid/content/BroadcastReceiver;
...
.field private wH:Lcom/oneplus/config/ConfigObserver;

.field private xH:Lcom/android/server/wm/OpScreenModeService;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/backlight/OpBacklightManager;->cI:Z
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;

    const/16 v0, 0x3e8

    iput v0, p0, Lcom/android/server/backlight/OpBacklightManager;->DH:I
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->mCurrentPkg:Ljava/lang/String;
    ...
    iput-boolean v1, p0, Lcom/android/server/backlight/OpBacklightManager;->EH:Z

    iput-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->FH:Z

    iput-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lcom/android/server/backlight/OpBacklightManager;->HH:J

    const/16 v1, 0xffe

    iput v1, p0, Lcom/android/server/backlight/OpBacklightManager;->IH:I

    const/16 v5, 0xd98

    iput v5, p0, Lcom/android/server/backlight/OpBacklightManager;->JH:I

    const v6, 0x75300

    iput v6, p0, Lcom/android/server/backlight/OpBacklightManager;->KH:I

    iput-boolean v0, p0, Lcom/android/server/backlight/OpBacklightManager;->LH:Z

    iput-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
    ...
    iput v1, p0, Lcom/android/server/backlight/OpBacklightManager;->PH:I

    iput v5, p0, Lcom/android/server/backlight/OpBacklightManager;->QH:I

    iput v2, p0, Lcom/android/server/backlight/OpBacklightManager;->RH:I

    const/16 v0, 0x190

    iput v0, p0, Lcom/android/server/backlight/OpBacklightManager;->SH:I

    const/16 v0, 0x17c

    iput v0, p0, Lcom/android/server/backlight/OpBacklightManager;->TH:I

    iput-wide v3, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J

    const/16 v0, 0x3a98

    iput v0, p0, Lcom/android/server/backlight/OpBacklightManager;->VH:I
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->XH:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->YH:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->_H:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->mDockDividerVisibilityListener:Lcom/android/server/backlight/OpBacklightManager$DockDividerVisibilityListener;
    ...
    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
...
.method public static E(Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/backlight/OpBacklightManager;->cI:Z
...
.method private Ip()V
    ...
    :cond_0
    iget v1, p0, Lcom/android/server/backlight/OpBacklightManager;->PH:I
    ...
    const-string v4, "special_wireless"
    ...
    iget v1, p0, Lcom/android/server/backlight/OpBacklightManager;->IH:I

    iget v2, p0, Lcom/android/server/backlight/OpBacklightManager;->JH:I
    ...
    iget-object v3, p0, Lcom/android/server/backlight/OpBacklightManager;->mDisplayPowerController:Lcom/android/server/display/IOpBacklightController;
    ...
    iget v9, p0, Lcom/android/server/backlight/OpBacklightManager;->mAdjustBrightnessInterval:I
...
.method private Lp()D
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/server/backlight/zta$zta;->ed()D
...
.method private Mp()I
    ...
    invoke-virtual {v1}, Lcom/android/server/backlight/zta;->ld()I
    ...
    invoke-virtual {p0}, Lcom/android/server/backlight/zta;->ld()I
...
.method private Np()V
    ...
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->_H:Landroid/content/BroadcastReceiver;
...
.method private Op()V
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/backlight/OpBacklightManager;->RH:I

    iget v1, p0, Lcom/android/server/backlight/OpBacklightManager;->SH:I
    ...
    iget-boolean v0, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/android/server/backlight/OpBacklightManager;->NH:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/android/server/backlight/OpBacklightManager;->OH:Z

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->XH:Ljava/lang/Runnable;
    ...
    :goto_1
    iget v5, p0, Lcom/android/server/backlight/OpBacklightManager;->RH:I

    iget v6, p0, Lcom/android/server/backlight/OpBacklightManager;->TH:I

    if-gt v5, v6, :cond_5

    iget-wide v5, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J
    ...
    iput-wide v5, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J
    ...
    iget-wide v7, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J

    sub-long/2addr v5, v7

    iget v7, p0, Lcom/android/server/backlight/OpBacklightManager;->VH:I
    ...
    iput-boolean v1, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
...
.method private Pp()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/backlight/OpBacklightManager;->cc(Ljava/lang/String;)Lcom/android/server/backlight/zta;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-direct {p0, v0}, Lcom/android/server/backlight/OpBacklightManager;->tsu(Lcom/android/server/backlight/zta;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v0}, Lcom/android/server/backlight/zta;->ld()I
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/backlight/zta;->updateStatus(I)V

    invoke-direct {p0, v0}, Lcom/android/server/backlight/OpBacklightManager;->zta(Lcom/android/server/backlight/zta;)I

    move-result v1

    add-int/lit8 v1, v1, -0x1

    invoke-virtual {v0, v1}, Lcom/android/server/backlight/zta;->v(I)I
    ...
    :cond_1
    invoke-direct {p0, v0}, Lcom/android/server/backlight/OpBacklightManager;->rtg(Lcom/android/server/backlight/zta;)V
...
.method private Wa(Z)V
    ...
    :try_start_0
    sget-boolean v1, Lcom/android/server/backlight/OpBacklightManager;->bI:Z
    ...
    sget-boolean v2, Lcom/android/server/backlight/OpBacklightManager;->bI:Z
    ...
    sput-boolean p1, Lcom/android/server/backlight/OpBacklightManager;->bI:Z

    sget-boolean p1, Lcom/android/server/backlight/OpBacklightManager;->bI:Z
    ...
    iget-object v1, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
    ...
    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/backlight/zta;->updateStatus(I)V

    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mHandler:Lcom/android/server/backlight/OpBacklightManager$you;

    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
...
.method private Xa(Z)V
    ...
    :try_start_0
    sget-boolean v1, Lcom/android/server/backlight/OpBacklightManager;->aI:Z
    ...
    sget-boolean v2, Lcom/android/server/backlight/OpBacklightManager;->aI:Z
    ...
    sput-boolean p1, Lcom/android/server/backlight/OpBacklightManager;->aI:Z

    sget-boolean p1, Lcom/android/server/backlight/OpBacklightManager;->aI:Z

    if-nez p1, :cond_2

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->FH:Z

    iput-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z

    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mHandler:Lcom/android/server/backlight/OpBacklightManager$you;

    iget-object v3, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/backlight/zta;->updateStatus(I)V
...
.method private Ya(Z)V
    ...
    iget-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
    ...
    iget-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->EH:Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backlight/OpBacklightManager;->cc(Ljava/lang/String;)Lcom/android/server/backlight/zta;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/backlight/OpBacklightManager;->Pp()V
...
.method private Za(Z)V
    ...
    iget-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->EH:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->FH:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->EH:Z
...
.method private _a(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/server/backlight/OpBacklightManager;->EH:Z
    ...
    :try_start_0
    iget-boolean v3, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z

    const/4 v4, 0x1

    if-nez v3, :cond_1

    iput-boolean v4, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v1

    iput-wide v1, p0, Lcom/android/server/backlight/OpBacklightManager;->HH:J

    goto/16 :goto_2

    :cond_1
    iget-boolean v3, p0, Lcom/android/server/backlight/OpBacklightManager;->FH:Z
    ...
    iget-wide v7, p0, Lcom/android/server/backlight/OpBacklightManager;->HH:J

    sub-long/2addr v5, v7

    iget v3, p0, Lcom/android/server/backlight/OpBacklightManager;->KH:I
    ...
    iget-wide v5, p0, Lcom/android/server/backlight/OpBacklightManager;->HH:J
    ...
    iget-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
    ...
    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;
    ...
    :cond_2
    iput-boolean v4, p0, Lcom/android/server/backlight/OpBacklightManager;->FH:Z

    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mHandler:Lcom/android/server/backlight/OpBacklightManager$you;

    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->YH:Ljava/lang/Runnable;
    ...
    iput-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z
...
.method static synthetic bio(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    iget p0, p0, Lcom/android/server/backlight/OpBacklightManager;->JH:I
...
.method static synthetic bvj(Lcom/android/server/backlight/OpBacklightManager;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z

    return p0
.end method

.method private cc(Ljava/lang/String;)Lcom/android/server/backlight/zta;
    .locals 4

    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;
    ...
    iget-object v1, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    :cond_5
    sget-boolean p0, Lcom/android/server/backlight/OpBacklightManager;->bI:Z
    ...
    invoke-static {p0}, Lcom/android/server/backlight/OpBacklightManager;->E(Ljava/lang/String;)V
...
.method private dc(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->xH:Lcom/android/server/wm/OpScreenModeService;
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    const-string v2, "     mTempMinBrightness="
    ...
    const-string v2, "     mTempMaxBrightness="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/server/backlight/OpBacklightManager;->PH:I
    ...
    iget v2, p0, Lcom/android/server/backlight/OpBacklightManager;->TH:I
    ...
    iget v2, p0, Lcom/android/server/backlight/OpBacklightManager;->VH:I
    ...
    iget-wide v2, p0, Lcom/android/server/backlight/OpBacklightManager;->UH:J
    ...
    const-string v2, "     mWirelessMinBrightness="
    ...
    const-string v2, "     mWirelessMaxBrightness="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/server/backlight/OpBacklightManager;->IH:I
    ...
    iget-boolean v2, p0, Lcom/android/server/backlight/OpBacklightManager;->GH:Z
    ...
    iget-wide v2, p0, Lcom/android/server/backlight/OpBacklightManager;->HH:J
    ...
    iget-object v2, p0, Lcom/android/server/backlight/OpBacklightManager;->mCurrentPkg:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;
...
.method static synthetic gck(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    invoke-direct {p0}, Lcom/android/server/backlight/OpBacklightManager;->Mp()I
...
.method static synthetic igw(Lcom/android/server/backlight/OpBacklightManager;)I
    .locals 0
...
.method static synthetic kth(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    iget p0, p0, Lcom/android/server/backlight/OpBacklightManager;->IH:I
...
.method static synthetic qbh(Lcom/android/server/backlight/OpBacklightManager;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/backlight/OpBacklightManager;->WH:Z
...
.method private resolvePerfConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-object v6, v0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v7, v0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v6, v0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;
    ...
    :try_start_3
    iget-object v7, v0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;
    ...
    :cond_5
    iget-object v6, v0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;
    ...
    :try_start_5
    iget-object v7, v0, Lcom/android/server/backlight/OpBacklightManager;->BH:Ljava/util/HashSet;
    ...
    iget-object v2, v0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
    ...
    :try_start_7
    iget-object v6, v0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v2}, Lcom/android/server/backlight/OpBacklightManager;->Xa(Z)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/backlight/OpBacklightManager;->Wa(Z)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/backlight/OpBacklightManager;->Ya(Z)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/backlight/OpBacklightManager;->Za(Z)V
    ...
    const-string v5, "minTempBrightness"
    ...
    const-string v5, "maxTempBrightness"
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->PH:I
    ...
    const-string v5, "minWirelessBrightness"
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->JH:I
    ...
    const-string v5, "maxWirelessBrightness"
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->IH:I
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->KH:I
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->TH:I
    ...
    iput v2, v0, Lcom/android/server/backlight/OpBacklightManager;->VH:I
...
.method static synthetic rtg(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    iget p0, p0, Lcom/android/server/backlight/OpBacklightManager;->DH:I
...
.method private rtg(Lcom/android/server/backlight/zta;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backlight/OpBacklightManager;->dc(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
...
.method static synthetic sis(Lcom/android/server/backlight/OpBacklightManager;)Lcom/android/server/display/IOpBacklightController;
    .locals 0
...
.method private sis(Lcom/android/server/backlight/zta;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/backlight/zta;->v(I)I
...
.method static synthetic ssp(Lcom/android/server/backlight/OpBacklightManager;)I
    ...
    iget p0, p0, Lcom/android/server/backlight/OpBacklightManager;->PH:I

    return p0
.end method

.method static synthetic tsu(Lcom/android/server/backlight/OpBacklightManager;)I
    .locals 0
...
.method static synthetic ugm(Lcom/android/server/backlight/OpBacklightManager;)Lcom/android/server/backlight/zta;
    .locals 0
...
.method static synthetic you(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)I
    .locals 0
...
.method static synthetic you(Lcom/android/server/backlight/OpBacklightManager;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/backlight/OpBacklightManager;->_a(Z)V
...
.method static synthetic you(Lcom/android/server/backlight/OpBacklightManager;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/backlight/OpBacklightManager;->MH:Z

    return p0
.end method

.method static synthetic ywr(Lcom/android/server/backlight/OpBacklightManager;)Lcom/android/server/backlight/OpBacklightManager$you;
    .locals 0
...
.method private ywr(Ljava/lang/String;I)V
    ...
    iget-object p2, p0, Lcom/android/server/backlight/OpBacklightManager;->ZH:Ljava/lang/Runnable;
...
.method private zta(Lcom/android/server/backlight/zta;Lcom/android/server/backlight/zta$zta;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/backlight/zta$zta;->ed()D

    move-result-wide v4

    invoke-virtual {p2}, Lcom/android/server/backlight/zta$zta;->ed()D
...
.method static synthetic zta(Lcom/android/server/backlight/OpBacklightManager;Lcom/android/server/backlight/zta;)Lcom/android/server/backlight/zta$zta;
    .locals 0
...
.method public d(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mDisplayPowerController:Lcom/android/server/display/IOpBacklightController;

    if-eqz p1, :cond_2

    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mContext:Landroid/content/Context;
    ...
    iget-boolean p1, p0, Lcom/android/server/backlight/OpBacklightManager;->OH:Z
    ...
    :cond_2
    :goto_0
    invoke-direct {p0}, Lcom/android/server/backlight/OpBacklightManager;->Op()V
...
.method public initOnlineConfig(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->wH:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->wH:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object v0, p0, Lcom/android/server/backlight/OpBacklightManager;->mDockDividerVisibilityListener:Lcom/android/server/backlight/OpBacklightManager$DockDividerVisibilityListener;
...
.method public qbh(IZ)V
    ...
    sget-boolean v0, Lcom/android/server/backlight/OpBacklightManager;->aI:Z
    ...
    :try_start_0
    iput p1, p0, Lcom/android/server/backlight/OpBacklightManager;->RH:I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/backlight/OpBacklightManager;->_a(Z)V
...
.method public sis(Ljava/lang/String;I)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mCurrentPkg:Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/android/server/backlight/OpBacklightManager;->WH:Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/backlight/zta;->updateStatus(I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/backlight/OpBacklightManager;->ywr(Ljava/lang/String;I)V

    :cond_7
    iget-object p0, p0, Lcom/android/server/backlight/OpBacklightManager;->mCurrentConfig:Lcom/android/server/backlight/zta;

    invoke-virtual {p0, p2}, Lcom/android/server/backlight/zta;->w(I)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/backlight/zta;->w(I)V
...
.method public updateHBMStatus(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->mLock:Ljava/lang/Object;
...
.method public zta(Lcom/android/server/wm/OpScreenModeService;)V
    ...
    iput-object p1, p0, Lcom/android/server/backlight/OpBacklightManager;->xH:Lcom/android/server/wm/OpScreenModeService;
...
.method public zta(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backlight/OpBacklightManager;->Xa(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/backlight/OpBacklightManager;->Wa(Z)V
    ...
    sput-boolean p0, Lcom/android/server/backlight/OpBacklightManager;->cI:Z
    ...
    iget-object v4, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Lcom/android/server/backlight/OpBacklightManager;->yH:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v1, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
    ...
    :try_start_5
    iget-object v6, p0, Lcom/android/server/backlight/OpBacklightManager;->zH:Ljava/util/HashSet;
    ...
    :try_start_9
    iget-object v3, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
    ...
    iget-object p2, p0, Lcom/android/server/backlight/OpBacklightManager;->CH:Ljava/util/HashMap;
