...
.field private static mInstance:Lcom/android/server/zgw;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/zgw;->DEBUG:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/zgw;->Re:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/zgw;->We:Ljava/util/ArrayList;

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/zgw;->mInstance:Lcom/android/server/zgw;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/zgw;->Le:Landroid/os/Handler;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/zgw;->Me:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/zgw;->Ne:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/zgw;->Oe:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/server/OnePlusGPSFreezer$1;

    invoke-direct {v0, p0}, Lcom/android/server/OnePlusGPSFreezer$1;-><init>(Lcom/android/server/zgw;)V

    iput-object v0, p0, Lcom/android/server/zgw;->mUidObserver:Landroid/app/IUidObserver;
...
.method private Na(I)V
    ...
    :cond_1
    invoke-direct {p0, p1, v1}, Lcom/android/server/zgw;->zgw(IZ)V

    invoke-direct {p0, p1, v1}, Lcom/android/server/zgw;->vdb(IZ)V
...
.method private Qa(I)Z
    ...
    iget-object v0, p0, Lcom/android/server/zgw;->Ne:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/android/server/zgw;->Me:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/zgw;->Oe:Ljava/util/ArrayList;
    ...
    sget-object p0, Lcom/android/server/zgw;->mPms:Landroid/content/pm/IPackageManager;

    invoke-interface {p0, p1}, Landroid/content/pm/IPackageManager;->getNameForUid(I)Ljava/lang/String;

    move-result-object p0

    sget-object v0, Lcom/android/server/zgw;->Re:Ljava/util/List;
    ...
    :try_start_1
    sget-object v1, Lcom/android/server/zgw;->Re:Ljava/util/List;
...
.method private Ra(I)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/zgw;->zgw(IZ)V

    invoke-direct {p0, p1, v0}, Lcom/android/server/zgw;->vdb(IZ)V
...
.method static synthetic access$400()Landroid/content/pm/IPackageManager;
    ...
    sget-object v0, Lcom/android/server/zgw;->mPms:Landroid/content/pm/IPackageManager;
...
.method public static isBlockedGpsUid(I)Z
    ...
    sget-object v0, Lcom/android/server/zgw;->We:Ljava/util/ArrayList;
...
.method static synthetic rtg(Lcom/android/server/zgw;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/zgw;->Na(I)V
...
.method private rtg(ZI)V
    ...
    iget-object p1, p0, Lcom/android/server/zgw;->Le:Landroid/os/Handler;

    invoke-static {p2, v1}, Lcom/android/server/zgw;->cjf(II)I

    move-result v1

    invoke-virtual {p1, v1}, Landroid/os/Handler;->removeMessages(I)V

    invoke-static {p2}, Lcom/android/server/zgw;->isBlockedGpsUid(I)Z
    ...
    invoke-static {p2, v2}, Lcom/android/server/zgw;->cjf(II)I
    ...
    iget-object p0, p0, Lcom/android/server/zgw;->Le:Landroid/os/Handler;
...
.method static synthetic sis(Lcom/android/server/zgw;I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/zgw;->Pa(I)I
...
.method static synthetic sis(Lcom/android/server/zgw;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic tsu(Lcom/android/server/zgw;I)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/zgw;->Qa(I)Z
...
.method private ugm(IZ)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/zgw;->rtg(ZI)V
    ...
    iget-object p2, p0, Lcom/android/server/zgw;->Ne:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/zgw;->Me:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/zgw;->Oe:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/zgw;->Le:Landroid/os/Handler;

    invoke-static {p1, v0}, Lcom/android/server/zgw;->cjf(II)I
...
.method public static updateLocationReceiverUidsChange(IZZZ)V
    ...
    :cond_0
    sget-object v0, Lcom/android/server/zgw;->mInstance:Lcom/android/server/zgw;
    ...
    sget-object p2, Lcom/android/server/zgw;->mInstance:Lcom/android/server/zgw;

    if-eqz p1, :cond_2

    if-eqz p3, :cond_1

    iget-object p2, p2, Lcom/android/server/zgw;->Ne:Ljava/util/ArrayList;

    goto :goto_0

    :cond_1
    iget-object p2, p2, Lcom/android/server/zgw;->Me:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lcom/android/server/zgw;->Oe:Ljava/util/ArrayList;
    ...
    invoke-direct {p2, p0, p1}, Lcom/android/server/zgw;->ugm(IZ)V
...
.method private vdb(IZ)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/zgw;->zgw(IZ)V

    iget-object p2, p0, Lcom/android/server/zgw;->Qe:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/zgw;->mReceivers:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lcom/android/server/zgw;->mProviders:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/zgw;->Pe:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
...
.method static synthetic you(Lcom/android/server/zgw;I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/zgw;->Oa(I)I
...
.method static synthetic you(Lcom/android/server/zgw;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, Lcom/android/server/zgw;->Me:Ljava/util/ArrayList;
...
.method public static you(Ljava/util/List;)V
    ...
    sget-boolean p0, Lcom/android/server/zgw;->DEBUG:Z
    ...
    sget-object v2, Lcom/android/server/zgw;->Re:Ljava/util/List;
...
.method private zgw(IZ)V
    ...
    sget-object p0, Lcom/android/server/zgw;->We:Ljava/util/ArrayList;
...
.method static synthetic zta(Lcom/android/server/zgw;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, Lcom/android/server/zgw;->Ne:Ljava/util/ArrayList;
...
.method public static zta(IZZ)V
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/android/server/zgw;->updateLocationReceiverUidsChange(IZZZ)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/zgw;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/zgw;->Ra(I)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/zgw;ZI)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/zgw;->rtg(ZI)V
...
.method public initFromLMS(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$LocationManagerServiceInner;)V
    ...
    iput-object p2, p0, Lcom/android/server/zgw;->Pe:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;

    invoke-virtual {p2}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getLock()Ljava/lang/Object;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/zgw;->Qe:Ljava/lang/Object;

    invoke-virtual {p2}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getReceivers()Ljava/util/HashMap;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/zgw;->mReceivers:Ljava/util/HashMap;
    ...
    iput-object p1, p0, Lcom/android/server/zgw;->mProviders:Ljava/util/ArrayList;
    ...
    sput-object p0, Lcom/android/server/zgw;->We:Ljava/util/ArrayList;
...
.method public zta(Landroid/content/pm/IPackageManager;)V
    ...
    sput-object p1, Lcom/android/server/zgw;->mPms:Landroid/content/pm/IPackageManager;
...
.method public zta(Lcom/android/server/am/ActivityManagerService;)V
    ...
    sget-object v0, Lcom/android/server/zgw;->mAms:Lcom/android/server/am/ActivityManagerService;

    if-nez v0, :cond_0

    sput-object p1, Lcom/android/server/zgw;->mAms:Lcom/android/server/am/ActivityManagerService;

    sget-object p1, Lcom/android/server/zgw;->mAms:Lcom/android/server/am/ActivityManagerService;

    iget-object p0, p0, Lcom/android/server/zgw;->mUidObserver:Landroid/app/IUidObserver;
