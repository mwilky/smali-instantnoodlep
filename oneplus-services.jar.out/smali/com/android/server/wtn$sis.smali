...
.method constructor <init>(Lcom/android/server/wtn;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_0
    iget-object v1, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v1}, Lcom/android/server/wtn;->rtg(Lcom/android/server/wtn;)Z
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->obl(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v4, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v4}, Lcom/android/server/wtn;->obl(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;

    move-result-object v4

    iget-object v0, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;
    ...
    iget-object v2, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v2}, Lcom/android/server/wtn;->obl(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v1, v1, Lcom/android/server/wtn;->mBatteryManager:Landroid/os/BatteryManager;
    ...
    invoke-static {v0}, Lcom/android/server/wtn;->cjf(Lcom/android/server/wtn;)V
    ...
    invoke-static {v0}, Lcom/android/server/wtn;->oxb(Lcom/android/server/wtn;)Landroid/app/Notification;
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->ear(Lcom/android/server/wtn;)Landroid/content/Context;
    ...
    iget-object v13, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v13}, Lcom/android/server/wtn;->lqr(Lcom/android/server/wtn;)J
    ...
    iget-object v8, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v8}, Lcom/android/server/wtn;->zgw(Lcom/android/server/wtn;)Landroid/app/AlarmManager;
    ...
    invoke-static {v8}, Lcom/android/server/wtn;->ear(Lcom/android/server/wtn;)Landroid/content/Context;
    ...
    invoke-static {v8, v13}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;Landroid/app/AlarmManager;)Landroid/app/AlarmManager;
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->lqr(Lcom/android/server/wtn;)J
    ...
    invoke-static {v1, v6, v15}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v1}, Lcom/android/server/wtn;->ire(Lcom/android/server/wtn;)I
    ...
    invoke-virtual {v1, v15}, Lcom/android/server/wtn;->vdb(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/server/wtn;->zgw(Lcom/android/server/wtn;)Landroid/app/AlarmManager;
    ...
    invoke-static {v1, v2, v15}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->bvj(Lcom/android/server/wtn;)Lcom/android/server/wtn$zta;

    move-result-object v2

    iget-object v3, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v3}, Lcom/android/server/wtn;->ibl(Lcom/android/server/wtn;)Landroid/content/IntentFilter;
    ...
    invoke-static {v3}, Lcom/android/server/wtn;->gwm(Lcom/android/server/wtn;)Lcom/android/server/wtn$you;
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->hmo(Lcom/android/server/wtn;)Z
    ...
    invoke-static {v0}, Lcom/android/server/wtn;->gwm(Lcom/android/server/wtn;)Lcom/android/server/wtn$you;
    ...
    invoke-static {}, Lcom/android/server/wtn$tsu;->access$2500()Lcom/android/server/wtn$tsu;

    move-result-object v5

    iget-wide v5, v5, Lcom/android/server/wtn$tsu;->ld:J
    ...
    iget-wide v5, v5, Lcom/android/server/wtn$tsu;->md:J
    ...
    invoke-static {v5}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;)I
    ...
    invoke-virtual {v5}, Lcom/android/server/wtn;->F()I
    ...
    iget-wide v5, v5, Lcom/android/server/wtn$tsu;->nd:J
    ...
    iget-wide v5, v5, Lcom/android/server/wtn$tsu;->od:J
    ...
    invoke-static {v5}, Lcom/android/server/wtn;->oif(Lcom/android/server/wtn;)I
    ...
    invoke-static {v5}, Lcom/android/server/wtn;->ywr(Lcom/android/server/wtn;)I
    ...
    invoke-static {v5}, Lcom/android/server/wtn;->igw(Lcom/android/server/wtn;)I
    ...
    iget-object v6, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v6}, Lcom/android/server/wtn;->oif(Lcom/android/server/wtn;)I
    ...
    invoke-static {v6}, Lcom/android/server/wtn;->ywr(Lcom/android/server/wtn;)I
    ...
    invoke-static {v6}, Lcom/android/server/wtn;->igw(Lcom/android/server/wtn;)I
    ...
    invoke-static {v5, v4}, Lcom/android/server/wtn;->rtg(Lcom/android/server/wtn;I)I

    iget-object v4, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v4, v9}, Lcom/android/server/wtn;->tsu(Lcom/android/server/wtn;I)I

    iget-object v4, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v4, v9}, Lcom/android/server/wtn;->sis(Lcom/android/server/wtn;I)I
    ...
    invoke-virtual {v2}, Lcom/android/server/wtn$tsu;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$tsu;->clear()V

    iget-object v0, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-virtual {v0}, Lcom/android/server/wtn;->K()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$tsu;->A()V

    invoke-static {}, Lcom/android/server/wtn$tsu;->access$2500()Lcom/android/server/wtn$tsu;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/server/wtn$tsu;->C()V

    iget-object v1, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-virtual {v1}, Lcom/android/server/wtn;->E()V
    ...
    invoke-static {v1, v4, v5}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;J)J
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->lqr(Lcom/android/server/wtn;)J
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$tsu;->z()V
    ...
    invoke-static {v0}, Lcom/android/server/wtn;->fto(Lcom/android/server/wtn;)Lcom/android/server/wtn$sis;
    ...
    invoke-virtual {v0}, Lcom/android/server/wtn$tsu;->B()V

    invoke-static {}, Lcom/android/server/wtn$tsu;->access$2500()Lcom/android/server/wtn$tsu;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/server/wtn$tsu;->C()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wtn;->D()V
    ...
    invoke-static {v1, v2}, Lcom/android/server/wtn;->ssp(Lcom/android/server/wtn;I)I
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->ire(Lcom/android/server/wtn;)I
    ...
    iget-object v2, v2, Lcom/android/server/wtn;->mBatteryManager:Landroid/os/BatteryManager;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/wtn$tsu;->zta(J)V
    ...
    invoke-static {v6}, Lcom/android/server/wtn;->ire(Lcom/android/server/wtn;)I
    ...
    iget-object v7, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v7}, Lcom/android/server/wtn;->tsu(Lcom/android/server/wtn;)Z
    ...
    invoke-static {v4}, Lcom/android/server/wtn;->lqr(Lcom/android/server/wtn;)J
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->ugm(Lcom/android/server/wtn;)J
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/wtn;->vdb(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->you(Lcom/android/server/wtn;)J

    move-result-wide v13

    iget-object v1, v0, Lcom/android/server/wtn$sis;->this$0:Lcom/android/server/wtn;

    invoke-static {v1}, Lcom/android/server/wtn;->vdb(Lcom/android/server/wtn;)J
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->zgw(Lcom/android/server/wtn;)Landroid/app/AlarmManager;
    ...
    invoke-virtual {v0}, Lcom/android/server/wtn;->E()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn;->D()V
    ...
    invoke-virtual {v1, v7}, Lcom/android/server/wtn;->vdb(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v8, v15}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v7, v8}, Lcom/android/server/wtn$tsu;->you(J)V
    ...
    invoke-static {v4}, Lcom/android/server/wtn;->ear(Lcom/android/server/wtn;)Landroid/content/Context;
    ...
    invoke-static {v4}, Lcom/android/server/wtn;->zgw(Lcom/android/server/wtn;)Landroid/app/AlarmManager;
