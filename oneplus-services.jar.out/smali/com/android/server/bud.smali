...
.field final mConfigHandler:Lcom/android/server/bud$zta;

.field private mContext:Landroid/content/Context;

.field private mEnableLogDump:Z

.field mOpAlarmAlignment:Lcom/android/server/vju;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/bud;->mIsDeepSleep:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/bud;->Rg:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/bud;->mEnableLogDump:Z

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/bud;->Dg:[I

    new-instance v1, Lcom/android/server/bud$zta;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/bud$zta;-><init>(Lcom/android/server/bud;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/bud;->mConfigHandler:Lcom/android/server/bud$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/bud;->Gg:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/bud;->Hg:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/bud;->Ig:Ljava/util/List;

    iput-boolean v0, p0, Lcom/android/server/bud;->Jg:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/bud;->Kg:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/bud;->Lg:Ljava/util/List;
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/bud;->Gg:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/bud$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/bud$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/bud;->Gg:Ljava/util/HashMap;
...
.method private zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    ...
    iget-object p0, p0, Lcom/android/server/bud;->Gg:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/bud$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/bud$you;->Cg:Ljava/lang/String;
    ...
    sget-boolean p0, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/bud$you;->Bg:J
...
.method static synthetic zta(Lcom/android/server/bud;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/bud;->mContext:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/bud;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/bud;->zta(Lorg/json/JSONArray;)V
...
.method private zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    sget-boolean v3, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
...
.method private zta(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/bud;->Ig:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/bud;->Ig:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/bud;->Ig:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/bud;->Hg:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/bud;->Ig:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, Lcom/android/server/bud;->Lg:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/bud;->Lg:Ljava/util/List;
    ...
    sget-boolean v7, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/bud;->Lg:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/server/bud;->Kg:Ljava/util/HashMap;

    iget-object v6, p0, Lcom/android/server/bud;->Lg:Ljava/util/List;

    invoke-direct {p0, v3, v6, v5}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/bud;->kth(Ljava/util/List;)V
    :try_end_8
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/bud;->ng:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/bud;->ng:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/bud;->mOpAlarmAlignment:Lcom/android/server/vju;
    ...
    check-cast v4, Lcom/android/server/vju;

    iput-object v4, v0, Lcom/android/server/bud;->mOpAlarmAlignment:Lcom/android/server/vju;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/vju;->zgw(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/bud;->clampPositive(J)J
    ...
    iget-object v5, v0, Lcom/android/server/bud;->ng:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z
    ...
    sget-object v5, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Lcom/android/server/bud;->Hg:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/bud;->Jg:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/bud;->Kg:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifEnableLogDump()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/bud;->mEnableLogDump:Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/bud;->DEBUG_ONEPLUS:Z

    if-ne v4, v3, :cond_2

    iget-object p2, p0, Lcom/android/server/bud;->Hg:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/bud;->Kg:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v3}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/android/server/bud;->zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/bud;->mIsDeepSleep:Z
    ...
    iget-object v0, p0, Lcom/android/server/bud;->mOpAlarmAlignment:Lcom/android/server/vju;
    ...
    iput-object v0, p0, Lcom/android/server/bud;->mOpAlarmAlignment:Lcom/android/server/vju;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/vju;->zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/bud;->oxb(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/bud;->mAms:Lcom/android/server/AlarmManagerService;

    iput-object p2, p0, Lcom/android/server/bud;->mContext:Landroid/content/Context;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/bud;->zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/bud;->ng:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/bud;->Jg:Z
    ...
    iget-object v2, p0, Lcom/android/server/bud;->Kg:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, Lcom/android/server/bud;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V

    :cond_3
    new-instance p1, Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/bud;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/bud;->Fg:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/bud;->mConfigHandler:Lcom/android/server/bud$zta;

    new-instance v2, Lcom/android/server/bud$sis;

    invoke-direct {v2, p0}, Lcom/android/server/bud$sis;-><init>(Lcom/android/server/bud;)V
    ...
    iput-object p1, p0, Lcom/android/server/bud;->Mg:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, Lcom/android/server/bud;->Mg:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/bud;->Eg:Ljava/util/List;

    sget-object p1, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/bud;->mConfigHandler:Lcom/android/server/bud$zta;
...
.method public oxb(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/bud;->Rg:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/bud;->Rg:Ljava/util/List;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/bud;->mIsDeepSleep:Z
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/bud;->Dg:[I
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/bud;->Jg:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    ...
    iget-object p0, p0, Lcom/android/server/bud;->Eg:Ljava/util/List;
...
.method protected zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    ...
    iput-boolean p1, p0, Lcom/android/server/bud;->mEnableLogDump:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/vju;->qbh(Z)Z
