.class public Lcom/android/server/wm/w;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/w;->mOriginalDisplayRect:Landroid/graphics/Rect;
...
.method private zta(Landroid/graphics/Bitmap;II)I
    ...
    :cond_6
    new-instance p1, Lcom/android/server/wm/v;

    invoke-direct {p1, p0}, Lcom/android/server/wm/v;-><init>(Lcom/android/server/wm/w;)V
...
.method private zta(ILandroid/view/animation/Animation;Landroid/view/animation/Animation;II)V
    ...
    iget v4, v0, Lcom/android/server/wm/w;->mOriginalWidth:I

    iget v5, v0, Lcom/android/server/wm/w;->mOriginalHeight:I
    ...
    iget v3, v0, Lcom/android/server/wm/w;->mOriginalWidth:I

    iget v4, v0, Lcom/android/server/wm/w;->mOriginalHeight:I
    ...
    :cond_4
    :goto_2
    iget v1, v0, Lcom/android/server/wm/w;->mOriginalWidth:I

    iget v2, v0, Lcom/android/server/wm/w;->mOriginalHeight:I
    ...
    iget v0, v0, Lcom/android/server/wm/w;->mOriginalHeight:I
...
.method public init(Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;)V
    ...
    :cond_0
    iput-object p4, p0, Lcom/android/server/wm/w;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-object p5, p0, Lcom/android/server/wm/w;->mSurfaceControl:Landroid/view/SurfaceControl;

    iput-object p1, p0, Lcom/android/server/wm/w;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object p3, p0, Lcom/android/server/wm/w;->mOriginalDisplayRect:Landroid/graphics/Rect;
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/w;->mForceDefaultOrientation:Z
    ...
    :cond_2
    iput p2, p0, Lcom/android/server/wm/w;->mWidth:I

    iput p1, p0, Lcom/android/server/wm/w;->mHeight:I

    goto :goto_2

    :cond_3
    :goto_1
    iput p1, p0, Lcom/android/server/wm/w;->mWidth:I

    iput p2, p0, Lcom/android/server/wm/w;->mHeight:I

    :goto_2
    iput p4, p0, Lcom/android/server/wm/w;->mOriginalRotation:I

    iput p2, p0, Lcom/android/server/wm/w;->mOriginalWidth:I

    iput p1, p0, Lcom/android/server/wm/w;->mOriginalHeight:I
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wm/w;->zta(Landroid/graphics/Bitmap;II)I
...
.method public initBlackFrame(Landroid/view/SurfaceControl$Transaction;ZIIZ)Lcom/android/server/wm/BlackFrame;
    ...
    iget-object v6, p0, Lcom/android/server/wm/w;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
...
.method public loadAnimation(IZII)Landroid/view/animation/Animation;
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/w;->mContext:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/android/server/wm/w;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/wm/w;->zta(ILandroid/view/animation/Animation;Landroid/view/animation/Animation;II)V
...
.method public stepAnimation(JILandroid/view/animation/Animation;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/w;->sis(F)Landroid/graphics/Color;
    ...
    iget p1, p0, Lcom/android/server/wm/w;->mOriginalRotation:I
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/wm/w;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget p4, p0, Lcom/android/server/wm/w;->mHeight:I

    iget v2, p0, Lcom/android/server/wm/w;->mWidth:I
    ...
    iget p4, p0, Lcom/android/server/wm/w;->mWidth:I

    iget v2, p0, Lcom/android/server/wm/w;->mHeight:I
    ...
    iget p2, p0, Lcom/android/server/wm/w;->mOriginalRotation:I
