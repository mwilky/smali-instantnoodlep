...
.field Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;
...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Sca:Z
    ...
    iput-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;
...
.method private clear()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;

    invoke-static {v1}, Lcom/android/server/wm/OpPowerConsumpStats$ywr;->sis(Lcom/android/server/wm/OpPowerConsumpStats$ywr;)V

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Sca:Z
...
.method static synthetic cno(Lcom/android/server/wm/OpPowerConsumpStats$cno;)Lcom/android/server/wm/OpPowerConsumpStats$ssp;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$cno;->js()Lcom/android/server/wm/OpPowerConsumpStats$ssp;
...
.method private jc(I)Z
    ...
    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;

    invoke-static {v3}, Lcom/android/server/wm/OpPowerConsumpStats$ywr;->sis(Lcom/android/server/wm/OpPowerConsumpStats$ywr;)V

    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Sca:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Mca:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Nca:I
    ...
    iput-object p1, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Rca:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Mca:J
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Nca:I
...
.method private js()Lcom/android/server/wm/OpPowerConsumpStats$ssp;
    .locals 6
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Lca:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Lca:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Mca:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Nca:I

    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Nca:I
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Oca:I

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Rca:Ljava/lang/String;

    iput-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Rca:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Qca:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Qca:J

    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Pca:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Mca:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Nca:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Oca:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Rca:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Qca:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Pca:J
...
.method private ms()Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Sca:Z
    ...
    iget-wide v5, v5, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J

    sub-long/2addr v3, v5

    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Qca:J
    ...
    iget-wide v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Qca:J
...
.method private ns()Z
    ...
    iput-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Rca:Ljava/lang/String;
...
.method static synthetic rtg(Lcom/android/server/wm/OpPowerConsumpStats$cno;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ms()Z
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$cno;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ks()V
...
.method private stopTiming()Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Lca:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Kca:J
    ...
    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->Tca:Lcom/android/server/wm/OpPowerConsumpStats$ywr;

    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$ssp;

    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Lca:J
    ...
    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats;->Vda:Ljava/util/ArrayList;
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Oca:I
    ...
    iget-wide v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$ssp;->Pca:J
...
.method static synthetic tsu(Lcom/android/server/wm/OpPowerConsumpStats$cno;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ns()Z
...
.method static synthetic you(Lcom/android/server/wm/OpPowerConsumpStats$cno;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ls()V
