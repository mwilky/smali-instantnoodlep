...
.method private os()Lcom/android/server/wm/OpPowerConsumpStats$bio;
    .locals 6
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$igw;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$bio;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Mca:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Mca:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$igw;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$bio;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Nca:I

    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Nca:I
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Lca:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Lca:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J
    ...
    iput p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Oca:I

    const-string p0, "StillContinuing"

    iput-object p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Uca:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Mca:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Nca:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Oca:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Uca:Ljava/lang/String;
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$igw;)Lcom/android/server/wm/OpPowerConsumpStats$bio;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$igw;->os()Lcom/android/server/wm/OpPowerConsumpStats$bio;
...
.method private startTiming()Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Mca:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Nca:I
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Mca:J
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Nca:I
...
.method private stopTiming(Ljava/lang/String;)Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Lca:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$igw;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$bio;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Kca:J
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Oca:I

    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$igw;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$bio;

    iput-object p1, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Uca:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OpPowerConsumpStats;->Uda:Ljava/util/ArrayList;
    ...
    iget-wide v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Lca:J
    ...
    iget v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$bio;->Oca:I
