...
# instance fields
.field final synthetic Mha:Landroid/graphics/Rect;

.field final synthetic Nha:Lcom/android/server/wm/WindowState;

.field final synthetic Oha:Z
...
.method constructor <init>(Lcom/android/server/wm/OpScreenCompat;Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;Z)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/q;->this$0:Lcom/android/server/wm/OpScreenCompat;

    iput-object p2, p0, Lcom/android/server/wm/q;->Mha:Landroid/graphics/Rect;

    iput-object p3, p0, Lcom/android/server/wm/q;->Nha:Lcom/android/server/wm/WindowState;

    iput-boolean p4, p0, Lcom/android/server/wm/q;->Oha:Z
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/wm/q;->Mha:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->height()I

    move-result v0

    iget-object v1, p0, Lcom/android/server/wm/q;->Mha:Landroid/graphics/Rect;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/server/wm/q;->Nha:Lcom/android/server/wm/WindowState;

    iget-object v1, v1, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;

    iget-boolean v2, p0, Lcom/android/server/wm/q;->Oha:Z
