...
.field private Qba:Landroid/util/SparseArray;
...
.field kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;
...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Nr:Z
    ...
    iput-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;

    iput-boolean v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->lca:Z

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->mStartTimeMs:J

    iput-boolean v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->mca:Z

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Qba:Landroid/util/SparseArray;
    ...
    iget-boolean p2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Nr:Z
...
.method private ds()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Qba:Landroid/util/SparseArray;
...
.method private rb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->lca:Z
...
.method public Oe()V
    ...
    iput v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->hca:I

    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->mca:Z

    if-nez v1, :cond_1

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->mca:Z

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->lca:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;
    ...
    iget v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->ica:I
    ...
    iget-wide v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->jca:J
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->lca:Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$gck;->ds()Ljava/lang/String;
...
.method you(Lcom/android/server/wm/OpPowerConsumpStats$StatusType;)V
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Nr:Z
...
.method public zta(Lcom/android/server/wm/OpPowerConsumpStats$SettleType;)Lcom/android/server/wm/OpPowerConsumpStats$rtg;
    ...
    iget v8, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->hca:I
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->hca:I
    ...
    iget v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->hca:I
    ...
    sget-object v0, Lcom/android/server/wm/lqr;->Dba:[I
    ...
    :cond_4
    iget p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->ica:I

    add-int/2addr p1, v12

    iput p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->ica:I

    iget-wide v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->jca:J

    add-long/2addr v4, v10

    iput-wide v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->jca:J

    iget-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->this$0:Lcom/android/server/wm/OpPowerConsumpStats;

    iget-object v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Qba:Landroid/util/SparseArray;
...
.method zta(Lcom/android/server/wm/OpPowerConsumpStats$StatusType;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;
    ...
    :cond_3
    :goto_1
    iput-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;

    iget-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->kca:Lcom/android/server/wm/OpPowerConsumpStats$StatusType;
...
.method public zta(Lcom/android/server/wm/OpPowerConsumpStats$tsu;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$gck;->Qba:Landroid/util/SparseArray;
    ...
    iget-object v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Qba:Landroid/util/SparseArray;
    ...
    iget-object v3, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Qba:Landroid/util/SparseArray;
    ...
    :goto_1
    iget-wide v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Sba:J
    ...
    iput-wide v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Sba:J

    iget v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Rba:I
    ...
    iput v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->Rba:I
