...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;ILcom/android/server/wm/OpPowerConsumpStats$NetworkType;JI)V
    ...
    sget-object p1, Lcom/android/server/wm/OpPowerConsumpStats$NetworkType;->QCa:Lcom/android/server/wm/OpPowerConsumpStats$NetworkType;
    ...
    iput p2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Hca:I
    ...
    iput-wide p4, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ica:J

    iput p6, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
...
.method static synthetic rtg(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)I
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
...
.method static synthetic tsu(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)J
    ...
    iget-wide v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ica:J
...
.method static synthetic you(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)I
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Hca:I
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$rtg;I)I
    ...
    iget v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I

    add-int/2addr v0, p1

    iput v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$rtg;J)J
    ...
    iput-wide v0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ica:J
...
.method public add(JI)V
    ...
    iget p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I

    add-int/2addr p1, p3

    iput p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
...
.method public ssp(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)V
    ...
    iget-wide v2, p1, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ica:J
    ...
    iget p1, p1, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Hca:I
    ...
    iget v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Jca:I
    ...
    iget-wide v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ica:J
