...
.field private static final MSG_RESET_CPUSET_SURFACEFLINGER:I = 0x7

.field private static final MSG_SET_CPUSET_SURFACEFLINGER:I = 0x6
...
.method static synthetic access$500(Lcom/android/server/wm/OnePlusPerfManager;Lorg/json/JSONArray;)V
    .locals 0
...
.method private getPkgPerfLock(Ljava/lang/String;)I
    ...
    iget-object v2, p0, Lcom/android/server/wm/OnePlusPerfManager$you;->_d:Ljava/lang/String;
...
.method private mayPerfRelease()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/OnePlusPerfManager$rtg;->Ke()V
    ...
    iget-object v4, v4, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;

    invoke-virtual {v2, v1}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->ka(Ljava/lang/String;)Z
...
.method private perfAcquire(Lcom/android/server/wm/OnePlusPerfManager$rtg;I)Z
    ...
    iget-object p2, p2, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;

    iget-object v1, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
    ...
    iget-object v4, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/OnePlusPerfManager$sis;->Je()[I
    ...
    :try_start_6
    iget-object p2, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;

    invoke-virtual {v1, p2}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->la(Ljava/lang/String;)Z
...
.method private resolvePerfConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iput-object v4, v8, Lcom/android/server/wm/OnePlusPerfManager$you;->_d:Ljava/lang/String;
    ...
    iput-object v7, v9, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
...
.method private startSpeedSchedtune(Ljava/lang/String;)V
    ...
    iget-object v0, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->la(Ljava/lang/String;)Z
...
.method public acquirePccore()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->la(Ljava/lang/String;)Z
...
.method public acquirePerfForStartSpeed(Ljava/lang/String;Landroid/util/BoostFramework;)Z
    ...
    sput-boolean v1, Lcom/android/server/wm/ActivityDisplay;->mPerfSendTapHint:Z
...
.method public isUsingPccore(Ljava/lang/String;)Z
    ...
    iget p0, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->mMode:I

    const/4 v1, 0x5

    if-ne p0, v1, :cond_1

    iget-object p0, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->_d:Ljava/lang/String;
...
.method public mayChangeInodeIndex(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/OnePlusPerfManager$you;->_d:Ljava/lang/String;
...
.method public releasePccore()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->ka(Ljava/lang/String;)Z
