...
.field static final yba:I = 0x1eab92
...
.field nba:Landroid/view/SurfaceControl;
...
.field private final xba:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;I)V
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->oba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->pba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->qba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->rba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->sba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->tba:Z

    iput-boolean v6, v1, Lcom/android/server/wm/obl;->uba:Z

    invoke-static {}, Lcom/android/server/policy/OpPhoneWindowManagerInjector;->isGestureButtonEnabled()Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/server/wm/obl;->vba:Z
    ...
    iput-object v8, v1, Lcom/android/server/wm/obl;->xba:Landroid/view/animation/Interpolator;
    ...
    iput v4, v1, Lcom/android/server/wm/obl;->wba:I
    ...
    :pswitch_1
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->rba:Z

    goto :goto_0

    :pswitch_2
    iput-boolean v6, v1, Lcom/android/server/wm/obl;->oba:Z
    ...
    :goto_0
    iget-boolean v11, v1, Lcom/android/server/wm/obl;->rba:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->qba:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->pba:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->uba:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->sba:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/obl;->tba:Z
    ...
    invoke-static {}, Lcom/android/server/wm/vdb;->Oe()Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-static {}, Lcom/android/server/wm/vdb;->Pe()Lcom/android/server/wm/AppWindowToken;
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->pba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->qba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->uba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->oba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->rba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->sba:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/obl;->tba:Z
    ...
    :try_start_0
    iget-boolean v10, v1, Lcom/android/server/wm/obl;->pba:Z
    :try_end_0
    ...
    :try_start_1
    iget-boolean v10, v1, Lcom/android/server/wm/obl;->rba:Z
    ...
    iput-object v2, v1, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
    ...
    :goto_d
    iget-object v0, v1, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
...
.method private startAnimation(Landroid/view/SurfaceControl$Transaction;JFIIZII)Z
    ...
    iget-object v6, v0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
    ...
    :cond_4
    iget-boolean v12, v0, Lcom/android/server/wm/obl;->rba:Z
    ...
    :cond_5
    iget-boolean v12, v0, Lcom/android/server/wm/obl;->tba:Z
    ...
    :cond_6
    iget-boolean v4, v0, Lcom/android/server/wm/obl;->sba:Z
    ...
    :cond_7
    iget-boolean v4, v0, Lcom/android/server/wm/obl;->pba:Z
    ...
    :cond_8
    iget-boolean v4, v0, Lcom/android/server/wm/obl;->qba:Z

    if-eqz v4, :cond_b

    iget-boolean v4, v0, Lcom/android/server/wm/obl;->vba:Z

    if-eqz v4, :cond_a

    iget-boolean v4, v0, Lcom/android/server/wm/obl;->uba:Z
    ...
    :cond_b
    iget-boolean v4, v0, Lcom/android/server/wm/obl;->oba:Z
    ...
    iget-boolean v6, v0, Lcom/android/server/wm/obl;->pba:Z
...
.method private zta(IZLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    iget-object v2, v0, Lcom/android/server/wm/obl;->xba:Landroid/view/animation/Interpolator;
...
.method private zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
    ...
    iget-object v3, p0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
    ...
    iget-object p0, p0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
...
.method public dismiss(Landroid/view/SurfaceControl$Transaction;JFIIII)Z
    ...
    iget-object v0, v10, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
...
.method public kill()V
    ...
    iput-object v1, p0, Lcom/android/server/wm/obl;->nba:Landroid/view/SurfaceControl;
...
.method public printTo(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->oba:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->pba:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->qba:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->uba:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->rba:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/obl;->sba:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/obl;->tba:Z
