...
.field private static final AY:Ljava/lang/String; = "game_mode_apps"

.field private static final AZ:S = 0x14s

.field private static final BY:Ljava/lang/String; = "config_current_primary_sub"

.field private static final BZ:S = 0x15s
...
.field private static final CY:Ljava/lang/String; = "android.intent.action.ENABLE_DOWNLOAD_SWITCH"

.field private static final CZ:S = 0x16s

.field private static final DOUBLE:I = 0x8

.field private static final DU:Ljava/lang/String; = "network_restrict"

.field private static final DY:Ljava/lang/String; = "android.intent.action.ENABLE_SLS_APP_SWITCH"

.field private static final DZ:S = 0x17s

.field private static final EU:Landroid/net/Uri;

.field private static final EY:Ljava/lang/String; = "sla_download_onetime_notify"

.field private static final EZ:S = 0x18s

.field private static final FLOAT:I = 0x4

.field private static final FOREGROUND_IMPORTANCE_CUTOFF:I = 0x64

.field private static final FY:Ljava/lang/String; = "sls_app_onetime_notify"

.field private static final FZ:S = 0x19s

.field private static final GY:Ljava/lang/String; = "download_smart_link_aggregation"

.field private static final GZ:S = 0x1as

.field private static final HY:Ljava/lang/String; = "sla_enable_notify"

.field private static final INT:I = 0x4

.field private static final INVALID_RSSI:I = -0xc8

.field private static final IY:Ljava/lang/String; = "sla_downloading_dm_notify"

.field private static final IZ:S = 0x1bs

.field private static final JY:Ljava/lang/String; = "sla_downloading_ota_notify"

.field private static final JZ:S = 0x1cs

.field private static final KY:Ljava/lang/String; = "sla_downloading_heytap_notify"

.field private static final KZ:S = 0x1ds

.field private static final LONG:I = 0x8

.field private static final LY:Ljava/lang/String; = "android.intent.action.GO_ACCELERATION_SETTINGS"

.field private static final LZ:S = 0x1es

.field private static final MSG_GET_ONLINECONFIG:I = 0x1

.field private static final MSG_STOP_LISTENING:I = 0x7

.field private static final MY:Ljava/lang/String; = "oneplus.intent.action.OP_SLA"

.field private static final MZ:S = 0x1fs

.field private static final NY:Ljava/lang/String; = "android.net.network.INTERNET_LOST"

.field private static final NZ:S = 0x20s

.field private static final OP_GAME_MODE_APP:I = 0x3ec

.field private static final OY:Ljava/lang/String; = "NETWORK_SLA_STATUS"

.field private static final OZ:S = 0x21s

.field private static final PY:Ljava/lang/String; = "NETWORK_SLS_STATUS"

.field private static final PZ:S = 0x22s

.field private static final QY:Ljava/lang/String; = "NETWORK_SLA_ALERTS"

.field private static final QZ:S = 0x23s

.field private static final RY:Ljava/lang/String; = "wifi_dbs_enable"

.field private static final RZ:S = 0x24s

.field private static final SHORT:I = 0x2

.field private static final SY:J = 0x12cL

.field private static final SZ:S = 0x25s

.field private static final TAG:Ljava/lang/String; = "OpSlaNetlinkHelper"

.field private static final TY:J = 0x1d4c0L

.field private static final TZ:S = 0x26s

.field private static final UY:J = 0x124f80L

.field private static final UZ:S = 0x27s

.field private static final VY:J = 0x2710L

.field private static final VZ:S = 0x28s

.field private static final WIFI_AUTO_CHANGE_TO_MOBILE_DATA:Ljava/lang/String; = "wifi_auto_change_to_mobile_data"

.field private static final WY:J = 0x4e20L

.field private static final WZ:S = 0x29s

.field private static final XY:I = 0x100

.field private static final XZ:S = 0x2as

.field private static final YY:I = 0x0

.field private static final YZ:S = 0x2bs

.field private static final ZY:I = 0x1

.field private static final ZZ:S = 0x2cs

.field private static final _Y:I = 0x2

.field private static final _Z:S = 0x2ds

.field private static final aZ:I = 0x1

.field private static final aaa:S = 0x2es

.field private static final bZ:I = 0x0

.field private static final baa:S = 0x2fs

.field private static final cZ:I = 0x1

.field private static final caa:S = 0x30s

.field private static final dZ:I = 0x1

.field private static final daa:S = 0x31s

.field private static final eZ:I = 0x2

.field private static final eaa:S = 0x37s

.field private static final fZ:I = 0x3

.field private static final faa:[Ljava/lang/String;

.field private static final gZ:I = 0x1

.field private static gaa:Ljava/util/ArrayList; = null
...
.field private static haa:Ljava/util/ArrayList; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private static final jZ:I = 0x4

.field private static final kZ:I = 0x5

.field private static lY:Ljava/io/FileDescriptor; = null

.field private static final lZ:I = 0x6

.field private static mDebug:Z = false

.field private static final mZ:I = 0x8

.field private static nY:Ljava/lang/String; = null

.field private static final nZ:I = 0x9

.field private static final oY:Ljava/lang/String; = "19867"

.field private static final oZ:I = 0xa

.field private static final pY:Ljava/lang/String; = "_id"

.field private static final pZ:I = 0xb

.field private static final qY:Ljava/lang/String; = "pkg"

.field private static final qZ:I = 0xd

.field private static final rY:Ljava/lang/String; = "mobile"

.field private static final rZ:I = 0xe

.field private static final sY:Ljava/lang/String; = "wlan"

.field private static final sZ:I = 0xf

.field private static final tY:Ljava/lang/String; = "SlaOnlineConfig"

.field private static final tZ:I = 0x10

.field private static final uY:Ljava/lang/String; = "SlaGameWhiteList"

.field private static final uZ:I = 0x11

.field private static final vY:Ljava/lang/String; = "SlaTopAppWhiteList"

.field private static final vZ:I = 0x12

.field private static final wY:Ljava/lang/String; = "oneplus_link_turbo_value"

.field private static final wZ:I = 0x1d

.field private static final xY:Ljava/lang/String; = "oneplus_smart_link_selection"

.field private static final xZ:S = 0x11s

.field private static final yY:Ljava/lang/String; = "sla_game_mark"

.field private static final yZ:S = 0x12s

.field private static final zY:Ljava/lang/String; = "op_gamemode_removed_packages_by_user"

.field private static final zZ:S = 0x13s


# instance fields
.field private AX:Landroid/net/INetd;

.field private BX:Landroid/net/Network;

.field private CX:Landroid/net/Network;

.field private DX:Landroid/net/ConnectivityManager$NetworkCallback;
...
.field private rX:Landroid/os/Handler;

.field private sX:Ljava/lang/Thread;

.field private tX:Landroid/app/NotificationChannel;

.field private uX:Landroid/app/NotificationChannel;

.field private vX:Landroid/app/NotificationChannel;

.field private wX:Landroid/net/NetworkRequest;

.field private xX:Lcom/android/server/pm/PackageManagerService;

.field private yX:Landroid/app/IActivityManager;

.field private zX:Landroid/telephony/TelephonyManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->nY:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->EU:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->faa:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->gaa:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->haa:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/wifi/ire;->sX:Ljava/lang/Thread;

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/server/wifi/ire;->EX:I

    const/16 v2, -0xc8

    iput v2, p0, Lcom/android/server/wifi/ire;->FX:I

    iput v1, p0, Lcom/android/server/wifi/ire;->GX:I

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/server/wifi/ire;->HX:I

    iput v1, p0, Lcom/android/server/wifi/ire;->IX:I

    iput v1, p0, Lcom/android/server/wifi/ire;->JX:I

    iput v1, p0, Lcom/android/server/wifi/ire;->KX:I

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lcom/android/server/wifi/ire;->mLastUpdateTime:J

    iput-wide v2, p0, Lcom/android/server/wifi/ire;->LX:J

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->MX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->NX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->OX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->QX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->RX:Z

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/server/wifi/ire;->mScreenOn:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->SX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->UX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->VX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->WX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->XX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->YX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->ZX:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->_X:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->aY:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->bY:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->cY:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->dY:Z

    iput-boolean v1, p0, Lcom/android/server/wifi/ire;->eY:Z

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/ire;->jY:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Lcom/android/server/wifi/ire;->kY:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Lcom/android/server/wifi/ire;->Nu:Landroid/app/IProcessObserver;
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->xX:Lcom/android/server/pm/PackageManagerService;
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->AX:Landroid/net/INetd;
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->wX:Landroid/net/NetworkRequest;
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->DX:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->yX:Landroid/app/IActivityManager;

    :try_start_0
    iget-object p1, p0, Lcom/android/server/wifi/ire;->yX:Landroid/app/IActivityManager;

    iget-object v2, p0, Lcom/android/server/wifi/ire;->Nu:Landroid/app/IProcessObserver;
    ...
    iput-object v0, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->GX:I

    invoke-direct {p0}, Lcom/android/server/wifi/ire;->qr()Z
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->xr()V

    iget-object p0, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
...
.method private Ar()V
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->xX:Lcom/android/server/pm/PackageManagerService;

    if-eqz v0, :cond_a

    invoke-direct {p0}, Lcom/android/server/wifi/ire;->ar()Ljava/util/Map;

    move-result-object v0

    invoke-direct {p0}, Lcom/android/server/wifi/ire;->gr()Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;

    monitor-enter v4

    :try_start_0
    iget-object v5, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/server/wifi/ire;->jY:Ljava/util/HashMap;
    ...
    :cond_1
    iget-object v8, p0, Lcom/android/server/wifi/ire;->xX:Lcom/android/server/pm/PackageManagerService;
    ...
    :cond_4
    iget-object v12, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;
...
.method private Cr()V
    ...
    sget-object v0, Lcom/android/server/wifi/ire;->lY:Ljava/io/FileDescriptor;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/android/server/wifi/ire;->sX:Ljava/lang/Thread;
    ...
    iput-object v0, p0, Lcom/android/server/wifi/ire;->sX:Ljava/lang/Thread;

    iget-object p0, p0, Lcom/android/server/wifi/ire;->sX:Ljava/lang/Thread;
...
.method private Dr()V
    ...
    iput-object v1, p0, Lcom/android/server/wifi/ire;->tX:Landroid/app/NotificationChannel;

    iget-object v1, p0, Lcom/android/server/wifi/ire;->tX:Landroid/app/NotificationChannel;
    ...
    iget-object v4, p0, Lcom/android/server/wifi/ire;->tX:Landroid/app/NotificationChannel;
    ...
    iput v2, p0, Lcom/android/server/wifi/ire;->KX:I
...
.method private Er()V
    ...
    iput-object v1, p0, Lcom/android/server/wifi/ire;->vX:Landroid/app/NotificationChannel;

    iget-object v1, p0, Lcom/android/server/wifi/ire;->mNotificationManager:Landroid/app/NotificationManager;

    iget-object v2, p0, Lcom/android/server/wifi/ire;->vX:Landroid/app/NotificationChannel;
...
.method static synthetic Fe()Ljava/io/FileDescriptor;
    .locals 1
...
.method private Fr()V
    ...
    iget-object v1, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lcom/android/server/wifi/ire;->uX:Landroid/app/NotificationChannel;

    iget-object v1, p0, Lcom/android/server/wifi/ire;->uX:Landroid/app/NotificationChannel;
    ...
    iget-object v5, p0, Lcom/android/server/wifi/ire;->uX:Landroid/app/NotificationChannel;
    ...
    iput v3, p0, Lcom/android/server/wifi/ire;->JX:I

    iget-object v0, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
...
.method private Gr()V
    ...
    iput v2, p0, Lcom/android/server/wifi/ire;->JX:I
...
.method private Hr()V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->hr()Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Lcom/android/server/wifi/ire;->jY:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v7, p0, Lcom/android/server/wifi/ire;->xX:Lcom/android/server/pm/PackageManagerService;
    ...
    :cond_3
    iget-object v11, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;
...
.method private Jr()Z
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->rr()Z

    move-result v5

    iput-boolean v5, p0, Lcom/android/server/wifi/ire;->SX:Z
    ...
    iget v6, p0, Lcom/android/server/wifi/ire;->IX:I
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->OX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->MX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->VX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->ZX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->SX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->UX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->XX:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/ire;->eY:Z
    ...
    iget v5, p0, Lcom/android/server/wifi/ire;->IX:I

    if-nez v5, :cond_1

    iget-boolean v5, p0, Lcom/android/server/wifi/ire;->OX:Z

    if-eqz v5, :cond_1

    iget-boolean v5, p0, Lcom/android/server/wifi/ire;->VX:Z

    if-eqz v5, :cond_1

    iget-boolean v5, p0, Lcom/android/server/wifi/ire;->MX:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->ZX:Z

    if-eqz v0, :cond_1

    if-nez v4, :cond_1

    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->SX:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->UX:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->XX:Z
...
.method private Kr()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->SX:Z
...
.method private Qq()V
    ...
    iput-boolean v0, p0, Lcom/android/server/wifi/ire;->SX:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/wifi/ire;->SX:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/wifi/ire;->IX:I
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->vr()V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->wr()V
...
.method private Sq()V
    ...
    iget v0, p0, Lcom/android/server/wifi/ire;->KX:I
...
.method private Tq()V
    ...
    iget v0, p0, Lcom/android/server/wifi/ire;->JX:I
...
.method private Uq()V
    ...
    iget v1, p0, Lcom/android/server/wifi/ire;->HX:I
    ...
    iget v0, p0, Lcom/android/server/wifi/ire;->HX:I
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/wifi/ire;->AX:Landroid/net/INetd;
...
.method private Vq()V
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->jY:Ljava/util/HashMap;
    ...
    sget-object v3, Lcom/android/server/wifi/ire;->EU:Landroid/net/Uri;
    ...
    :goto_1
    iget-object v2, p0, Lcom/android/server/wifi/ire;->jY:Ljava/util/HashMap;
...
.method private Yb(I)V
    ...
    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->dY:Z
...
.method private Zb(I)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wifi/ire;->_b(I)Z
...
.method private _b(I)Z
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/wifi/ire;->gY:Ljava/util/ArrayList;
...
.method private ac(I)Z
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->kY:Ljava/util/HashMap;
    ...
    :cond_2
    :goto_1
    iget-object p0, p0, Lcom/android/server/wifi/ire;->kY:Ljava/util/HashMap;
...
.method private ar()Ljava/util/Map;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private bc(I)Z
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/wifi/ire;->fY:Ljava/util/ArrayList;
...
.method static synthetic bio(Lcom/android/server/wifi/ire;I)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wifi/ire;->_b(I)Z
...
.method static synthetic c(Lcom/android/server/wifi/ire;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->XX:Z
...
.method static synthetic cno(Lcom/android/server/wifi/ire;I)I
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->EX:I
...
.method static synthetic d(Lcom/android/server/wifi/ire;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Wq()Z
...
.method private dc(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/server/wifi/ire;->MX:Z

    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->MX:Z

    if-eqz p1, :cond_3

    sget-object p1, Lcom/android/server/wifi/ire;->lY:Ljava/io/FileDescriptor;

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/android/server/wifi/ire;->sX:Ljava/lang/Thread;
...
.method static synthetic dma(Lcom/android/server/wifi/ire;)I
    ...
    iget p0, p0, Lcom/android/server/wifi/ire;->GX:I
...
.method static synthetic dma(Lcom/android/server/wifi/ire;I)I
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->JX:I
...
.method static synthetic e(Lcom/android/server/wifi/ire;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Rq()V
...
.method private fb(Z)V
    ...
    iget p1, p0, Lcom/android/server/wifi/ire;->KX:I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/wifi/ire;->JX:I
    ...
    iput v0, p0, Lcom/android/server/wifi/ire;->JX:I
    ...
    iput v0, p0, Lcom/android/server/wifi/ire;->KX:I
...
.method private fc(I)V
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->FX:I
...
.method static synthetic fto(Lcom/android/server/wifi/ire;)I
    ...
    iget p0, p0, Lcom/android/server/wifi/ire;->EX:I
...
.method private gr()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;

    return-object p0

    :cond_0
    sget-object p0, Lcom/android/server/wifi/ire;->gaa:Ljava/util/ArrayList;
...
.method private hr()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;

    return-object p0

    :cond_0
    sget-object p0, Lcom/android/server/wifi/ire;->haa:Ljava/util/ArrayList;
...
.method static synthetic ibl(Lcom/android/server/wifi/ire;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->RX:Z
...
.method static synthetic igw(Lcom/android/server/wifi/ire;I)I
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->HX:I
...
.method static synthetic igw(Lcom/android/server/wifi/ire;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Yq()Z
...
.method static synthetic ire(Lcom/android/server/wifi/ire;)I
    ...
    iget p0, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method static synthetic irq(Lcom/android/server/wifi/ire;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Pq()V
...
.method private static isVerizonSku()Z
    ...
    sget-object v0, Lcom/android/server/wifi/ire;->nY:Ljava/lang/String;
...
.method static synthetic ivd(Lcom/android/server/wifi/ire;)Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->DX:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method static synthetic k(Lcom/android/server/wifi/ire;)Landroid/net/Network;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->CX:Landroid/net/Network;
...
.method static synthetic kth(Lcom/android/server/wifi/ire;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->QX:Z
...
.method private lb(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->NX:Z

    if-eq v0, p1, :cond_1

    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->NX:Z

    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->NX:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->SX:Z

    iget-object p1, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
...
.method static synthetic lqr(Lcom/android/server/wifi/ire;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Qq()V
...
.method static synthetic m(Lcom/android/server/wifi/ire;)Landroid/net/Network;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->BX:Landroid/net/Network;
...
.method private mr()V
    ...
    iget-object v0, p0, Lcom/android/server/wifi/ire;->zX:Landroid/telephony/TelephonyManager;
    ...
    iput-object v0, p0, Lcom/android/server/wifi/ire;->zX:Landroid/telephony/TelephonyManager;
...
.method static synthetic o(Lcom/android/server/wifi/ire;)I
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->jr()I
...
.method private qb(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->OX:Z
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->OX:Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wifi/ire;->fc(I)V
...
.method private qbh(Lorg/json/JSONArray;)V
    ...
    iget-object v3, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/wifi/ire;->hY:Ljava/util/ArrayList;
    ...
    :try_start_2
    iget-object v2, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
    ...
    iget-object v3, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;
    ...
    :try_start_5
    iget-object v4, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/wifi/ire;->iY:Ljava/util/ArrayList;
...
.method static synthetic qeg(Lcom/android/server/wifi/ire;)Landroid/net/NetworkRequest;
    ...
    iget-object p0, p0, Lcom/android/server/wifi/ire;->wX:Landroid/net/NetworkRequest;
...
.method private registerSettingsCallbacks()V
    ...
    iget-object v3, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
    ...
    iget-object v4, p0, Lcom/android/server/wifi/ire;->rX:Landroid/os/Handler;
    ...
    sget-object v1, Lcom/android/server/wifi/ire;->EU:Landroid/net/Uri;
...
.method private rtg(Landroid/content/ComponentName;)I
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/wifi/ire;->xX:Lcom/android/server/pm/PackageManagerService;
...
.method static synthetic rtg(Lcom/android/server/wifi/ire;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->cY:Z
...
.method private setOPSlaDisable()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/wifi/ire;->AX:Landroid/net/INetd;
    ...
    iget v4, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method private setOPSlaEnable()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/wifi/ire;->AX:Landroid/net/INetd;
    ...
    iget-boolean v2, p0, Lcom/android/server/wifi/ire;->OX:Z

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lcom/android/server/wifi/ire;->NX:Z
    ...
    iput v2, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method private sis(ZLandroid/net/LinkProperties;Landroid/net/NetworkCapabilities;)V
    ...
    iget-boolean p3, p0, Lcom/android/server/wifi/ire;->ZX:Z
    ...
    :cond_6
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->VX:Z
    ...
    iget-boolean p3, p0, Lcom/android/server/wifi/ire;->_X:Z
    ...
    :cond_8
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->WX:Z
    ...
    iget-object p3, p0, Lcom/android/server/wifi/ire;->AX:Landroid/net/INetd;
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->ZX:Z

    goto :goto_6

    :cond_a
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->_X:Z
...
.method private sr()Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wifi/ire;->_b(I)Z
...
.method static synthetic ssp(Lcom/android/server/wifi/ire;I)I
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method static synthetic ssp(Lcom/android/server/wifi/ire;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->dY:Z
...
.method static synthetic ssp(Lcom/android/server/wifi/ire;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->RX:Z
...
.method private stopListening()V
    ...
    sput-object v0, Lcom/android/server/wifi/ire;->lY:Ljava/io/FileDescriptor;
...
.method private tr()Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wifi/ire;->bc(I)Z
...
.method private tsu(S)Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/wifi/ire;->faa:[Ljava/lang/String;
...
.method static synthetic tsu(Lcom/android/server/wifi/ire;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wifi/ire;->cc(I)V
...
.method static synthetic tsu(Lcom/android/server/wifi/ire;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/ire;->Xq()Z
...
.method private vr()V
    ...
    iget v1, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method private wr()V
    ...
    iget-boolean v2, p0, Lcom/android/server/wifi/ire;->VX:Z

    if-eqz v2, :cond_0

    iget-boolean v2, p0, Lcom/android/server/wifi/ire;->WX:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/wifi/ire;->QX:Z

    invoke-direct {p0}, Lcom/android/server/wifi/ire;->tr()Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/wifi/ire;->RX:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->QX:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->RX:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->NX:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->WX:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->_X:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wifi/ire;->YX:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->QX:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->RX:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->_X:Z

    if-eqz v0, :cond_3

    iget-boolean v0, p0, Lcom/android/server/wifi/ire;->YX:Z
...
.method static synthetic wtn(Lcom/android/server/wifi/ire;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wifi/ire;->Yb(I)V
...
.method static synthetic you(Lcom/android/server/wifi/ire;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->bY:Z
...
.method static synthetic zgw(Lcom/android/server/wifi/ire;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wifi/ire;->QX:Z
...
.method private zr()V
    ...
    iget v0, p0, Lcom/android/server/wifi/ire;->EX:I
...
.method static synthetic zta(Lcom/android/server/wifi/ire;I)I
    ...
    iput p1, p0, Lcom/android/server/wifi/ire;->KX:I
...
.method static synthetic zta(Lcom/android/server/wifi/ire;J)J
    ...
    iput-wide p1, p0, Lcom/android/server/wifi/ire;->LX:J
...
.method static synthetic zta(Ljava/io/FileDescriptor;)Ljava/io/FileDescriptor;
    ...
    sput-object p0, Lcom/android/server/wifi/ire;->lY:Ljava/io/FileDescriptor;
...
.method private zta(Landroid/net/Network;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;)V
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->BX:Landroid/net/Network;
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/android/server/wifi/ire;->VX:Z
    ...
    iput-object p1, p0, Lcom/android/server/wifi/ire;->CX:Landroid/net/Network;
    ...
    :cond_3
    iput-boolean v2, p0, Lcom/android/server/wifi/ire;->WX:Z

    :cond_4
    :goto_0
    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->VX:Z

    if-eqz p1, :cond_5

    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->WX:Z

    if-nez p1, :cond_6

    :cond_5
    iget p1, p0, Lcom/android/server/wifi/ire;->IX:I
...
.method private zta(ZLandroid/net/LinkProperties;Landroid/net/NetworkCapabilities;)V
    ...
    iput-boolean p2, p0, Lcom/android/server/wifi/ire;->UX:Z

    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->UX:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/ire;->UX:Z
...
.method private zta(ZLandroid/net/NetworkCapabilities;)V
    ...
    :goto_0
    iput-boolean p2, p0, Lcom/android/server/wifi/ire;->XX:Z
    ...
    :goto_1
    iput-boolean p2, p0, Lcom/android/server/wifi/ire;->YX:Z

    :cond_4
    :goto_2
    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->XX:Z

    aput p1, v0, v3

    iget-boolean p1, p0, Lcom/android/server/wifi/ire;->YX:Z
...
.method private zta(SI)Z
    ...
    sget-object v3, Lcom/android/server/wifi/ire;->lY:Ljava/io/FileDescriptor;
