...
# static fields
.field public static final BM:I = 0x68

.field public static final CM:I = 0x4e

.field private static final DEBUG:Z

.field public static final DM:I = 0xd3

.field public static final EM:I = 0x47

.field public static final GM:I = 0x46

.field public static final GPU_OUT_OF_MEMORY:I = 0xa8

.field public static final HM:I = 0xf

.field public static final IM:I = 0xe6

.field public static final JM:I = 0x50

.field public static final KM:I = 0x2

.field public static final LM:I = 0x1d7

.field public static final MM:I = 0x1e6

.field private static final NL:Ljava/lang/String; = "compatibility_config_values"

.field public static final NM:I = 0x14c

.field private static final OL:Ljava/lang/String; = "/data/system/oneplus_cpt_list.xml"

.field public static final OM:I = 0x166

.field private static final PL:Ljava/lang/String; = "/system/etc/oneplus_cpt_list.xml"

.field public static final QM:I = 0x186

.field public static final RM:I = 0x23c

.field private static final SM:Ljava/util/Map;
...
.field private static final mM:Ljava/lang/String; = "/data/system/install_warning_list.xml"

.field private static mTotalCount:I = 0x0

.field private static final nM:Ljava/lang/String; = "/system/etc/install_warning_list.xml"

.field private static final oM:Ljava/lang/String; = "CompatConfigList"

.field private static final pM:Ljava/lang/String; = "disable.install.warning"
...
.field public static final sM:I = 0x14b

.field public static final tM:I = 0x6b

.field public static final uM:I = 0x5f

.field public static final vM:I = 0x1bb

.field public static final wM:I = 0x1bc

.field public static final xM:I = 0x1bd

.field public static final yM:I = 0x6f

.field public static final zM:I = 0x55


# instance fields
.field private jM:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private lM:Lcom/oneplus/config/ConfigObserver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/sis;->SM:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/sis;->SM:Ljava/util/Map;
    ...
    sput-object v0, Lcom/android/server/pm/sis;->TM:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/sis;->TM:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
...
.method private Sp()V
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
    ...
    :cond_5
    iget-object v4, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
...
.method private Tp()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/sis;->ec(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/sis;->Up()V
...
.method private Up()V
    ...
    iget-object v3, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
    ...
    :try_start_1
    iget-object p0, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
...
.method private dc(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
...
.method private ec(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
...
.method private gck(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/sis;->fc(Ljava/lang/String;)Z
...
.method private zta(Ljava/lang/String;Landroid/util/SparseArray;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/sis;->Sb(I)Ljava/lang/String;
...
.method public S(Ljava/lang/String;)I
    ...
    sget-object p0, Lcom/android/server/pm/sis;->SM:Ljava/util/Map;
...
.method public dumpToString()Ljava/lang/String;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/pm/sis;->kM:Ljava/util/Map;
...
.method public getCompatConfigString(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
...
.method public initCompatOnlineConfig()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/sis;->lM:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, Lcom/android/server/pm/sis;->lM:Lcom/oneplus/config/ConfigObserver;
...
.method public initInstance(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/sis;->Sp()V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/sis;->Tp()V
...
.method public isInConfigList(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/pm/sis;->dc(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/pm/sis;->jM:Landroid/util/SparseArray;
...
.method public z(I)Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/pm/sis;->TM:Ljava/util/Map;
