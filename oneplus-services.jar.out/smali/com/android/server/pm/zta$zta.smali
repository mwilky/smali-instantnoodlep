...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v2, p0, Lcom/android/server/pm/zta$zta;->this$0:Lcom/android/server/pm/zta;

    invoke-static {v2}, Lcom/android/server/pm/zta;->rtg(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/android/server/pm/zta;->ssp(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v0, p1, v1}, Lcom/android/server/pm/zta;->zta(Lcom/android/server/pm/zta;Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v0

    iget-object v1, p0, Lcom/android/server/pm/zta$zta;->this$0:Lcom/android/server/pm/zta;

    invoke-static {v1}, Lcom/android/server/pm/zta;->cno(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/android/server/pm/zta;->cno(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lcom/android/server/pm/zta;->rtg(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lcom/android/server/pm/zta;->tsu(Lcom/android/server/pm/zta;)V
    ...
    invoke-static {v0}, Lcom/android/server/pm/zta;->you(Lcom/android/server/pm/zta;)Ljava/util/ArrayList;
    ...
    invoke-static {v0}, Lcom/android/server/pm/zta;->sis(Lcom/android/server/pm/zta;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/server/pm/zta;->sis(Lcom/android/server/pm/zta;)Ljava/lang/String;
    ...
    invoke-static {v0, p1, v1, v2}, Lcom/android/server/pm/zta;->zta(Lcom/android/server/pm/zta;Ljava/lang/String;Ljava/lang/String;Z)Z
