...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/veq;->Tf:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/veq;->Uf:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/veq;->Wf:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/veq;->mLock:Ljava/lang/Object;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/veq;->Xf:Z
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/veq;->mPolicy:I

    iput-boolean v0, p0, Lcom/android/server/veq;->mFirstReport:Z

    iput-boolean v0, p0, Lcom/android/server/veq;->Nf:Z

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/veq;->Qf:Ljava/util/HashSet;
...
.method private Ra(I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/veq;->Qf:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/veq;->Qf:Ljava/util/HashSet;
...
.method private Sa(I)V
    ...
    iget-object p0, p0, Lcom/android/server/veq;->mResolver:Landroid/content/ContentResolver;
    ...
    :cond_0
    sget-object p1, Lcom/android/server/veq;->Uf:Ljava/lang/String;

    goto :goto_0

    :cond_1
    sget-object p1, Lcom/android/server/veq;->Tf:Ljava/lang/String;
...
.method private Ta(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/vju;->ywr(Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/vju;->ywr(Z)Z
...
.method W()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/veq;->X()Landroid/util/ArrayMap;
    ...
    iget-object v0, v1, Lcom/android/server/veq;->mContext:Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/veq;->clearGpsUids()V
    ...
    sget-boolean v15, Lcom/android/server/veq;->DEBUG_ONEPLUS:Z
    ...
    invoke-direct {v1, v0}, Lcom/android/server/veq;->Ra(I)V
    :try_end_1
...
.method X()Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, Lcom/android/server/veq;->Qe:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/veq;->mReceivers:Ljava/util/HashMap;
    ...
    sget-boolean v7, Lcom/android/server/veq;->DEBUG_ONEPLUS:Z
    ...
    iget-object v9, p0, Lcom/android/server/veq;->Pf:Ljava/util/ArrayList;
    ...
    sget-object v4, Lcom/android/server/veq;->Pe:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
    ...
    iget-object v4, p0, Lcom/android/server/veq;->Pf:Ljava/util/ArrayList;
    ...
    :cond_3
    sget-boolean p0, Lcom/android/server/veq;->DEBUG_ONEPLUS:Z
...
.method Y()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/veq;->isAggressive()Z
...
.method Z()Z
    ...
    iget-object v0, p0, Lcom/android/server/veq;->mLocationManagerService:Lcom/android/server/LocationManagerService;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/android/server/veq;->X()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/veq;->mContext:Landroid/content/Context;
...
.method public anyMotionResultOverride(I)I
    ...
    invoke-virtual {p0}, Lcom/android/server/veq;->Y()Z
...
.method public clearWhitelistUid()V
    ...
    sget-object v0, Lcom/android/server/veq;->mLock:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/veq;->Wf:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/veq;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/veq;->Wf:Ljava/util/ArrayList;
...
.method public getStopGpsState()Z
    ...
    sget-boolean p0, Lcom/android/server/veq;->Xf:Z
...
.method isAggressive()Z
    ...
    iget p0, p0, Lcom/android/server/veq;->mPolicy:I
...
.method public isMoving(Landroid/location/Location;)Z
    ...
    sget-boolean v1, Lcom/android/server/veq;->DEBUG_ONEPLUS:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/veq;->Nf:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/veq;->mFirstReport:Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/server/veq;->Nf:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/veq;->mFirstReport:Z

    return v0

    :cond_1
    iget-boolean p1, p0, Lcom/android/server/veq;->mFirstReport:Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/server/veq;->W()Z
    ...
    :cond_3
    sput-boolean v3, Lcom/android/server/veq;->Xf:Z
...
.method public mayUseAggressiveTimeoutLocked(FJJJJJFJJ)Z
    ...
    iget v1, v0, Lcom/android/server/veq;->mPolicy:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    iget-object v0, v0, Lcom/android/server/veq;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object p2, p0, Lcom/android/server/veq;->mResolver:Landroid/content/ContentResolver;
    ...
    iput p1, p0, Lcom/android/server/veq;->mPolicy:I

    sget-boolean p1, Lcom/android/server/veq;->DEBUG_ONEPLUS:Z
    ...
    iget p2, p0, Lcom/android/server/veq;->mPolicy:I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/veq;->mPolicy:I

    invoke-direct {p0, p1}, Lcom/android/server/veq;->Sa(I)V

    iget p1, p0, Lcom/android/server/veq;->mPolicy:I

    invoke-direct {p0, p1}, Lcom/android/server/veq;->Ta(I)V
...
.method public prepareDeviceIdleController(Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;)V
    ...
    sput-object p1, Lcom/android/server/veq;->Vf:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/veq;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/veq;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iput-object v0, p0, Lcom/android/server/veq;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iput-object v0, p0, Lcom/android/server/veq;->mResolver:Landroid/content/ContentResolver;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getHandler()Landroid/os/Handler;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/veq;->mHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/veq;->mLocationManager:Landroid/location/LocationManager;
    ...
    iput-object p1, p0, Lcom/android/server/veq;->mGpsLocationListener:Landroid/location/LocationListener;

    iget-object p1, p0, Lcom/android/server/veq;->mResolver:Landroid/content/ContentResolver;
    ...
    iget-object v2, p0, Lcom/android/server/veq;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iget v0, p0, Lcom/android/server/veq;->mPolicy:I
...
.method public prepareLocationManagerService(Lcom/android/server/LocationManagerService$LocationManagerServiceInner;)V
    ...
    sput-object p1, Lcom/android/server/veq;->Pe:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
    ...
    iput-object v0, p0, Lcom/android/server/veq;->mLocationManagerService:Lcom/android/server/LocationManagerService;

    invoke-virtual {p1}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getLock()Ljava/lang/Object;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/veq;->Qe:Ljava/lang/Object;

    invoke-virtual {p1}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getReceivers()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/veq;->mReceivers:Ljava/util/HashMap;
...
.method public requestLocationUpdatesOverride()Z
    ...
    iget-boolean v0, p0, Lcom/android/server/veq;->Nf:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/veq;->mLocationManager:Landroid/location/LocationManager;
    ...
    sget-object v0, Lcom/android/server/veq;->Vf:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->setHasGps(Z)V

    iput-boolean v1, p0, Lcom/android/server/veq;->mFirstReport:Z

    iget-object v2, p0, Lcom/android/server/veq;->mLocationManager:Landroid/location/LocationManager;

    const-wide/16 v4, 0x3e8

    const/high16 v6, 0x40a00000    # 5.0f

    iget-object v7, p0, Lcom/android/server/veq;->mGpsLocationListener:Landroid/location/LocationListener;

    iget-object p0, p0, Lcom/android/server/veq;->mHandler:Landroid/os/Handler;
    ...
    sget-object p0, Lcom/android/server/veq;->Vf:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;
...
.method public scheduleAlarmOverride()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/veq;->Z()Z
    ...
    iget-object p0, p0, Lcom/android/server/veq;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
...
.method public shellCommand(Lcom/android/server/DeviceIdleController$Shell;Ljava/lang/String;Ljava/io/PrintWriter;)Z
    ...
    iget v3, p0, Lcom/android/server/veq;->mPolicy:I
...
.method public tryClearAllPendingBroadcasts()V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/veq;->mReceivers:Ljava/util/HashMap;
