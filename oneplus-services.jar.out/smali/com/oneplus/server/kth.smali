...
# instance fields
.field eg:Landroid/content/BroadcastReceiver;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/oneplus/server/kth;->eg:Landroid/content/BroadcastReceiver;
...
.method private Bq()[Ljava/lang/String;
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/oneplus/server/kth;->md(Ljava/lang/String;)[Ljava/lang/String;
...
.method private sw()V
    ...
    invoke-direct {p0, v2}, Lcom/oneplus/server/kth;->Tc(I)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-static {v2}, Lcom/android/server/am/ivd;->l(I)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-direct {p0, v2}, Lcom/oneplus/server/kth;->Uc(I)V
...
.method private you(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iget-object p0, p0, Lcom/oneplus/server/kth;->eg:Landroid/content/BroadcastReceiver;
