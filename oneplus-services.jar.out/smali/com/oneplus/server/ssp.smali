...
.field private static _H:Landroid/content/BroadcastReceiver;

.field private static aya:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

.field private static bya:Lcom/oneplus/android/server/scene/OemSceneButtonController;

.field private static cya:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

.field private static dya:Lcom/oneplus/android/server/scene/OemSceneActivityController;

.field private static eya:Lcom/oneplus/android/server/scene/OemSceneLightsController;

.field private static fya:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

.field private static gya:Lcom/oneplus/android/server/scene/OemSceneAudioController;

.field private static hya:Lcom/oneplus/android/server/scene/ESportMode;

.field private static iya:Lcom/oneplus/android/server/scene/oif;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->_H:Landroid/content/BroadcastReceiver;
...
.method public static kth(Landroid/content/Context;)V
    ...
    sget-object v1, Lcom/oneplus/server/ssp;->_H:Landroid/content/BroadcastReceiver;
...
.method public static sis(Landroid/content/Context;I)V
    ...
    sput-object p0, Lcom/oneplus/server/ssp;->iya:Lcom/oneplus/android/server/scene/oif;

    sget-object p0, Lcom/oneplus/server/ssp;->iya:Lcom/oneplus/android/server/scene/oif;

    if-eqz p0, :cond_0

    sget-object p0, Lcom/oneplus/server/ssp;->iya:Lcom/oneplus/android/server/scene/oif;

    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/oif;->fg()V
...
.method public static you(Lcom/oneplus/core/oimc/IOIMCServiceManager;Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v0, Lcom/oneplus/server/ssp;->bya:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    :cond_3
    sget-object p0, Lcom/oneplus/server/ssp;->aya:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
...
.method public static zta(Lcom/oneplus/core/oimc/IOIMCServiceManager;Landroid/content/Context;)V
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->bya:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sget-object v1, Lcom/oneplus/server/ssp;->bya:Lcom/oneplus/android/server/scene/OemSceneButtonController;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->dya:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    sget-object v0, Lcom/oneplus/server/ssp;->dya:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    if-eqz v0, :cond_1

    const-string v0, "AllowWhiteActivity"

    sget-object v1, Lcom/oneplus/server/ssp;->dya:Lcom/oneplus/android/server/scene/OemSceneActivityController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneActivityController;->eg()Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->cya:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    sget-object v0, Lcom/oneplus/server/ssp;->cya:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    if-eqz v0, :cond_2

    const-string v0, "AllowWhiteVibration"

    sget-object v1, Lcom/oneplus/server/ssp;->cya:Lcom/oneplus/android/server/scene/OemSceneVibrationController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->yg()Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->eya:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    sget-object v0, Lcom/oneplus/server/ssp;->eya:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    if-eqz v0, :cond_3

    const-string v0, "ZenModeLedController"

    sget-object v1, Lcom/oneplus/server/ssp;->eya:Lcom/oneplus/android/server/scene/OemSceneLightsController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneLightsController;->og()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->fya:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    sget-object v0, Lcom/oneplus/server/ssp;->fya:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    if-eqz v0, :cond_4

    const-string v0, "FloatingWindowController"

    sget-object v1, Lcom/oneplus/server/ssp;->fya:Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController;->hg()Lcom/oneplus/android/server/scene/OemSceneFloatingWindowController$FloatingWindowController;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->gya:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    sget-object v0, Lcom/oneplus/server/ssp;->gya:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    if-eqz v0, :cond_5

    const-string v0, "AudioProcessesController"

    sget-object v1, Lcom/oneplus/server/ssp;->gya:Lcom/oneplus/android/server/scene/OemSceneAudioController;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/OemSceneAudioController;->gg()Lcom/oneplus/android/server/scene/OemSceneAudioController$AudioProcessesController;
    ...
    sput-object v0, Lcom/oneplus/server/ssp;->hya:Lcom/oneplus/android/server/scene/ESportMode;

    sget-object v0, Lcom/oneplus/server/ssp;->hya:Lcom/oneplus/android/server/scene/ESportMode;

    if-eqz v0, :cond_7

    const-string v0, "ESportMode"

    sget-object v1, Lcom/oneplus/server/ssp;->hya:Lcom/oneplus/android/server/scene/ESportMode;
    ...
    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Upa:Lcom/oneplus/android/server/display/OpOIMCColorManager$GrayColor;
    ...
    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Tpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorBalance;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "ColorDisable"

    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Wpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorDisable;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "PaperColor"

    iget-object v2, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Vpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$PaperColor;

    invoke-interface {p0, v1, v2}, Lcom/oneplus/core/oimc/IOIMCServiceManager;->registerRemoteAction(Ljava/lang/String;Lcom/oneplus/core/oimc/IOIMCRemoteAction;)V

    const-string v1, "gooleMatrix"

    iget-object v0, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->Xpa:Lcom/oneplus/android/server/display/OpOIMCColorManager$GoogleMatrix;
    ...
    sput-object p1, Lcom/oneplus/server/ssp;->aya:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

    sget-object p1, Lcom/oneplus/server/ssp;->aya:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;

    if-eqz p1, :cond_c

    const-string p1, "TurnOffAutoBacklight"

    sget-object v0, Lcom/oneplus/server/ssp;->aya:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;
