...
.method public onStart([Ljava/lang/String;)I
    ...
    iget v0, v0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->cqa:I
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorDisable;->this$0:Lcom/oneplus/android/server/display/OpOIMCColorManager;

    const/4 v1, 0x0

    iput v1, p1, Lcom/oneplus/android/server/display/OpOIMCColorManager;->cqa:I
    ...
    invoke-interface {p1, v1}, Lcom/oneplus/display/IOneplusColorDisplayManager;->disableColor(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/display/color/ColorDisplayService$ColorDisplayServiceInternal;->cancelAnimation()V

    goto :goto_0

    :cond_0
    const-string p1, "mCdsi == null"
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorDisable;->this$0:Lcom/oneplus/android/server/display/OpOIMCColorManager;

    iget-object v2, v2, Lcom/oneplus/android/server/display/OpOIMCColorManager;->mOneplusIrisManager:Lcom/oneplus/iris/IOneplusIrisManager;

    const/16 v3, 0x38

    invoke-interface {v2, v3}, Lcom/oneplus/iris/IOneplusIrisManager;->getIrisCommand(I)I

    move-result v2

    if-nez v2, :cond_1

    const-string v2, "iris in PT_MODE, turn to bypass"

    invoke-static {v0, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/oneplus/android/server/display/OpOIMCColorManager$ColorDisable;->this$0:Lcom/oneplus/android/server/display/OpOIMCColorManager;

    invoke-static {v0, p1}, Lcom/oneplus/android/server/display/OpOIMCColorManager;->rtg(Lcom/oneplus/android/server/display/OpOIMCColorManager;Z)Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/display/OpOIMCColorManager;->mOneplusIrisManager:Lcom/oneplus/iris/IOneplusIrisManager;

    const-string p1, "56-1"

    invoke-interface {p0, p1}, Lcom/oneplus/iris/IOneplusIrisManager;->setIrisCommand(Ljava/lang/String;)V
...
.method public onStop([Ljava/lang/String;)I
    ...
    const-string v0, "  mTempSwitchIris2Bypass = "
