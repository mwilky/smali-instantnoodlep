...
# static fields
.field private static final kCa:Ljava/lang/String; = "MotorSocketServer"

.field private static final lCa:I = 0x400

.field private static final mCa:I = 0x3

.field private static final sD:Ljava/lang/String; = "motor_socket"


# instance fields
.field private iCa:Z

.field private jCa:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->iCa:Z
...
.method public Og()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->iCa:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->jCa:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->iCa:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->jCa:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->iCa:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->jCa:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->jCa:Landroid/net/LocalServerSocket;
