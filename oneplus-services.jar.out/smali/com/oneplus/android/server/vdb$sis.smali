...
# static fields
.field private static final JD:Ljava/lang/String; = "motor_socket"

.field private static final MCa:Ljava/lang/String; = "MotorSocketServer"

.field private static final NCa:I = 0x400

.field private static final OCa:I = 0x3


# instance fields
.field private KCa:Z

.field private LCa:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->KCa:Z
...
.method public Rg()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->KCa:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->LCa:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->KCa:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->LCa:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->KCa:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->LCa:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->LCa:Landroid/net/LocalServerSocket;
