...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/iris/OpIrisService$zta;
    }
.end annotation
...
.field private mIrisManager:Lcom/oneplus/android/server/iris/bio;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/oneplus/android/server/iris/igw;

    invoke-direct {v0}, Lcom/oneplus/android/server/iris/igw;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/oneplus/android/server/iris/OpIrisService$zta;-><init>(Lcom/oneplus/android/server/iris/OpIrisService;Landroid/os/Looper;)V
    ...
    invoke-direct {v0, p1}, Lcom/oneplus/android/server/iris/sis;-><init>(Landroid/content/Context;)V

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/oneplus/android/server/iris/bvj;

    invoke-direct {v0}, Lcom/oneplus/android/server/iris/bvj;-><init>()V

    :goto_0
    iput-object v0, p0, Lcom/oneplus/android/server/iris/OpIrisService;->mIrisManager:Lcom/oneplus/android/server/iris/bio;
...
.method static synthetic access$200(Lcom/oneplus/android/server/iris/OpIrisService;)Lcom/oneplus/android/server/iris/bio;
    .locals 0
...
.method private dumpInternal(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/oneplus/android/server/iris/bio;->dump(Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method private handleUserSwitch()V
    ...
    invoke-virtual {v0, p0}, Lcom/oneplus/android/server/iris/bio;->da(I)V
...
.method private setUp()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/oneplus/android/server/iris/wtn;-><init>(Lcom/oneplus/android/server/iris/OpIrisService;Landroid/os/Handler;)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/iris/OpIrisService;->mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    invoke-direct {v0, p0}, Lcom/oneplus/android/server/iris/gck;-><init>(Lcom/oneplus/android/server/iris/OpIrisService;)V
...
.method private updateColorMode()V
    ...
    iget v3, p0, Lcom/oneplus/android/server/iris/OpIrisService;->mCurrentUser:I
...
.method public getIrisCommand(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/iris/bio;->getIrisCommand(I)I
...
.method public getMemcAppTypeMap()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/iris/bio;->getMemcAppTypeMap()Ljava/util/HashMap;
...
.method public getMemcRateMap()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/iris/bio;->getMemcRateMap()Ljava/util/HashMap;
...
.method public getUrl()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/iris/bio;->getUrl()Ljava/lang/String;
...
.method public notifyRecentAnimatorStatus(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/iris/bio;->notifyRecentAnimatorStatus(Z)V
...
.method public onBootComplete()V
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/iris/bio;->onBootComplete()V
...
.method public postDisplayModeChange(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/iris/bio;->postDisplayModeChange(I)V
...
.method public prepareDisplayModeChange(Lcom/oneplus/iris/OpIrisWindowInfo;)V
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/iris/bio;->prepareDisplayModeChange(Lcom/oneplus/iris/OpIrisWindowInfo;)V
...
.method public setIrisCommand(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/iris/bio;->setIrisCommand(Ljava/lang/String;)V
...
.method public systemReady(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/iris/bio;->systemReady()V
...
.method public synthetic zta(Landroid/os/PowerSaveState;)V
    .locals 0
