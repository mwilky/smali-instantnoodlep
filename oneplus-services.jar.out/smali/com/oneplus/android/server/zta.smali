...
# instance fields
.field private Kha:Ljava/util/Set;
...
.field private Lha:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Ljava/lang/String;",
...
.field Mha:Ljava/util/List;

.field Nha:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Kha:Ljava/util/Set;

    new-instance v0, Ljava/util/TreeSet;

    invoke-direct {v0}, Ljava/util/TreeSet;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Lha:Ljava/util/Set;

    const-string v0, "/system/etc/bluetooth/china_carkit.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Oha:Ljava/lang/String;

    const-string v0, "/data/misc/carkit_user.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Pha:Ljava/lang/String;

    const-string v0, "/data/misc/carkit_cache.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Qha:Ljava/lang/String;

    const/16 v0, 0x4fc

    iput v0, p0, Lcom/oneplus/android/server/zta;->Rha:I
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Mha:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->Nha:Ljava/util/List;

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->yt()V

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->zt()V

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->xt()V
...
.method private flush()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Mha:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/zta;->Pha:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Nha:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/zta;->Qha:Ljava/lang/String;
...
.method private declared-synchronized sis(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/oneplus/android/server/zta;->Nha:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta;->Nha:Ljava/util/List;
...
.method private declared-synchronized xt()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Qha:Ljava/lang/String;
...
.method private yt()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Oha:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Kha:Ljava/util/Set;
...
.method private declared-synchronized zt()V
    .locals 6
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->Pha:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->Mha:Ljava/util/List;
...
.method public declared-synchronized addCarkit(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/oneplus/android/server/zta;->Mha:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta;->Mha:Ljava/util/List;
...
.method public declared-synchronized isCarkit(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_3
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->Nha:Ljava/util/List;
    ...
    iget v3, p0, Lcom/oneplus/android/server/zta;->Rha:I
    ...
    :cond_12
    :try_start_8
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->Kha:Ljava/util/Set;
