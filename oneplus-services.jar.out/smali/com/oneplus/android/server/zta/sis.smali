...
.field public static final Jq:Ljava/lang/String; = "OPTM"
...
.field public static final mla:Ljava/lang/String; = "com.antutu.benchmark.ui.test.activity.RefineryActivity"

.field public static final nla:Ljava/lang/String; = "com.antutu.benchmark.ui.test.activity.ActivityTestResultDetails"

.field public static final ola:Ljava/lang/String; = "/sys/class/thermal/msm-therm/temp"

.field public static final pla:Ljava/lang/String; = "/sys/class/thermal/skin-therm/temp"
...
.field private kla:Lcom/oneplus/android/server/zta/sis$zta;

.field private lla:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/zta/sis;->jla:Z

    new-instance v1, Lcom/oneplus/android/server/zta/sis$zta;

    invoke-direct {v1}, Lcom/oneplus/android/server/zta/sis$zta;-><init>()V

    iput-object v1, p0, Lcom/oneplus/android/server/zta/sis;->kla:Lcom/oneplus/android/server/zta/sis$zta;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta/sis;->lla:Ljava/lang/Runnable;
...
.method private Mc(Ljava/lang/String;)Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/zta/sis;->jla:Z

    if-nez v1, :cond_1

    iput-boolean v2, p0, Lcom/oneplus/android/server/zta/sis;->jla:Z
    ...
    :goto_0
    iget-boolean p1, p0, Lcom/oneplus/android/server/zta/sis;->jla:Z

    invoke-direct {p0, p1}, Lcom/oneplus/android/server/zta/sis;->xb(Z)Z
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta/sis;->kla:Lcom/oneplus/android/server/zta/sis$zta;
...
.method private dump()V
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/zta/sis;->jla:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/zta/sis;->kla:Lcom/oneplus/android/server/zta/sis$zta;
...
.method private wb(Z)V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/zta/sis;->lla:Ljava/lang/Runnable;
...
.method private xb(Z)Z
    ...
    :goto_0
    iput v0, p1, Lcom/oneplus/android/server/zta/sis$zta;->fla:I
    ...
    :goto_1
    iput v2, p0, Lcom/oneplus/android/server/zta/sis$zta;->gla:I
    ...
    :goto_2
    iput v0, p1, Lcom/oneplus/android/server/zta/sis$zta;->hla:I
    ...
    :goto_3
    iput v2, p0, Lcom/oneplus/android/server/zta/sis$zta;->ila:I
...
.method static synthetic zta(Lcom/oneplus/android/server/zta/sis;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/zta/sis;->wb(Z)V
...
.method private zta(Ljava/lang/String;Lcom/oneplus/android/server/zta/sis$zta;)V
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/oneplus/android/server/zta/sis$zta;->Hb()Ljava/util/Map;
...
.method public initEnv(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/zta/sis;->Cu()V
...
.method public zta(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/zta/sis;->Mc(Ljava/lang/String;)Z
