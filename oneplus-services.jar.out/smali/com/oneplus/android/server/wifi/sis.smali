...
.field private static Zwa:Lcom/oneplus/android/server/wifi/sis;
...
.field private final Xwa:Ljava/util/ArrayList;
...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->aI:Z
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->uC:Z
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->Vwa:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->Wwa:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/wifi/sis;->Ywa:Ljava/lang/Runnable;
...
.method private Wb(Z)V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/oneplus/android/server/wifi/sis;->aI:Z

    if-eq p1, v1, :cond_1

    iput-boolean p1, p0, Lcom/oneplus/android/server/wifi/sis;->aI:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/wifi/sis;->Ywa:Ljava/lang/Runnable;
...
.method public static getInstance()Lcom/oneplus/android/server/wifi/sis;
    ...
    sget-object v0, Lcom/oneplus/android/server/wifi/sis;->Zwa:Lcom/oneplus/android/server/wifi/sis;
    ...
    sput-object v0, Lcom/oneplus/android/server/wifi/sis;->Zwa:Lcom/oneplus/android/server/wifi/sis;
...
.method private kw()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;
...
.method private ld(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->aI:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->Wwa:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->uC:Z
    ...
    :cond_2
    iget-boolean p1, p0, Lcom/oneplus/android/server/wifi/sis;->Twa:Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/wifi/sis;->Vwa:Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/wifi/sis;->Wwa:Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/wifi/sis;->uC:Z
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/wifi/sis;->Vwa:Z
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-boolean v4, p0, Lcom/oneplus/android/server/wifi/sis;->Twa:Z
    ...
    iget-boolean v4, p0, Lcom/oneplus/android/server/wifi/sis;->Uwa:Z
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/oneplus/android/server/wifi/sis;->Xwa:Ljava/util/ArrayList;
...
.method static synthetic sis(Lcom/oneplus/android/server/wifi/sis;)Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/wifi/sis;->Vwa:Z
...
.method static synthetic sis(Lcom/oneplus/android/server/wifi/sis;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/wifi/sis;->Wwa:Z
...
.method static synthetic tsu(Lcom/oneplus/android/server/wifi/sis;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/wifi/sis;->kw()V
...
.method static synthetic you(Lcom/oneplus/android/server/wifi/sis;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/wifi/sis;->uC:Z
...
.method static synthetic zta(Lcom/oneplus/android/server/wifi/sis;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/wifi/sis;->Vwa:Z
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget-boolean p2, p0, Lcom/oneplus/android/server/wifi/sis;->Uwa:Z
