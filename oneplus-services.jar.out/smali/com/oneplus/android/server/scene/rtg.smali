...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/scene/rtg;->pta:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/rtg;->mta:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/oneplus/android/server/scene/rtg;->nta:Lcom/oneplus/android/server/scene/vju;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, Lcom/oneplus/android/server/scene/rtg;->pta:Z
...
.method private you(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->ita:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->jta:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->hta:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->hta:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->lta:Landroid/widget/CheckBox;
    ...
    :cond_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->lta:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->kta:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->kta:Landroid/widget/TextView;
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/rtg;)Landroid/widget/CheckBox;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/rtg;->lta:Landroid/widget/CheckBox;
...
.method public configurationChanged()V
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/scene/rtg;->ota:Z
...
.method protected hide()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->gta:Landroid/widget/LinearLayout;

    if-eqz v0, :cond_1

    :try_start_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->nta:Lcom/oneplus/android/server/scene/vju;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->nta:Lcom/oneplus/android/server/scene/vju;

    invoke-virtual {v0}, Lcom/oneplus/android/server/scene/vju;->eg()V

    :cond_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->mWindowManager:Landroid/view/WindowManager;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/rtg;->gta:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/rtg;->gta:Landroid/widget/LinearLayout;
...
.method public isAcquired()Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/scene/rtg;->ota:Z
...
.method protected declared-synchronized show()V
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/scene/rtg;->gta:Landroid/widget/LinearLayout;
...
.method public zta(Lcom/oneplus/android/server/scene/vju;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/rtg;->nta:Lcom/oneplus/android/server/scene/vju;
