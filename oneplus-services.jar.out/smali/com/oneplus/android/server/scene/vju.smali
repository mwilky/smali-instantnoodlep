...
.field private static final Rta:Ljava/lang/String; = "-1"

.field private static final SHORT_DURATION_TIMEOUT:J = 0x5dcL

.field private static final Sta:Ljava/lang/String; = "android.intent.action.PHONE_STATE"

.field private static final TAG:Ljava/lang/String; = "OemSceneGameModePanel"

.field private static final Tta:J = 0x1f4L

.field private static final Uta:Landroid/net/Uri;

.field private static final VALUE_ON:Ljava/lang/String; = "1"

.field private static Vta:Lcom/oneplus/android/server/scene/bud;

.field private static Wta:Lcom/oneplus/android/server/scene/bud;

.field private static Xta:Landroid/view/View;


# instance fields
.field private Ita:Landroid/view/WindowManager;

.field private Jta:Landroid/animation/ValueAnimator;

.field private Kta:Landroid/animation/ValueAnimator;

.field private Lta:Lcom/oneplus/android/server/scene/bud;

.field private Mta:Lcom/oneplus/android/server/scene/vju$zta;

.field private Nta:Ljava/lang/String;

.field private Ota:Z

.field private Pta:Z

.field private Qta:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/vju;->Uta:Landroid/net/Uri;

    const/4 v0, 0x0

    sput-object v0, Lcom/oneplus/android/server/scene/vju;->Vta:Lcom/oneplus/android/server/scene/bud;

    sput-object v0, Lcom/oneplus/android/server/scene/vju;->Wta:Lcom/oneplus/android/server/scene/bud;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Ita:Landroid/view/WindowManager;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/vju;->mESportGuider:Lcom/oneplus/android/server/scene/rtg;

    const-string v0, ""

    iput-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Nta:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/vju;->Ota:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/vju;->Pta:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Qta:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/vju;->Ita:Landroid/view/WindowManager;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Jta:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/vju;->Kta:Landroid/animation/ValueAnimator;

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/vju;->listenForCallState()V

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/vju;->Dv()V

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/vju;->Ev()V
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/vju;->Mta:Lcom/oneplus/android/server/scene/vju$zta;
    ...
    sget-object p2, Lcom/oneplus/android/server/scene/vju;->Uta:Landroid/net/Uri;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Mta:Lcom/oneplus/android/server/scene/vju$zta;
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/scene/vju;->Cv()V
...
.method private Cv()V
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/scene/vju;->Qta:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Qta:Ljava/util/ArrayList;
...
.method private Fv()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Ita:Landroid/view/WindowManager;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/vju;->dg()V
...
.method private Hv()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Jta:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Jta:Landroid/animation/ValueAnimator;
...
.method private Qb(Z)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/vju;->Kta:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Kta:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Kta:Landroid/animation/ValueAnimator;
...
.method public static fg()I
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/vju;->Xta:Landroid/view/View;
...
.method private hide(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;

    if-eqz p1, :cond_1

    iget-object v1, p0, Lcom/oneplus/android/server/scene/vju;->Ita:Landroid/view/WindowManager;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/vju;->Xta:Landroid/view/View;
...
.method static synthetic rtg(Lcom/oneplus/android/server/scene/vju;)Landroid/view/WindowManager;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Ita:Landroid/view/WindowManager;
...
.method private show(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Jta:Landroid/animation/ValueAnimator;
...
.method static synthetic sis(Lcom/oneplus/android/server/scene/vju;)Lcom/oneplus/android/server/scene/bud;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;
...
.method static synthetic ssp(Lcom/oneplus/android/server/scene/vju;)Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/scene/vju;->Ota:Z
...
.method static synthetic you(Lcom/oneplus/android/server/scene/vju;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/vju;->Ota:Z
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/vju;Lcom/oneplus/android/server/scene/bud;)Lcom/oneplus/android/server/scene/bud;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Lta:Lcom/oneplus/android/server/scene/bud;
...
.method public Z(Z)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/vju;->Pta:Z
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/oneplus/android/server/scene/vju;->Nta:Ljava/lang/String;

    iput-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Nta:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/vju;->Nta:Ljava/lang/String;
...
.method public gg()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/vju;->Nta:Ljava/lang/String;
...
.method public zta(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Lcom/oneplus/android/server/scene/vju;->Pta:Z
