...
.method constructor <init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Landroid/content/Intent;ILjava/lang/String;Ljava/lang/String;I)V
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/gwm;->val$intent:Landroid/content/Intent;

    iput p3, p0, Lcom/oneplus/android/server/scene/gwm;->val$userId:I

    iput-object p4, p0, Lcom/oneplus/android/server/scene/gwm;->tua:Ljava/lang/String;

    iput-object p5, p0, Lcom/oneplus/android/server/scene/gwm;->val$pkgName:Ljava/lang/String;

    iput p6, p0, Lcom/oneplus/android/server/scene/gwm;->sua:I
...
.method public onClick(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/gwm;->val$intent:Landroid/content/Intent;

    const/high16 v0, 0x10000000

    invoke-virtual {p1, v0}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;

    iget-object p1, p0, Lcom/oneplus/android/server/scene/gwm;->this$0:Lcom/oneplus/android/server/scene/OemSceneCallBlock;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/gwm;->val$intent:Landroid/content/Intent;

    new-instance v1, Landroid/os/UserHandle;

    iget v2, p0, Lcom/oneplus/android/server/scene/gwm;->val$userId:I
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/gwm;->tua:Ljava/lang/String;
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/gwm;->val$userId:I
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/gwm;->val$pkgName:Ljava/lang/String;

    const-string v2, "CONTEXT_PKG"

    invoke-virtual {v0, v2, v1}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/oneplus/android/server/scene/gwm;->tua:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/gwm;->this$0:Lcom/oneplus/android/server/scene/OemSceneCallBlock;
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/gwm;->sua:I

    iget-object p0, p0, Lcom/oneplus/android/server/scene/gwm;->tua:Ljava/lang/String;
