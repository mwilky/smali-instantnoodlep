...
.field private static rta:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;

.field private static sInstance:Lcom/oneplus/android/server/scene/OemSceneActivityController;

.field private static final sta:I

.field private static final tta:I
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;->QBa:Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->sta:I

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;->RBa:Lcom/oneplus/android/server/scene/OemSceneActivityController$ActivityMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->tta:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->qta:I
...
.method private b(IZ)V
    ...
    :try_start_0
    iget p2, p0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->qta:I

    shl-int p1, v1, p1

    or-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->qta:I
...
.method private tsu(Landroid/content/pm/ActivityInfo;)Z
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->qta:I

    sget v1, Lcom/oneplus/android/server/scene/OemSceneActivityController;->sta:I
    ...
    :cond_0
    sget v1, Lcom/oneplus/android/server/scene/OemSceneActivityController;->tta:I
...
# virtual methods
.method public _f()Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    .locals 1

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->rta:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->rta:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;

    :cond_0
    sget-object p0, Lcom/oneplus/android/server/scene/OemSceneActivityController;->rta:Lcom/oneplus/android/server/scene/OemSceneActivityController$AllowWhiteActivity;
