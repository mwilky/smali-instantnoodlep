...
.field private static final Tua:I
...
# instance fields
.field private Rua:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;->MCa:Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Tua:I
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Uua:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sua:I
...
.method private c(IZ)V
    ...
    :try_start_0
    iget p2, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sua:I

    shl-int p1, v1, p1

    or-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sua:I
...
.method private igw(III)Z
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sua:I

    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Tua:I
    ...
    :cond_0
    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Uua:I
...
# virtual methods
.method public ng()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    .locals 1

    iget-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rua:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rua:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;

    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rua:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
