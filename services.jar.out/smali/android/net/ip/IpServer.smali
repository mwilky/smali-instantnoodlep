...
.field private static final TETHER_WIFI_HOST_IFACE_THIRD_OCTET:B = 0x3ct
...
.method private configureIPv4(Z)Z
    ...
    const-string v5, "com.oneplus.filemanager"
    ...
    const-string v5, "com.oneplus.backuprestore"
    ...
    :cond_4
    invoke-direct {p0}, Landroid/net/ip/IpServer;->getSoftApIp()Ljava/lang/String;
...
.method private getHopLimit(Ljava/lang/String;)B
    ...
    const-string v3, "Verizon: upstreamIface = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v3, " Before modify upstreamHopLimit = "
...
.method private getRandomHostIPv4Address(Ljava/lang/String;)Ljava/lang/String;
    .locals 10
    ...
    invoke-static {v9}, Landroid/net/util/NetworkConstants;->asByte(I)B
    ...
    invoke-static {v1, v2}, Landroid/net/ip/IpServer;->getRandomSanitizedByte(B[B)B
    ...
    sget-byte v2, Landroid/net/util/NetworkConstants;->FF:B

    aput-byte v2, v1, v6

    invoke-static {v5, v1}, Landroid/net/ip/IpServer;->getRandomSanitizedByte(B[B)B
    ...
    const-string v2, "Randomising Host IP failed: "
...
.method private getSoftApIp()Ljava/lang/String;
    .locals 6
    ...
    invoke-interface {v2}, Landroid/os/INetworkManagementService;->getWifiIpForSap()Ljava/lang/String;
    ...
    const-string v4, "Error getting Service: "
    ...
    invoke-direct {p0, v0}, Landroid/net/ip/IpServer;->getRandomHostIPv4Address(Ljava/lang/String;)Ljava/lang/String;
