...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "persist.sys.enableoptcamera.adj"

    invoke-static {v3, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/android/server/am/OomAdjusterInjector;->sEnableOptCameraAdj:Z
...
.method public static resolveConfig(Lorg/json/JSONArray;)V
    ...
    :cond_c
    const-string/jumbo v5, "opt_adj_camera"
    ...
    sput-boolean v5, Lcom/android/server/am/OomAdjusterInjector;->sEnableOptCameraAdj:Z
    ...
    const-string v7, "EnableOptCameraAdj : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-boolean v7, Lcom/android/server/am/OomAdjusterInjector;->sEnableOptCameraAdj:Z
...
.method public static setTunedAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/am/ProcessRecord;->setCurProcState(I)V

    invoke-virtual {p0, v2}, Lcom/android/server/am/ProcessRecord;->setCurRawProcState(I)V
