...
.field protected final mNitsToBacklightSpline:Landroid/util/Spline;
...
.method public constructor <init>(Landroid/hardware/display/BrightnessConfiguration;[F[IF)V
    ...
    :goto_1
    const-string v3, "Nits and backlight arrays must be the same length!"
    ...
    invoke-static {p2, v3, v0, v4}, Lcom/android/internal/util/Preconditions;->checkArrayElementsInRange([FFFLjava/lang/String;)[F
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/display/BrightnessMappingStrategy$PhysicalMappingStrategy;->normalizeAbsoluteBrightness(I)F
    ...
    iput-object v3, p0, Lcom/android/server/display/BrightnessMappingStrategy$PhysicalMappingStrategy;->mNitsToBacklightSpline:Landroid/util/Spline;

    invoke-static {v2, p2}, Landroid/util/Spline;->createSpline([F[F)Landroid/util/Spline;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/display/BrightnessMappingStrategy$PhysicalMappingStrategy;->mBacklightToNitsSpline:Landroid/util/Spline;
    ...
    const-string/jumbo v4, "physical mapping strategy"

    invoke-virtual {v3, v4}, Lcom/android/server/display/utils/Plog;->start(Ljava/lang/String;)Lcom/android/server/display/utils/Plog;
...
.method protected correctBrightness(FLjava/lang/String;I)F
    .locals 2
...
.method public getBrightness(FLjava/lang/String;I)F
    ...
    invoke-virtual {p0, v1, p2, p3}, Lcom/android/server/display/BrightnessMappingStrategy$PhysicalMappingStrategy;->correctBrightness(FLjava/lang/String;I)F
