...
.method private handleWifiApAction(Landroid/content/Intent;)V
    ...
    invoke-static {v5, v3}, Lcom/android/server/connectivity/Tethering;->access$1102(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Ljava/lang/String;

    :cond_0
    iget-object v5, p0, Lcom/android/server/connectivity/Tethering$StateReceiver;->this$0:Lcom/android/server/connectivity/Tethering;

    invoke-static {v5, v1, v2}, Lcom/android/server/connectivity/Tethering;->access$1200(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;I)V
    ...
    invoke-static {v6, v5}, Lcom/android/server/connectivity/Tethering;->access$1302(Lcom/android/server/connectivity/Tethering;I)I
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/Tethering;->access$1102(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Ljava/lang/String;

    iget-object v6, p0, Lcom/android/server/connectivity/Tethering$StateReceiver;->this$0:Lcom/android/server/connectivity/Tethering;

    invoke-static {v6, v1, v0}, Lcom/android/server/connectivity/Tethering;->access$1400(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;I)V

    iget-object v6, p0, Lcom/android/server/connectivity/Tethering$StateReceiver;->this$0:Lcom/android/server/connectivity/Tethering;

    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$1000(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/EntitlementManager;
...
# virtual methods
.method public synthetic lambda$onReceive$0$Tethering$StateReceiver()V
    .locals 1
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$500(Lcom/android/server/connectivity/Tethering;)Landroid/os/Handler;

    move-result-object v1

    new-instance v2, Lcom/android/server/connectivity/-$$Lambda$Tethering$StateReceiver$LUhwLGdeh_d3P477Oe-qHf5ZEKQ;

    invoke-direct {v2, p0}, Lcom/android/server/connectivity/-$$Lambda$Tethering$StateReceiver$LUhwLGdeh_d3P477Oe-qHf5ZEKQ;-><init>(Lcom/android/server/connectivity/Tethering$StateReceiver;)V
