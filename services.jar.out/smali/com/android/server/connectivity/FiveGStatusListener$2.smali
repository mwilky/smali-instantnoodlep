...
.method private cleanup()V
    ...
    invoke-static {}, Lcom/android/server/connectivity/FiveGStatusListener;->access$300()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/server/connectivity/FiveGStatusListener;->access$702(Lcom/android/server/connectivity/FiveGStatusListener;Z)Z

    iget-object v0, p0, Lcom/android/server/connectivity/FiveGStatusListener$2;->this$0:Lcom/android/server/connectivity/FiveGStatusListener;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/android/server/connectivity/FiveGStatusListener;->access$402(Lcom/android/server/connectivity/FiveGStatusListener;Lorg/codeaurora/internal/IExtTelephony;)Lorg/codeaurora/internal/IExtTelephony;

    iget-object v0, p0, Lcom/android/server/connectivity/FiveGStatusListener$2;->this$0:Lcom/android/server/connectivity/FiveGStatusListener;

    invoke-static {v0, v1}, Lcom/android/server/connectivity/FiveGStatusListener;->access$502(Lcom/android/server/connectivity/FiveGStatusListener;Lorg/codeaurora/internal/Client;)Lorg/codeaurora/internal/Client;
...
.method public onBindingDied(Landroid/content/ComponentName;)V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/FiveGStatusListener;->access$800(Lcom/android/server/connectivity/FiveGStatusListener;)I
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/FiveGStatusListener;->access$900(Lcom/android/server/connectivity/FiveGStatusListener;)Landroid/os/Handler;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/FiveGStatusListener;->access$800(Lcom/android/server/connectivity/FiveGStatusListener;)I
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/FiveGStatusListener;->access$400(Lcom/android/server/connectivity/FiveGStatusListener;)Lorg/codeaurora/internal/IExtTelephony;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/connectivity/FiveGStatusListener$2;->this$0:Lcom/android/server/connectivity/FiveGStatusListener;

    invoke-static {v2}, Lcom/android/server/connectivity/FiveGStatusListener;->access$600(Lcom/android/server/connectivity/FiveGStatusListener;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/FiveGStatusListener;->access$500(Lcom/android/server/connectivity/FiveGStatusListener;)Lorg/codeaurora/internal/Client;
