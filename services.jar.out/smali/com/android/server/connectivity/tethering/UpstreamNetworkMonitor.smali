...
.field public static final EVENT_ON_REQUEST_REPLIED:I = 0x65

.field public static final NOTIFY_LOCAL_PREFIXES:I = 0xa

.field private static final TAG:Ljava/lang/String;

.field public static final TRANSPORT_AUTO:I = -0x2

.field public static final TRANSPORT_NULL:I = -0x1
...
.field private mMobileNetworkRequestReplied:Z
...
.method static synthetic access$1100(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;Landroid/net/Network;)V
    .locals 0
...
.method static synthetic access$1200(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;Landroid/net/Network;)V
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mMobileNetworkRequestReplied:Z

    return v0
.end method

.method static synthetic access$502(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mMobileNetworkRequestReplied:Z
...
.method static synthetic access$600(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;ILandroid/net/Network;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->notifyTarget(ILandroid/net/Network;)V

    return-void
.end method

.method static synthetic access$700(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;Landroid/net/Network;Landroid/net/LinkProperties;)V
    .locals 0
...
.method static synthetic access$900(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;)V
    .locals 0
...
.method private static findFirstAvailableUpstreamByTransport(Ljava/lang/Iterable;I)Landroid/net/NetworkState;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v3, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->TAG:Ljava/lang/String;

    const-string v4, "Null pointer exception in networkCapabilities"
...
.method private static findInconsistentUpstreamByTransport(Ljava/lang/Iterable;I)Landroid/net/NetworkState;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v3, v1, Landroid/net/NetworkState;->networkCapabilities:Landroid/net/NetworkCapabilities;
...
.method public getDefaultUpstreamTransport()I
    .locals 1

    iget-object v0, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mDefaultInternetNetwork:Landroid/net/Network;

    invoke-direct {p0, v0}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->getNetworkTransport(Landroid/net/Network;)I
...
.method public getTetheringUpstreamTransport()I
    .locals 2
...
.method public hasInconsistentUpstreamReserved(I)Z
    .locals 4
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mNetworkMap:Ljava/util/HashMap;
    ...
    invoke-static {v3, v0}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->findInconsistentUpstreamByTransport(Ljava/lang/Iterable;I)Landroid/net/NetworkState;
    ...
    const-string v3, "hasInconsistentUpstreamReserved mNetworkMap == null!"
...
.method public registerMobileNetworkRequest()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->registerNetworkRequest(I)V

    return-void
.end method

.method public registerNetworkRequest(I)V
    .locals 14
    ...
    const-string/jumbo v2, "registerMobileNetworkRequest() is not permitted"
    ...
    invoke-virtual {v2, v5}, Landroid/net/NetworkRequest$Builder;->setCapabilities(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkRequest$Builder;
    ...
    invoke-virtual {v5, v7}, Landroid/net/NetworkCapabilities;->addCapability(I)Landroid/net/NetworkCapabilities;
    ...
    iget-object v5, v2, Landroid/net/NetworkRequest;->networkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v5, p1}, Landroid/net/NetworkCapabilities;->addTransportType(I)Landroid/net/NetworkCapabilities;
    ...
    invoke-direct {v2, p0, v5}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor$UpstreamNetworkCallback;-><init>(Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;I)V
    ...
    iput-boolean v4, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mMobileNetworkRequestReplied:Z
    ...
    const-string/jumbo v3, "requesting upstream network: "
    ...
    iget-object v4, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mMobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;

    const/4 v5, 0x0

    iget-object v7, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v1, v13, v2, v3}, Landroid/net/ConnectivityManager;->requestNetwork(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;Landroid/os/Handler;)V
    ...
    iget-object v9, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mMobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;

    const/4 v10, 0x0

    iget-object v12, p0, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->mHandler:Landroid/os/Handler;

    move-object v8, v13

    move v11, v6

    invoke-virtual/range {v7 .. v12}, Landroid/net/ConnectivityManager;->requestNetwork(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;IILandroid/os/Handler;)V
...
.method public selectPreferredUpstreamTransport(I)Landroid/net/NetworkState;
    .locals 1
    ...
    invoke-static {v0, p1}, Lcom/android/server/connectivity/tethering/UpstreamNetworkMonitor;->findFirstAvailableUpstreamByTransport(Ljava/lang/Iterable;I)Landroid/net/NetworkState;
