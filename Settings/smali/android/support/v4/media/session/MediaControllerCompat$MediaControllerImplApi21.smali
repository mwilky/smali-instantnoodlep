...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-virtual {p0, v0, p2, p1}, Landroid/media/session/MediaController;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    check-cast v0, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;

    :try_start_1
    invoke-virtual {v0}, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method processPendingCallbacksLocked()V
    ...
    check-cast v3, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;

    :try_start_1
    invoke-virtual {v3, v2}, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;->registerCallbackListener(Landroid/support/v4/media/session/IMediaControllerCallback;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    check-cast p0, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;

    :try_start_2
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;->registerCallbackListener(Landroid/support/v4/media/session/IMediaControllerCallback;)V
...
.method public final unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    :try_start_2
    invoke-virtual {p0, v1}, Landroid/support/v4/media/session/IMediaSession$Stub$Proxy;->unregisterCallbackListener(Landroid/support/v4/media/session/IMediaControllerCallback;)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
