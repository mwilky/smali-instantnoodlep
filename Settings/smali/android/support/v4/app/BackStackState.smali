...
.method public instantiate(Landroid/support/v4/app/FragmentManagerImpl;)Landroid/support/v4/app/BackStackRecord;
    ...
    iput v1, v2, Landroid/support/v4/app/BackStackRecord$Op;->cmd:I
    ...
    iget-object v4, p1, Landroid/support/v4/app/FragmentManagerImpl;->mActive:Landroid/util/SparseArray;
    ...
    iput v1, v2, Landroid/support/v4/app/BackStackRecord$Op;->enterAnim:I

    add-int/lit8 v1, v4, 0x1

    aget v4, v3, v4

    iput v4, v2, Landroid/support/v4/app/BackStackRecord$Op;->exitAnim:I

    add-int/lit8 v4, v1, 0x1

    aget v1, v3, v1

    iput v1, v2, Landroid/support/v4/app/BackStackRecord$Op;->popEnterAnim:I
    ...
    iput v3, v0, Landroid/support/v4/app/BackStackRecord;->mEnterAnim:I

    iget v3, v2, Landroid/support/v4/app/BackStackRecord$Op;->exitAnim:I

    iput v3, v0, Landroid/support/v4/app/BackStackRecord;->mExitAnim:I
    ...
    iput v3, v0, Landroid/support/v4/app/BackStackRecord;->mPopExitAnim:I

    invoke-virtual {v0, v2}, Landroid/support/v4/app/BackStackRecord;->addOp(Landroid/support/v4/app/BackStackRecord$Op;)V
