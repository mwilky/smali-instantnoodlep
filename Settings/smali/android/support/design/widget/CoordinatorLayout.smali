...
.field private static final sRectPool:Landroid/support/v4/util/Pools$SimplePool;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;
...
.method private static acquireTempRect()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;
...
.method private getDesiredAnchoredChildRectWithoutConstraints(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$LayoutParams;II)V
    .locals 5

    iget p0, p4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->gravity:I
    ...
    :cond_0
    invoke-static {p0, p1}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I

    move-result p0

    iget p4, p4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->anchorGravity:I
    ...
    :cond_2
    invoke-static {p4, p1}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
...
.method private performIntercept(Landroid/view/MotionEvent;I)Z
    ...
    iget-object v13, v12, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method private prepareChildren()V
    ...
    iget v5, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorId:I
    ...
    iput-object v6, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorDirectChild:Landroid/view/View;

    iput-object v6, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorView:Landroid/view/View;

    goto/16 :goto_7

    :cond_0
    iget-object v5, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorView:Landroid/view/View;
    ...
    iget v7, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorId:I
    ...
    :cond_5
    iput-object v5, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorDirectChild:Landroid/view/View;
    ...
    iput-object v5, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorView:Landroid/view/View;
    ...
    iget-object v7, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorDirectChild:Landroid/view/View;
    ...
    iget v9, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->insetEdge:I

    invoke-static {v9, v7}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I

    move-result v9

    if-eqz v9, :cond_10

    iget v10, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->dodgeInsetEdges:I

    invoke-static {v10, v7}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
    ...
    iget-object v7, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;

    if-eqz v7, :cond_11

    invoke-virtual {v7, p0, v3, v6}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->layoutDependsOn(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget v2, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorId:I
...
.method getDesiredAnchoredChildRect(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/design/widget/CoordinatorLayout;->getDesiredAnchoredChildRectWithoutConstraints(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$LayoutParams;II)V

    invoke-direct {p0, v0, p4, v8, p1}, Landroid/support/design/widget/CoordinatorLayout;->constrainChildRect(Landroid/support/design/widget/CoordinatorLayout$LayoutParams;Landroid/graphics/Rect;II)V
...
.method getResolvedLayoutParams(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    ...
    iget-object v3, p0, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;

    if-eq v3, p1, :cond_6

    if-eqz v3, :cond_5

    invoke-virtual {v3}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->onDetachedFromLayoutParams()V
...
.method offsetChildToAnchor(Landroid/view/View;I)V
    ...
    iget-object v0, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorView:Landroid/view/View;
    ...
    invoke-virtual {v7, v0, v10}, Landroid/support/design/widget/CoordinatorLayout;->getDescendantRect(Landroid/view/View;Landroid/graphics/Rect;)V

    const/4 v13, 0x0

    invoke-virtual {v7, v8, v13, v11}, Landroid/support/design/widget/CoordinatorLayout;->getChildRect(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/design/widget/CoordinatorLayout;->getDesiredAnchoredChildRectWithoutConstraints(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$LayoutParams;II)V
    ...
    :cond_1
    invoke-direct {v7, v9, v12, v14, v15}, Landroid/support/design/widget/CoordinatorLayout;->constrainChildRect(Landroid/support/design/widget/CoordinatorLayout$LayoutParams;Landroid/graphics/Rect;II)V
    ...
    iget-object v0, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;

    if-eqz v0, :cond_4

    iget-object v1, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mAnchorView:Landroid/view/View;

    invoke-virtual {v0, v7, v8, v1}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->onDependentViewChanged(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v10}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z

    invoke-virtual {v11}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {v0, v11}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z

    invoke-virtual {v12}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {v0, v12}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z
...
.method final onChildViewsChanged(I)V
    ...
    iget v10, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->insetEdge:I
    ...
    invoke-static {v10, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
    ...
    :cond_7
    :goto_3
    iget v9, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->dodgeInsetEdges:I
    ...
    iget-object v10, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    invoke-virtual {v10, v0, v8, v11}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->getInsetDodgeRect(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    sget-object v3, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {v3, v12}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v11}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z
    ...
    invoke-static {v3, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
    ...
    iget v12, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mInsetOffsetY:I
    ...
    invoke-direct {v0, v8, v12}, Landroid/support/design/widget/CoordinatorLayout;->setInsetOffsetY(Landroid/view/View;I)V
    ...
    iget v13, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mInsetOffsetY:I
    ...
    invoke-direct {v0, v8, v10}, Landroid/support/design/widget/CoordinatorLayout;->setInsetOffsetY(Landroid/view/View;I)V
    ...
    iget v12, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mInsetOffsetX:I
    ...
    invoke-direct {v0, v8, v12}, Landroid/support/design/widget/CoordinatorLayout;->setInsetOffsetX(Landroid/view/View;I)V
    ...
    iget v9, v9, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mInsetOffsetX:I
    ...
    invoke-direct {v0, v8, v3}, Landroid/support/design/widget/CoordinatorLayout;->setInsetOffsetX(Landroid/view/View;I)V
    ...
    invoke-virtual {v13, v0, v11, v8}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->layoutDependsOn(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v12}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getChangedAfterNestedScroll()Z

    move-result v14

    if-eqz v14, :cond_16

    invoke-virtual {v12}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->resetChangedAfterNestedScroll()V
    ...
    invoke-virtual {v13, v0, v11, v8}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->onDependentViewChanged(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_17
    invoke-virtual {v13, v0, v11, v8}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->onDependentViewRemoved(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v12, v11}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->setChangedAfterNestedScroll(Z)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p5, p5, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onLayoutChild(Landroid/view/View;I)V
    ...
    :try_start_0
    invoke-virtual {p0, v1, v0}, Landroid/support/design/widget/CoordinatorLayout;->getDescendantRect(Landroid/view/View;Landroid/graphics/Rect;)V

    invoke-virtual {p0, p1, p2, v0, v2}, Landroid/support/design/widget/CoordinatorLayout;->getDesiredAnchoredChildRect(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    sget-object p0, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {p0, v2}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z
    ...
    iget v4, v1, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->gravity:I

    invoke-static {v4}, Landroid/support/design/widget/CoordinatorLayout;->resolveKeylineGravity(I)I

    move-result v4

    invoke-static {v4, p2}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
    ...
    sget-object p1, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {p1, v7}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z

    invoke-virtual {p0}, Landroid/graphics/Rect;->setEmpty()V

    sget-object p1, Landroid/support/design/widget/CoordinatorLayout;->sRectPool:Landroid/support/v4/util/Pools$SimplePool;

    invoke-virtual {p1, p0}, Landroid/support/v4/util/Pools$SimplePool;->release(Ljava/lang/Object;)Z
...
.method protected onMeasure(II)V
    ...
    :cond_3
    invoke-static {v11, v10}, Landroid/support/v4/content/res/TypedArrayUtils;->getAbsoluteGravity(II)I
    ...
    :goto_6
    iget-object v0, v1, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onStartNestedScroll(Landroid/view/View;Landroid/view/View;II)Z
    ...
    iget-object v0, v13, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onStopNestedScroll(Landroid/view/View;I)V
    ...
    :cond_0
    iget-object v5, v4, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->mBehavior:Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    :cond_1
    invoke-virtual {v4, p2, v1}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->setNestedScrollAccepted(IZ)V
