...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v4}, Landroid/support/v7/view/menu/ShowableListMenu;->isShowing()Z
    ...
    :cond_0
    invoke-interface {v4}, Landroid/support/v7/view/menu/ShowableListMenu;->getListView()Landroid/widget/ListView;

    move-result-object v4

    check-cast v4, Landroid/support/v7/widget/DropDownListView;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ForwardingListener;->mTmpLocation:[I
    ...
    invoke-virtual {v4, v5, v3}, Landroid/support/v7/widget/DropDownListView;->onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    iput p2, p0, Landroid/support/v7/widget/ForwardingListener;->mActivePointerId:I

    iget-object p2, p0, Landroid/support/v7/widget/ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    :cond_e
    iget-object p2, p0, Landroid/support/v7/widget/ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    iget v0, p0, Landroid/support/v7/widget/ForwardingListener;->mLongPressTimeout:I
