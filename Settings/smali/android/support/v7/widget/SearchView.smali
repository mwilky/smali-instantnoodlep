...
.method onItemClicked(IILjava/lang/String;)Z
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/CursorAdapter;

    invoke-virtual {p3}, Landroid/support/v4/widget/CursorAdapter;->getCursor()Landroid/database/Cursor;
    ...
    invoke-static {p3, v0}, Landroid/support/v7/widget/SuggestionsAdapter;->getColumnString(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, v1}, Landroid/support/v7/widget/SuggestionsAdapter;->getColumnString(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->access$000(Landroid/support/v7/widget/SearchView$SearchAutoComplete;Z)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p4, p0, Landroid/support/v7/widget/SearchView;->mTemp:[I

    invoke-virtual {p1, p4}, Landroid/view/View;->getLocationInWindow([I)V

    iget-object p4, p0, Landroid/support/v7/widget/SearchView;->mTemp2:[I
...
.method public onWindowFocusChanged(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mUpdateDrawableStateRunnable:Ljava/lang/Runnable;
...
.method public setSearchableInfo(Landroid/app/SearchableInfo;)V
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/widget/CursorAdapter;->changeCursor(Landroid/database/Cursor;)V
    ...
    new-instance p1, Landroid/support/v7/widget/SuggestionsAdapter;
    ...
    invoke-direct {p1, v3, p0, v4, v5}, Landroid/support/v7/widget/SuggestionsAdapter;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    check-cast p1, Landroid/support/v7/widget/SuggestionsAdapter;
    ...
    :goto_0
    invoke-virtual {p1, v3}, Landroid/support/v7/widget/SuggestionsAdapter;->setQueryRefinement(I)V
