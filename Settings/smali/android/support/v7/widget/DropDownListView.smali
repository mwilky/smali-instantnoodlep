...
.method public onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    iput-boolean v5, v1, Landroid/support/v7/widget/DropDownListView;->mDrawsInPressedState:Z
    ...
    iget v0, v1, Landroid/support/v7/widget/DropDownListView;->mMotionPosition:I
    ...
    :cond_6
    iput v8, v1, Landroid/support/v7/widget/DropDownListView;->mMotionPosition:I
    ...
    :cond_9
    iget-object v0, v1, Landroid/support/v7/widget/DropDownListView;->mSelectorRect:Landroid/graphics/Rect;
    ...
    iget v13, v1, Landroid/support/v7/widget/DropDownListView;->mSelectionLeftPadding:I
    ...
    iget v13, v1, Landroid/support/v7/widget/DropDownListView;->mSelectionTopPadding:I
    ...
    iget v13, v1, Landroid/support/v7/widget/DropDownListView;->mSelectionRightPadding:I
    ...
    iget v13, v1, Landroid/support/v7/widget/DropDownListView;->mSelectionBottomPadding:I
    ...
    :try_start_0
    iget-object v0, v1, Landroid/support/v7/widget/DropDownListView;->mIsChildViewEnabled:Ljava/lang/reflect/Field;
    ...
    iget-object v5, v1, Landroid/support/v7/widget/DropDownListView;->mIsChildViewEnabled:Ljava/lang/reflect/Field;
    ...
    :cond_e
    invoke-direct {v1, v4}, Landroid/support/v7/widget/DropDownListView;->setSelectorEnabled(Z)V
    ...
    :cond_10
    iput-boolean v4, v1, Landroid/support/v7/widget/DropDownListView;->mDrawsInPressedState:Z
    ...
    iget v3, v1, Landroid/support/v7/widget/DropDownListView;->mMotionPosition:I
    ...
    iget-object v3, v1, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    iput-object v3, v1, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/widget/AutoScrollHelper;->setEnabled(Z)Landroid/support/v4/widget/AutoScrollHelper;

    iget-object v3, v1, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Landroid/support/v4/widget/ListViewAutoScrollHelper;

    invoke-virtual {v3, v1, v2}, Landroid/support/v4/widget/AutoScrollHelper;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_7

    :cond_13
    iget-object v1, v1, Landroid/support/v7/widget/DropDownListView;->mScrollHelper:Landroid/support/v4/widget/ListViewAutoScrollHelper;

    if-eqz v1, :cond_14

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/AutoScrollHelper;->setEnabled(Z)Landroid/support/v4/widget/AutoScrollHelper;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v1, Landroid/support/v7/widget/DropDownListView$ResolveHoverRunnable;->this$0:Landroid/support/v7/widget/DropDownListView;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Landroid/support/v7/widget/DropDownListView$ResolveHoverRunnable;->this$0:Landroid/support/v7/widget/DropDownListView;

    const/4 v2, 0x0

    invoke-static {v1, v2}, Landroid/support/v7/widget/DropDownListView;->access$102(Landroid/support/v7/widget/DropDownListView;Landroid/support/v7/widget/DropDownListView$ResolveHoverRunnable;)Landroid/support/v7/widget/DropDownListView$ResolveHoverRunnable;
