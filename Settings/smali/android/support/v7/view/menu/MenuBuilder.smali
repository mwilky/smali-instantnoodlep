...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :goto_0
    iput-boolean p1, p0, Landroid/support/v7/view/menu/MenuBuilder;->mShortcutsVisible:Z
...
.method public addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    iget-object p7, p0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v1}, Landroid/support/v7/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
    ...
    invoke-virtual {p0, p1, p2, p3, v4}, Landroid/support/v7/view/menu/MenuBuilder;->addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method protected addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget v9, p0, Landroid/support/v7/view/menu/MenuBuilder;->mDefaultShowAsAction:I
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/MenuBuilder;->mCurrentMenuInfo:Landroid/view/ContextMenu$ContextMenuInfo;

    if-eqz p1, :cond_0

    invoke-virtual {v1, p1}, Landroid/support/v7/view/menu/MenuItemImpl;->setMenuInfo(Landroid/view/ContextMenu$ContextMenuInfo;)V

    :cond_0
    iget-object p1, p0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    check-cast p4, Landroid/support/v7/view/menu/MenuItemImpl;

    invoke-virtual {p4}, Landroid/support/v7/view/menu/MenuItemImpl;->getOrdering()I
    ...
    invoke-virtual {p0, p3}, Landroid/support/v7/view/menu/MenuBuilder;->onItemsChanged(Z)V
...
.method public performIdentifierAction(II)Z
    ...
    :goto_1
    invoke-virtual {p0, v2, p2}, Landroid/support/v7/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;I)Z
...
.method public performItemAction(Landroid/view/MenuItem;Landroid/support/v7/view/menu/MenuPresenter;I)Z
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/MenuBuilder;->mContext:Landroid/content/Context;
    ...
    iget-object p3, v2, Landroid/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;->mInner:Landroid/view/ActionProvider;

    iget-object v2, v2, Landroid/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;->this$0:Landroid/support/v7/view/menu/MenuItemWrapperICS;

    invoke-virtual {v2, p1}, Landroid/support/v7/view/menu/BaseMenuWrapper;->getSubMenuWrapper(Landroid/view/SubMenu;)Landroid/view/SubMenu;
    ...
    :cond_7
    iget-object p3, p0, Landroid/support/v7/view/menu/MenuBuilder;->mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public removeGroup(I)V
    ...
    invoke-direct {p0, v2, v1}, Landroid/support/v7/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
...
.method public removeItem(I)V
    ...
    invoke-direct {p0, v1, p1}, Landroid/support/v7/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
