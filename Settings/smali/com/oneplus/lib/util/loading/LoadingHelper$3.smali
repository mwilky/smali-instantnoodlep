...
.method public run()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/oneplus/lib/util/loading/LoadingHelper$3;->val$callback:Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;

    if-eqz p0, :cond_1

    const/4 v0, 0x1

    invoke-interface {p0, v0}, Lcom/oneplus/lib/util/loading/LoadingHelper$FinishShowCallback;->finish(Z)V
