...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/oneplus/lib/widget/NumberPicker;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectorIndices:[I

    const/high16 v3, -0x80000000

    iput v3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mInitialScrollOffset:I

    iput v0, p0, Lcom/oneplus/lib/widget/NumberPicker;->mScrollState:I

    const/4 v3, -0x1

    iput v3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mLastHandledDownDpadKeyCode:I

    iput v1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectMiddleCount:I

    sget-object v4, Lcom/oneplus/commonctrl/R$styleable;->NumberPicker:[I
    ...
    :goto_0
    iput-boolean p3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mHasSelectorWheel:Z

    sget p3, Lcom/oneplus/commonctrl/R$styleable;->NumberPicker_hideWheelUntilFocused:I

    invoke-virtual {p2, p3, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p3

    iput-boolean p3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mHideWheelUntilFocused:Z
    ...
    iput v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSolidColor:I
    ...
    :cond_1
    iput-object v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectionDivider:Landroid/graphics/drawable/Drawable;
    ...
    iput v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectionDividerHeight:I
    ...
    iput v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectionDividerWidth:I
    ...
    iput v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectionDividersDistance:I
    ...
    iput v5, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinHeight:I
    ...
    iput v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxHeight:I

    iget v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinHeight:I

    if-eq v7, v3, :cond_3

    iget v8, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxHeight:I
    ...
    iput v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinWidth:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxWidth:I

    iget v2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinWidth:I

    if-eq v2, v3, :cond_5

    iget v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxWidth:I
    ...
    :cond_5
    :goto_2
    iget v2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxWidth:I
    ...
    iget-boolean v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mHasSelectorWheel:Z
    ...
    iput-object v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;

    iget-object v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;

    invoke-virtual {v7, p2}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;

    invoke-virtual {v7, v4}, Landroid/widget/ImageButton;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    goto :goto_4

    :cond_7
    iput-object v8, p0, Lcom/oneplus/lib/widget/NumberPicker;->mIncrementButton:Landroid/widget/ImageButton;
    ...
    iput-object v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mDecrementButton:Landroid/widget/ImageButton;

    iget-object v7, p0, Lcom/oneplus/lib/widget/NumberPicker;->mDecrementButton:Landroid/widget/ImageButton;

    invoke-virtual {v7, p2}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mDecrementButton:Landroid/widget/ImageButton;

    invoke-virtual {p2, v4}, Landroid/widget/ImageButton;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-direct {v4, p0}, Lcom/oneplus/lib/widget/NumberPicker$3;-><init>(Lcom/oneplus/lib/widget/NumberPicker;)V
    ...
    new-instance v7, Lcom/oneplus/lib/widget/NumberPicker$InputTextFilter;

    invoke-direct {v7, p0}, Lcom/oneplus/lib/widget/NumberPicker$InputTextFilter;-><init>(Lcom/oneplus/lib/widget/NumberPicker;)V
    ...
    invoke-virtual {p2, v5}, Landroid/widget/EditText;->setRawInputType(I)V
    ...
    invoke-direct {p1, p2, v8, v1}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;Z)V
...
.method private formatNumber(I)Ljava/lang/String;
    ...
    check-cast p0, Lcom/oneplus/lib/widget/NumberPicker$TwoDigitFormatter;

    invoke-virtual {p0, p1}, Lcom/oneplus/lib/widget/NumberPicker$TwoDigitFormatter;->format(I)Ljava/lang/String;
...
.method private setValueInternal(IZ)V
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mOnValueChangeListener:Lcom/oneplus/lib/widget/NumberPicker$OnValueChangeListener;

    if-eqz p1, :cond_3

    iget p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mValue:I

    invoke-interface {p1, p0, v0, p2}, Lcom/oneplus/lib/widget/NumberPicker$OnValueChangeListener;->onValueChange(Lcom/oneplus/lib/widget/NumberPicker;II)V
...
.method public computeScroll()V
    ...
    invoke-virtual {p0, v3, v2}, Lcom/oneplus/lib/widget/NumberPicker;->scrollBy(II)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mBeginSoftInputOnLongPressCommand:Lcom/oneplus/lib/widget/NumberPicker$BeginSoftInputOnLongPressCommand;

    if-nez p1, :cond_8

    new-instance p1, Lcom/oneplus/lib/widget/NumberPicker$BeginSoftInputOnLongPressCommand;

    invoke-direct {p1, p0}, Lcom/oneplus/lib/widget/NumberPicker$BeginSoftInputOnLongPressCommand;-><init>(Lcom/oneplus/lib/widget/NumberPicker;)V

    iput-object p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mBeginSoftInputOnLongPressCommand:Lcom/oneplus/lib/widget/NumberPicker$BeginSoftInputOnLongPressCommand;
...
.method protected onLayout(ZIIII)V
    ...
    iget p3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mTextSize:I
    ...
    iput p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectorTextGapHeight:I

    iget p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mTextSize:I

    iget p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectorTextGapHeight:I

    add-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectorElementHeight:I
    ...
    iget p3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectMiddleCount:I

    mul-int/2addr p1, p3

    sub-int/2addr p2, p1

    iput p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mInitialScrollOffset:I
    ...
    iput p3, p0, Lcom/oneplus/lib/widget/NumberPicker;->mBottomSelectionDividerBottom:I
...
.method protected onMeasure(II)V
    ...
    :cond_1
    iget p1, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinHeight:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v4, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinimumFlingVelocity:I
    ...
    iget-object v4, p0, Lcom/oneplus/lib/widget/NumberPicker;->mFlingScroller:Landroid/widget/Scroller;
...
.method public scrollBy(II)V
    ...
    iget p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMaxValue:I

    :cond_4
    aput p2, p1, v2

    invoke-direct {p0, p2}, Lcom/oneplus/lib/widget/NumberPicker;->ensureCachedScrollSelectorValue(I)V

    iget p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mSelectMiddleCount:I

    aget p2, p1, p2

    invoke-direct {p0, p2, v3}, Lcom/oneplus/lib/widget/NumberPicker;->setValueInternal(IZ)V
    ...
    iget p2, p0, Lcom/oneplus/lib/widget/NumberPicker;->mMinValue:I
