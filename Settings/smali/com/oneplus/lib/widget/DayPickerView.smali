...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v2, v1, v0}, Lcom/oneplus/lib/widget/DayPickerView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v1, v0}, Lcom/oneplus/lib/widget/DayPickerView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p2, v2}, Lcom/oneplus/lib/widget/DayPickerPagerAdapter;->setMonthTextAppearance(I)V

    iget-object p2, p0, Lcom/oneplus/lib/widget/DayPickerView;->mAdapter:Lcom/oneplus/lib/widget/DayPickerPagerAdapter;

    invoke-virtual {p2, v3}, Lcom/oneplus/lib/widget/DayPickerPagerAdapter;->setDayOfWeekTextAppearance(I)V

    iget-object p2, p0, Lcom/oneplus/lib/widget/DayPickerView;->mAdapter:Lcom/oneplus/lib/widget/DayPickerPagerAdapter;

    invoke-virtual {p2, v4}, Lcom/oneplus/lib/widget/DayPickerPagerAdapter;->setDayTextAppearance(I)V

    iget-object p2, p0, Lcom/oneplus/lib/widget/DayPickerView;->mAdapter:Lcom/oneplus/lib/widget/DayPickerPagerAdapter;

    invoke-virtual {p2, v5}, Lcom/oneplus/lib/widget/DayPickerPagerAdapter;->setDaySelectorColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v3, p0, p2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/oneplus/lib/widget/DayPickerView;->mOnClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {p1, v3}, Lcom/oneplus/support/viewpager/widget/ViewPager;->setAdapter(Lcom/oneplus/support/viewpager/widget/PagerAdapter;)V

    iget-object p1, p0, Lcom/oneplus/lib/widget/DayPickerView;->mViewPager:Lcom/oneplus/support/viewpager/widget/ViewPager;

    iget-object v3, p0, Lcom/oneplus/lib/widget/DayPickerView;->mOnPageChangedListener:Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;

    invoke-virtual {p1, v3}, Lcom/oneplus/support/viewpager/widget/ViewPager;->setOnPageChangeListener(Lcom/oneplus/support/viewpager/widget/ViewPager$OnPageChangeListener;)V
    ...
    sget-object v4, Lcom/oneplus/lib/widget/DayPickerView;->ATTRS_TEXT_COLOR:[I

    invoke-virtual {p1, v3, v4, p2, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {p1, v0, p2, p4}, Ljava/util/Calendar;->set(III)V
    ...
    invoke-static {v1, p1}, Lcom/oneplus/lib/widget/DayPickerView;->parseDate(Ljava/lang/String;Ljava/util/Calendar;)Z
    ...
    invoke-virtual {p1, p4, v0, v1}, Ljava/util/Calendar;->set(III)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/oneplus/lib/util/MathUtils;->constrain(JJJ)J

    move-result-wide v2

    invoke-virtual {p0, p3}, Lcom/oneplus/lib/widget/DayPickerView;->setFirstDayOfWeek(I)V

    invoke-virtual {p0, v8, v9}, Lcom/oneplus/lib/widget/DayPickerView;->setMinDate(J)V

    invoke-virtual {p0, v0, v1}, Lcom/oneplus/lib/widget/DayPickerView;->setMaxDate(J)V

    invoke-virtual {p0, v2, v3, p2}, Lcom/oneplus/lib/widget/DayPickerView;->setDate(JZ)V
...
.method private setDate(JZZ)V
    ...
    :cond_4
    iget-object p4, p0, Lcom/oneplus/lib/widget/DayPickerView;->mMinDate:Ljava/util/Calendar;

    iget-object v0, p0, Lcom/oneplus/lib/widget/DayPickerView;->mMaxDate:Ljava/util/Calendar;

    invoke-direct {p0, p4, v0}, Lcom/oneplus/lib/widget/DayPickerView;->getDiffMonths(Ljava/util/Calendar;Ljava/util/Calendar;)I
    ...
    iput-object v1, p0, Lcom/oneplus/lib/widget/DayPickerView;->mTempCalendar:Ljava/util/Calendar;
    ...
    iget-object p1, p0, Lcom/oneplus/lib/widget/DayPickerView;->mTempCalendar:Ljava/util/Calendar;

    invoke-direct {p0, v0, p1}, Lcom/oneplus/lib/widget/DayPickerView;->getDiffMonths(Ljava/util/Calendar;Ljava/util/Calendar;)I

    move-result p1

    invoke-static {p1, v2, p4}, Lcom/oneplus/lib/util/MathUtils;->constrain(III)I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p2, v1, v3, v2}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline1(IIII)I
    ...
    invoke-static {p3, p5, v4, v3}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline1(IIII)I
    ...
    invoke-static {p2, p5, v2, v1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline1(IIII)I
    ...
    invoke-virtual {v0, p0, p2, p4, p5}, Landroid/widget/ImageButton;->layout(IIII)V
