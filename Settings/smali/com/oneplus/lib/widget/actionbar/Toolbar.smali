...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v2, v1, v0}, Lcom/oneplus/lib/widget/actionbar/Toolbar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v1, v0}, Lcom/oneplus/lib/widget/actionbar/Toolbar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mTmpStatesArray:[I
    ...
    iput-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMenuViewItemClickListener:Lcom/oneplus/lib/menu/ActionMenuView$OnMenuItemClickListener;
    ...
    iput-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mShowOverflowMenuRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, p1, v2}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->getDividerColor(Landroid/content/Context;I)I

    move-result v2

    iput v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mActionBarDividerColor:I
    ...
    invoke-virtual {p0, v3}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->setCollapsedState(Z)Z
    ...
    invoke-virtual {p2, v2, p4}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I
    ...
    iget-object v6, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mContentInsets:Lcom/oneplus/lib/widget/actionbar/RtlSpacingHelper;

    invoke-virtual {v6, v4, v5}, Lcom/oneplus/lib/widget/actionbar/RtlSpacingHelper;->setAbsolute(II)V
    ...
    :cond_5
    iget-object v4, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mContentInsets:Lcom/oneplus/lib/widget/actionbar/RtlSpacingHelper;

    invoke-virtual {v4, p1, v2}, Lcom/oneplus/lib/widget/actionbar/RtlSpacingHelper;->setRelative(II)V
...
.method private ensureMenu()V
    ...
    invoke-direct {v0, v2, v1}, Lcom/oneplus/lib/menu/ActionMenuView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v0, v2}, Lcom/oneplus/lib/menu/ActionMenuView;->setPopupTheme(I)V

    iget-object v0, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;

    iget-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMenuViewItemClickListener:Lcom/oneplus/lib/menu/ActionMenuView$OnMenuItemClickListener;

    invoke-virtual {v0, v2}, Lcom/oneplus/lib/menu/ActionMenuView;->setOnMenuItemClickListener(Lcom/oneplus/lib/menu/ActionMenuView$OnMenuItemClickListener;)V

    iget-object v0, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMenuView:Lcom/oneplus/lib/menu/ActionMenuView;

    iget-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mActionMenuPresenterCallback:Lcom/oneplus/lib/menu/MenuPresenter$Callback;

    iget-object v3, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMenuBuilderCallback:Lcom/oneplus/lib/menu/MenuBuilder$Callback;

    invoke-virtual {v0, v2, v3}, Lcom/oneplus/lib/menu/ActionMenuView;->setMenuCallbacks(Lcom/oneplus/lib/menu/MenuPresenter$Callback;Lcom/oneplus/lib/menu/MenuBuilder$Callback;)V
    ...
    iget v3, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mButtonGravity:I
    ...
    invoke-direct {p0, v0, v2}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->addSystemView(Landroid/view/View;Z)V
    ...
    new-instance v2, Lcom/oneplus/lib/widget/actionbar/Toolbar$ExpandedActionViewMenuPresenter;

    invoke-direct {v2, p0, v1}, Lcom/oneplus/lib/widget/actionbar/Toolbar$ExpandedActionViewMenuPresenter;-><init>(Lcom/oneplus/lib/widget/actionbar/Toolbar;Lcom/oneplus/lib/widget/actionbar/Toolbar$1;)V

    iput-object v2, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mExpandedMenuPresenter:Lcom/oneplus/lib/widget/actionbar/Toolbar$ExpandedActionViewMenuPresenter;
...
.method private getChildTop(Landroid/view/View;I)I
    ...
    iget v3, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mGravity:I
...
.method private measureChildCollapseMargins(Landroid/view/View;IIII[I)I
    ...
    invoke-static {p4, p0, p3}, Landroid/widget/Toolbar;->getChildMeasureSpec(III)I
...
.method private measureChildConstrained(Landroid/view/View;IIIII)V
    ...
    invoke-static {p2, v2, p3}, Landroid/widget/Toolbar;->getChildMeasureSpec(III)I
...
.method getOuterActionMenuPresenter()Lcom/oneplus/lib/menu/ActionMenuPresenter;
    ...
    iget-object p0, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mOuterActionMenuPresenter:Lcom/oneplus/lib/menu/ActionMenuPresenter;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v7, v4, v12, v3, v5}, Landroid/widget/TextView;->layout(IIII)V
    ...
    invoke-virtual {v7, v4, v12, v5, v6}, Landroid/widget/TextView;->layout(IIII)V

    iget v6, v0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mTitleMarginEnd:I
    ...
    invoke-direct {v0, v1, v3}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->addCustomViewsWithGravity(Ljava/util/List;I)V
    ...
    iget-object v5, v0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mTempViews:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v5, v4, v15, v6}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->layoutChildLeft(Landroid/view/View;I[II)I
    ...
    invoke-direct {v0, v5, v3, v15, v6}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->layoutChildRight(Landroid/view/View;I[II)I
    ...
    check-cast v11, Lcom/oneplus/lib/widget/actionbar/Toolbar$LayoutParams;

    iget v12, v11, Landroid/widget/Toolbar$LayoutParams;->leftMargin:I

    sub-int/2addr v12, v8

    iget v8, v11, Landroid/widget/Toolbar$LayoutParams;->rightMargin:I
    ...
    invoke-direct {v0, v2, v4, v15, v6}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->layoutChildLeft(Landroid/view/View;I[II)I
...
.method protected onMeasure(II)V
    ...
    iget-object v10, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mTempMargins:[I
    ...
    invoke-static {v11, v1}, Landroid/widget/Toolbar;->combineMeasuredStates(II)I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/widget/Toolbar;->getMeasuredWidth()I
    ...
    invoke-static {v8, v3, v4}, Landroid/widget/Toolbar;->getChildMeasureSpec(III)I
    ...
    iget v4, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mPaddingTopOffset:I

    add-int/2addr v3, v4

    iget-boolean v4, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mInsetPaddingTopInGestureMode:Z
    ...
    invoke-static {v9, v4, v2}, Landroid/widget/Toolbar;->getChildMeasureSpec(III)I
    ...
    invoke-direct {v7, v5}, Lcom/oneplus/lib/widget/actionbar/Toolbar;->shouldLayout(Landroid/view/View;)Z
    ...
    invoke-static {v15, v1}, Landroid/widget/Toolbar;->combineMeasuredStates(II)I
    ...
    invoke-static {v15, v2}, Landroid/widget/Toolbar;->combineMeasuredStates(II)I
    ...
    invoke-static {v0, v8, v1}, Landroid/widget/Toolbar;->resolveSizeAndState(III)I
    ...
    invoke-static {v1, v9, v2}, Landroid/widget/Toolbar;->resolveSizeAndState(III)I
    ...
    iput v3, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mPaddingTopOffset:I
    ...
    invoke-static {v2}, Lcom/oneplus/lib/util/AppUtils;->gestureButtonEnabled(Landroid/content/Context;)Z
    ...
    const-class v4, Lcom/oneplus/support/annotation/GestureBarAdapter;

    invoke-virtual {v3, v4}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v3

    check-cast v3, Lcom/oneplus/support/annotation/GestureBarAdapter;

    if-eqz v3, :cond_10

    invoke-interface {v3}, Lcom/oneplus/support/annotation/GestureBarAdapter;->transparentGestureButton()Z
    ...
    iput-boolean v3, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mMeasuredGestureBar:Z
    ...
    iget v4, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mHeightWithGestureBar:I
    ...
    :goto_d
    iget-boolean v1, v7, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mCollapsible:Z
    ...
    invoke-virtual {v7, v2}, Landroid/widget/Toolbar;->getChildAt(I)Landroid/view/View;
    ...
    :cond_17
    invoke-virtual {v7, v0, v12}, Landroid/widget/Toolbar;->setMeasuredDimension(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object p1, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mShowOverflowMenuRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, p1}, Landroid/widget/Toolbar;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object p1, p0, Lcom/oneplus/lib/widget/actionbar/Toolbar;->mShowOverflowMenuRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, p1}, Landroid/widget/Toolbar;->post(Ljava/lang/Runnable;)Z
