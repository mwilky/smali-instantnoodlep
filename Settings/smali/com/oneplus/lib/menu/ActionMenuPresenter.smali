...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput v0, p0, Lcom/oneplus/lib/menu/ActionMenuPresenter;->mOpenSubMenuId:I
    ...
    invoke-virtual {p1, v2}, Lcom/oneplus/lib/menu/MenuBuilder;->getItem(I)Landroid/view/MenuItem;
    ...
    :cond_8
    :goto_4
    new-instance v0, Lcom/oneplus/lib/menu/ActionMenuPresenter$ActionButtonSubmenu;

    iget-object v2, p0, Lcom/oneplus/lib/menu/BaseMenuPresenter;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v2, p1, v3}, Lcom/oneplus/lib/menu/ActionMenuPresenter$ActionButtonSubmenu;-><init>(Lcom/oneplus/lib/menu/ActionMenuPresenter;Landroid/content/Context;Lcom/oneplus/lib/menu/SubMenuBuilder;Landroid/view/View;)V

    iput-object v0, p0, Lcom/oneplus/lib/menu/ActionMenuPresenter;->mActionButtonPopup:Lcom/oneplus/lib/menu/ActionMenuPresenter$ActionButtonSubmenu;
    ...
    invoke-virtual {v0, v4, v4}, Lcom/oneplus/lib/menu/MenuPopupHelper;->tryShow(ZZ)Z
...
.method public updateMenuView(Z)V
    ...
    invoke-virtual {v3}, Lcom/oneplus/lib/menu/MenuBuilder;->flagActionItems()V
    ...
    invoke-virtual {v7}, Lcom/oneplus/lib/menu/MenuItemImpl;->isActionButton()Z
    ...
    instance-of v9, v8, Lcom/oneplus/lib/menu/MenuView$ItemView;

    if-eqz v9, :cond_1

    move-object v9, v8

    check-cast v9, Lcom/oneplus/lib/menu/MenuView$ItemView;

    invoke-interface {v9}, Lcom/oneplus/lib/menu/MenuView$ItemView;->getItemData()Lcom/oneplus/lib/menu/MenuItemImpl;
    ...
    :goto_1
    invoke-virtual {p0, v7, v8, p1}, Lcom/oneplus/lib/menu/BaseMenuPresenter;->getItemView(Lcom/oneplus/lib/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_3
    iget-object v7, p0, Lcom/oneplus/lib/menu/BaseMenuPresenter;->mMenuView:Lcom/oneplus/lib/menu/MenuView;
    ...
    invoke-virtual {v5}, Lcom/oneplus/lib/menu/MenuItemImpl;->getSupportActionProvider()Lcom/oneplus/lib/widget/ActionProvider;
    ...
    :cond_b
    iget-boolean p1, p0, Lcom/oneplus/lib/menu/ActionMenuPresenter;->mReserveOverflow:Z
