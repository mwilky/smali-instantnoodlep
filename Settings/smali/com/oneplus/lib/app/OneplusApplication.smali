...
.method public onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    new-instance p2, Lcom/oneplus/support/annotation/GestureBarAdapterPolicy;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    invoke-direct {p2, v0, p0, p0}, Lcom/oneplus/support/annotation/GestureBarAdapterPolicy;-><init>(Landroid/os/Handler;Landroid/content/Context;Lcom/oneplus/support/annotation/GestureBarAdapterPolicy$NavigationBarChangeListener;)V

    invoke-virtual {p2, p1}, Lcom/oneplus/support/annotation/GestureBarAdapterPolicy;->bindGestureBarAnnotation(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lcom/oneplus/lib/app/OneplusApplication;->mGesturePolicyMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-boolean p1, p0, Lcom/oneplus/lib/app/OneplusApplication;->mGestureButtonEnabled:Z

    const-string p1, " mGestureButtonEnabled "

    invoke-static {p1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline23(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p0, p0, Lcom/oneplus/lib/app/OneplusApplication;->mGestureButtonEnabled:Z

    const-string p2, "OneplusApplication"

    invoke-static {p1, p0, p2}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline46(Ljava/lang/StringBuilder;ZLjava/lang/String;)V
...
.method public onActivityDestroyed(Landroid/app/Activity;)V
    ...
    iget-object p0, p0, Lcom/oneplus/lib/app/OneplusApplication;->mNavigationBarColor:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string p1, "OneplusApplication"
...
.method public onActivityResumed(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lcom/oneplus/lib/app/OneplusApplication;->mNavigationBarColor:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public onCreate()V
    ...
    const-string v2, "prev_install_versionCode"
    ...
    const-string v1, "Get app version code failed! "
...
.method public onNavigationBarModeChanged(Z)V
    ...
    const-string p1, " onNavigationBarModeChanged "
    ...
    const-string v0, "OneplusApplication"

    invoke-static {p1, p0, v0}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline46(Ljava/lang/StringBuilder;ZLjava/lang/String;)V
...
.method protected onVersionChanged(II)V
    ...
    const-string v1, " previousCode is: "
