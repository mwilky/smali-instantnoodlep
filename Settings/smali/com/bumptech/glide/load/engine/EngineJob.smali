...
.method declared-synchronized addCallback(Lcom/bumptech/glide/request/ResourceCallback;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v1, p1}, Lcom/bumptech/glide/R$id;->checkArgument(ZLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method callCallbackOnLoadFailed(Lcom/bumptech/glide/request/ResourceCallback;)V
    ...
    :try_start_1
    invoke-virtual {p1, p0}, Lcom/bumptech/glide/request/SingleRequest;->onLoadFailed(Lcom/bumptech/glide/load/engine/GlideException;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method callCallbackOnResourceReady(Lcom/bumptech/glide/request/ResourceCallback;)V
    ...
    :try_start_1
    invoke-virtual {p1, v0, p0}, Lcom/bumptech/glide/request/SingleRequest;->onResourceReady(Lcom/bumptech/glide/load/engine/Resource;Lcom/bumptech/glide/load/DataSource;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method decrementPendingCallbacks()V
    ...
    invoke-static {v0, v1}, Lcom/bumptech/glide/R$id;->checkArgument(ZLjava/lang/String;)V
