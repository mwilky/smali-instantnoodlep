...
.method getOrientation(Landroid/net/Uri;)I
    ...
    invoke-static {v2, v1, p0}, Lcom/bumptech/glide/R$id;->getOrientation(Ljava/util/List;Ljava/io/InputStream;Lcom/bumptech/glide/load/engine/bitmap_recycle/ArrayPool;)I
...
.method public open(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    :cond_3
    iget-object v3, p0, Lcom/bumptech/glide/load/data/mediastore/ThumbnailStreamOpener;->service:Lcom/bumptech/glide/load/data/mediastore/FileService;

    invoke-virtual {v3, v0}, Lcom/bumptech/glide/load/data/mediastore/FileService;->get(Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    iget-object v3, p0, Lcom/bumptech/glide/load/data/mediastore/ThumbnailStreamOpener;->service:Lcom/bumptech/glide/load/data/mediastore/FileService;

    invoke-virtual {v3, v0}, Lcom/bumptech/glide/load/data/mediastore/FileService;->exists(Ljava/io/File;)Z
    ...
    invoke-virtual {v5, v0}, Lcom/bumptech/glide/load/data/mediastore/FileService;->length(Ljava/io/File;)J
