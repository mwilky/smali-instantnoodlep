...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/android/settingslib/wifi/WifiTracker$WifiListener;)V
    .locals 8
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settingslib/wifi/WifiTracker$WifiListener;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V
    .locals 8
...
.method private requestScoresForNetworkKeys(Ljava/util/Collection;)V
    ...
    const-string v0, "Requesting scores for Network Keys: "
...
.method private updateAccessPoints(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {v10}, Lcom/android/settingslib/wifi/AccessPoint;->getSecurity(Landroid/net/wifi/ScanResult;)I
    ...
    invoke-static {v8}, Lcom/android/settingslib/wifi/AccessPoint;->getKey(Landroid/net/wifi/ScanResult;)Ljava/lang/String;

    move-result-object v8

    invoke-direct {p0, v3, v8}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    invoke-direct {v8, v9, p2}, Lcom/android/settingslib/wifi/AccessPoint;-><init>(Landroid/content/Context;Ljava/util/Collection;)V

    goto :goto_b

    :cond_15
    invoke-virtual {v8, p2}, Lcom/android/settingslib/wifi/AccessPoint;->setScanResults(Ljava/util/Collection;)V
    ...
    iget-object p2, p0, Lcom/android/settingslib/wifi/WifiTracker;->mLastNetworkInfo:Landroid/net/NetworkInfo;
    ...
    invoke-virtual {v8, v1, p2, v9}, Lcom/android/settingslib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Z
    ...
    invoke-virtual {v0, p2, v8}, Lcom/android/settingslib/wifi/WifiTracker$Multimap;->put(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private updateNetworkInfo(Landroid/net/NetworkInfo;)V
    ...
    const-string v0, "mLastNetworkInfo set: "
    ...
    const-string v0, "mLastInfo set as: "
...
.method getCachedOrCreate(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    const-string p0, "getCachedOrCreate Create AccessPoint, ssid :"
...
.method public onStart()V
    ...
    invoke-static {v0, v4, v1, v2}, Landroid/provider/Settings$Global;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J
...
.method updateOsuAccessPoints(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, p2, v5}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
