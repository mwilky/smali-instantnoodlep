...
.method public getDefaultAppLabel()Ljava/lang/CharSequence;
    ...
    invoke-static {v0, v2}, Lcom/android/settings/applications/defaultapps/DefaultBrowserPreferenceController;->getCandidates(Landroid/content/pm/PackageManager;I)Ljava/util/List;
...
.method getOnlyAppIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v3, v2, v6}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;

    move-result-object v2
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    const-string v4, "Getting icon for the only browser app: "
    ...
    :catch_0
    const-string p0, "Error getting app info for "

    invoke-static {p0, v3, v0}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline41(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
