...
.method private onReceivedSizes()V
    ...
    instance-of v6, v5, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$ResultHandler;

    if-eqz v6, :cond_3

    check-cast v5, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$ResultHandler;

    invoke-interface {v5, v2}, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$ResultHandler;->handleResult(Landroid/util/SparseArray;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    new-instance p1, Lcom/android/settings/deviceinfo/storage/CachedStorageValuesHelper;
    ...
    invoke-direct {p1, p2, v0}, Lcom/android/settings/deviceinfo/storage/CachedStorageValuesHelper;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, p2}, Landroid/app/usage/StorageStatsManager;->isQuotaSupported(Ljava/lang/String;)Z
