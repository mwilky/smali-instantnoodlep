...
.method private stopBackgroundWorker(Landroid/net/Uri;)V
    ...
    const-string v1, "Stopping background worker for: "

    const-string v2, "SettingsSliceProvider"

    invoke-static {v1, p1, v2}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline35(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public onBindSlice(Landroid/net/Uri;)Landroidx/slice/Slice;
    ...
    :try_start_2
    invoke-virtual {v1, p0, p1}, Lcom/android/settings/slices/SlicesFeatureProviderImpl;->getSliceableFromUri(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/settings/slices/CustomSliceable;
    ...
    :try_start_4
    invoke-virtual {v1, p0}, Lcom/android/settings/slices/SlicesFeatureProviderImpl;->getNewWifiCallingSliceHelper(Landroid/content/Context;)Lcom/android/settings/wifi/calling/WifiCallingSliceHelper;
    ...
    :try_start_8
    invoke-virtual {v1, p0}, Lcom/android/settings/slices/SlicesFeatureProviderImpl;->getNewEnhanced4gLteSliceHelper(Landroid/content/Context;)Lcom/android/settings/network/telephony/Enhanced4gLteSliceHelper;
...
.method public onSlicePinned(Landroid/net/Uri;)V
    ...
    invoke-virtual {v1, v0, p1}, Lcom/android/settings/slices/SlicesFeatureProviderImpl;->getSliceableFromUri(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/settings/slices/CustomSliceable;
