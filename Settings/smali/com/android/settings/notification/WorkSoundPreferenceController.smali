...
.method private disableWorkSyncSettings()V
    ...
    iget-object v2, p0, Lcom/android/settings/notification/WorkSoundPreferenceController;->mWorkPhoneRingtonePreference:Landroidx/preference/Preference;

    if-eqz v2, :cond_1

    invoke-direct {p0, v0, v1}, Lcom/android/settings/notification/WorkSoundPreferenceController;->updateRingtoneName(Landroid/content/Context;I)Ljava/lang/CharSequence;
...
.method private updateWorkPreferences()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/RingtonePreference;->setUserId(I)V
