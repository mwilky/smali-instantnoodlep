...
.method protected getItems(Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/settings/AppWidgetLoader;->putAppWidgetItems(Ljava/util/List;Ljava/util/List;Ljava/util/List;IZ)V

    if-eqz v1, :cond_0

    invoke-virtual {p0, v8, p1}, Lcom/android/settings/AppWidgetLoader;->putCustomAppWidgets(Ljava/util/List;Landroid/content/Intent;)V
...
.method putCustomAppWidgets(Ljava/util/List;Landroid/content/Intent;)V
    ...
    :cond_2
    :goto_1
    const-string p2, "error using EXTRA_CUSTOM_INFO index="

    invoke-static {p2, v5, v1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline32(Ljava/lang/String;ILjava/lang/String;)V
    ...
    :cond_7
    :goto_3
    const-string p2, "error using EXTRA_CUSTOM_EXTRAS index="

    invoke-static {p2, v4, v1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline32(Ljava/lang/String;ILjava/lang/String;)V
