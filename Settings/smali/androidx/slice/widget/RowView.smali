...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Landroidx/slice/view/R$id;->tintIndeterminateProgressBar(Landroid/content/Context;Landroid/widget/ProgressBar;)V
...
.method private addItem(Landroidx/slice/SliceItem;IZ)Z
    ...
    invoke-static {p2, v4, v5}, Landroidx/slice/view/R$id;->getTimestampString(Landroid/content/Context;J)Ljava/lang/CharSequence;
...
.method private addSubtitle(Z)V
    ...
    invoke-static {v3, v2}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline14(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private populateViews(Z)V
    ...
    invoke-direct {p0, v2, v6, v0}, Landroidx/slice/widget/RowView;->addItem(Landroidx/slice/SliceItem;IZ)Z
    ...
    invoke-virtual {v7}, Landroidx/slice/widget/SliceStyle;->getTitleColor()I
    ...
    invoke-virtual {v6}, Landroidx/slice/widget/RowContent;->hasBottomDivider()Z
    ...
    iput-object v4, p0, Landroidx/slice/widget/RowView;->mRowAction:Landroidx/slice/core/SliceActionImpl;
    ...
    invoke-direct {p0, v4, v0}, Landroidx/slice/widget/RowView;->setViewClickable(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v0, v4}, Landroidx/slice/core/SliceQuery;->findSubtype(Landroidx/slice/SliceItem;Ljava/lang/String;Ljava/lang/String;)Landroidx/slice/SliceItem;
    ...
    invoke-direct {v0, v2, v5, v4}, Landroid/widget/ProgressBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget v4, p0, Landroidx/slice/widget/RowView;->mRangeMinValue:I
    ...
    iput-object v0, p0, Landroidx/slice/widget/RowView;->mRangeBar:Landroid/widget/ProgressBar;
...
.method private setViewClickable(Landroid/view/View;Z)V
    ...
    invoke-static {p0, v0}, Landroidx/slice/view/R$id;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private updateEndItems()V
    ...
    invoke-direct {p0, v8, v11, v1}, Landroidx/slice/widget/RowView;->addItem(Landroidx/slice/SliceItem;IZ)Z
    ...
    invoke-static {v5, v7, v2, v2}, Landroidx/slice/core/SliceQuery;->find(Landroidx/slice/Slice;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Landroidx/slice/SliceItem;
    ...
    invoke-virtual {v3}, Landroidx/slice/widget/RowContent;->hasActionDivider()Z
    ...
    invoke-direct {p0, v0, v10}, Landroidx/slice/widget/RowView;->setViewClickable(Landroid/view/View;Z)V
...
.method public setStyle(Landroidx/slice/widget/SliceStyle;)V
    ...
    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getTitleItemEndPadding()I
    ...
    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getContentStartPadding()I

    move-result v1

    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getContentEndPadding()I
    ...
    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getEndItemStartPadding()I

    move-result v1

    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getEndItemEndPadding()I
    ...
    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getBottomDividerStartPadding()I

    move-result v1

    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getBottomDividerEndPadding()I
    ...
    :cond_2
    iget-object p0, p0, Landroidx/slice/widget/RowView;->mActionDivider:Landroid/view/View;

    invoke-virtual {p1}, Landroidx/slice/widget/RowStyle;->getActionDividerHeight()I
