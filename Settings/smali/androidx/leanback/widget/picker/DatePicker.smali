...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p3, v0}, Landroidx/leanback/widget/picker/PickerUtility;->getDateConstantInstance(Ljava/util/Locale;Landroid/content/res/Resources;)Landroidx/leanback/widget/picker/PickerUtility$DateConstant;

    move-result-object p3

    iput-object p3, p0, Landroidx/leanback/widget/picker/DatePicker;->mConstant:Landroidx/leanback/widget/picker/PickerUtility$DateConstant;
    ...
    invoke-virtual {p3, v0}, Landroidx/leanback/widget/picker/PickerColumn;->setStaticLabels([Ljava/lang/CharSequence;)V

    iget p3, p0, Landroidx/leanback/widget/picker/DatePicker;->mColMonthIndex:I

    iget-object v0, p0, Landroidx/leanback/widget/picker/DatePicker;->mMonthColumn:Landroidx/leanback/widget/picker/PickerColumn;

    invoke-virtual {p0, p3, v0}, Landroidx/leanback/widget/picker/Picker;->setColumnAt(ILandroidx/leanback/widget/picker/PickerColumn;)V
    ...
    invoke-virtual {p2, v3, v4, v0}, Ljava/util/Calendar;->set(III)V
    ...
    invoke-direct {p0, v1, p2}, Landroidx/leanback/widget/picker/DatePicker;->parseDate(Ljava/lang/String;Ljava/util/Calendar;)Z
    ...
    invoke-virtual {p2, p3, v4, v0}, Ljava/util/Calendar;->set(III)V
    ...
    :cond_6
    invoke-virtual {p0, v2}, Landroidx/leanback/widget/picker/DatePicker;->setDatePickerFormat(Ljava/lang/String;)V
...
.method updateSpinnersImpl(Z)V
    ...
    invoke-virtual {v7}, Landroidx/leanback/widget/picker/PickerColumn;->getMinValue()I

    move-result v9

    if-eq v8, v9, :cond_1

    invoke-virtual {v7, v8}, Landroidx/leanback/widget/picker/PickerColumn;->setMinValue(I)V
    ...
    invoke-virtual {v7}, Landroidx/leanback/widget/picker/PickerColumn;->getMaxValue()I

    move-result v10

    if-eq v9, v10, :cond_3

    invoke-virtual {v7, v9}, Landroidx/leanback/widget/picker/PickerColumn;->setMaxValue(I)V
