...
.method private moveFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_0
    invoke-virtual {v6, v0}, Landroidx/collection/SparseArrayCompat;->get(I)Ljava/lang/Object;
    ...
    iget v10, p0, Landroidx/customview/widget/ExploreByTouchHelper;->mKeyboardFocusedVirtualViewId:I

    if-eq v10, v7, :cond_3

    invoke-virtual {p0, v10}, Landroidx/customview/widget/ExploreByTouchHelper;->obtainAccessibilityNodeInfo(I)Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;

    move-result-object p2

    invoke-virtual {p2, v9}, Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;->getBoundsInParent(Landroid/graphics/Rect;)V
    ...
    :goto_3
    sget-object v8, Landroidx/customview/widget/ExploreByTouchHelper;->SPARSE_VALUES_ADAPTER:Landroidx/customview/widget/FocusStrategy$CollectionAdapter;

    sget-object v9, Landroidx/customview/widget/ExploreByTouchHelper;->NODE_ADAPTER:Landroidx/customview/widget/FocusStrategy$BoundsAdapter;

    check-cast v8, Landroidx/customview/widget/ExploreByTouchHelper$2;

    invoke-virtual {v8, v6}, Landroidx/customview/widget/ExploreByTouchHelper$2;->size(Ljava/lang/Object;)I
    ...
    invoke-virtual {v8, v6, v4}, Landroidx/customview/widget/ExploreByTouchHelper$2;->get(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    :cond_b
    new-instance v4, Landroidx/customview/widget/FocusStrategy$SequentialComparator;

    invoke-direct {v4, p2, v9}, Landroidx/customview/widget/FocusStrategy$SequentialComparator;-><init>(ZLandroidx/customview/widget/FocusStrategy$BoundsAdapter;)V
    ...
    :cond_11
    invoke-virtual {v6, p1}, Landroidx/collection/SparseArrayCompat;->indexOfValue(Ljava/lang/Object;)I

    move-result p1

    invoke-virtual {v6, p1}, Landroidx/collection/SparseArrayCompat;->keyAt(I)I
...
.method private performActionForChild(IILandroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p2}, Landroidx/customview/widget/ExploreByTouchHelper;->clearAccessibilityFocus(I)Z
...
.method public final dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v4, v6}, Landroidx/customview/widget/ExploreByTouchHelper;->sendEventForVirtualView(II)Z
    ...
    invoke-virtual {p0, v0, v5}, Landroidx/customview/widget/ExploreByTouchHelper;->sendEventForVirtualView(II)Z
...
.method public final invalidateVirtualView(II)V
    ...
    invoke-direct {p0, p1, v1}, Landroidx/customview/widget/ExploreByTouchHelper;->createEventForChild(II)Landroid/view/accessibility/AccessibilityEvent;
