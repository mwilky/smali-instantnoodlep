...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mListView:Landroid/widget/ListView;

    new-instance p2, Lcom/oneplus/settings/quicklaunch/OPApplicationListAdapter;

    iget-object p3, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mContext:Landroid/content/Context;

    iget-object v0, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mAppList:Ljava/util/List;

    invoke-direct {p2, p3, v0}, Lcom/oneplus/settings/quicklaunch/OPApplicationListAdapter;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mOPApplicationListAdapter:Lcom/oneplus/settings/quicklaunch/OPApplicationListAdapter;

    iget-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mListView:Landroid/widget/ListView;

    iget-object p3, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mOPApplicationListAdapter:Lcom/oneplus/settings/quicklaunch/OPApplicationListAdapter;
    ...
    iput-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mLoadingContainer:Landroid/view/View;
    ...
    iput-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mEmptyView:Landroid/view/View;

    iget-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mOPApplicationLoader:Lcom/oneplus/settings/apploader/OPApplicationLoader;

    iget-object p3, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mLoadingContainer:Landroid/view/View;

    invoke-virtual {p2, p3}, Lcom/oneplus/settings/apploader/OPApplicationLoader;->setmLoadingContainer(Landroid/view/View;)V

    iget-object p2, p0, Lcom/oneplus/settings/quicklaunch/OPQuickLaunchAppFragment;->mOPApplicationLoader:Lcom/oneplus/settings/apploader/OPApplicationLoader;

    const/4 p3, 0x0

    invoke-virtual {p2, p3}, Lcom/oneplus/settings/apploader/OPApplicationLoader;->setNeedLoadWorkProfileApps(Z)V
    ...
    invoke-virtual {p2, p3, p0}, Lcom/oneplus/settings/apploader/OPApplicationLoader;->initData(ILandroid/os/Handler;)V
