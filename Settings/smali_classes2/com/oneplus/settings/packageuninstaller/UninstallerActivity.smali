...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v5, v7, v4, v2}, Landroid/app/AppOpsManager;->noteOpNoThrow(Ljava/lang/String;ILjava/lang/String;)I
    ...
    :try_start_1
    invoke-virtual {v2, v10, v6}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-interface {v2, v0, v4}, Landroid/content/pm/IPackageManager;->checkUidPermission(Ljava/lang/String;I)I
    ...
    invoke-interface {v2, p1, v4}, Landroid/content/pm/IPackageManager;->checkUidPermission(Ljava/lang/String;I)I
    ...
    const-string p1, "Invalid package name in URI: "

    invoke-static {p1, v0, v1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline36(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v3, v6, p1}, Landroid/content/pm/IPackageManager;->getActivityInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ActivityInfo;
    ...
    new-instance p1, Lcom/oneplus/settings/packageuninstaller/UninstallAlertFragment;

    invoke-direct {p1}, Lcom/oneplus/settings/packageuninstaller/UninstallAlertFragment;-><init>()V

    invoke-direct {p0, p1, v6, v6}, Lcom/oneplus/settings/packageuninstaller/UninstallerActivity;->showContentFragment(Landroid/app/Fragment;II)V

    goto :goto_5

    :cond_d
    new-instance p1, Lcom/oneplus/settings/packageuninstaller/UninstallAlertDialogFragment;

    invoke-direct {p1}, Lcom/oneplus/settings/packageuninstaller/UninstallAlertDialogFragment;-><init>()V

    invoke-direct {p0, p1, v6, v6}, Lcom/oneplus/settings/packageuninstaller/UninstallerActivity;->showDialogFragment(Landroid/app/DialogFragment;II)V
