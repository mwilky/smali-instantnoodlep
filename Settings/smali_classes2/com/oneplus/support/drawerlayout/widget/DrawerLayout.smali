...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->CAN_HIDE_DESCENDANTS:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mMinDrawerMargin:I

    const/high16 v1, 0x43c80000    # 400.0f

    mul-float/2addr v1, v0

    new-instance v2, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    invoke-direct {v2, p0, p3}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;-><init>(Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;I)V

    iput-object v2, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mLeftCallback:Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    new-instance p3, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;

    const/4 v2, 0x5

    invoke-direct {p3, p0, v2}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;-><init>(Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;I)V
    ...
    invoke-static {p0, v2, p3}, Lcom/oneplus/lib/util/ViewDragHelper;->create(Landroid/view/ViewGroup;FLcom/oneplus/lib/util/ViewDragHelper$Callback;)Lcom/oneplus/lib/util/ViewDragHelper;
    ...
    invoke-virtual {p3, v1}, Lcom/oneplus/lib/util/ViewDragHelper;->setMinVelocity(F)V
    ...
    invoke-virtual {p3, v3}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;->setDragger(Lcom/oneplus/lib/util/ViewDragHelper;)V
    ...
    invoke-virtual {p3, v2}, Lcom/oneplus/lib/util/ViewDragHelper;->setEdgeTrackingEnabled(I)V
    ...
    invoke-virtual {p3, v1}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$ViewDragCallback;->setDragger(Lcom/oneplus/lib/util/ViewDragHelper;)V
...
.method public addDrawerListener(Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$DrawerListener;)V
    ...
    :cond_1
    iget-object p0, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mListeners:Ljava/util/List;
...
.method public closeDrawer(Landroid/view/View;Z)V
    ...
    invoke-static {p2, p1, v0}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline15(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildHitRect:Landroid/graphics/Rect;
    ...
    iput-object v5, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildHitRect:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildInvertedMatrix:Landroid/graphics/Matrix;
    ...
    iput-object v6, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildInvertedMatrix:Landroid/graphics/Matrix;
    ...
    iget-object v5, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildInvertedMatrix:Landroid/graphics/Matrix;
...
.method findDrawerWithGravity(I)Landroid/view/View;
    ...
    invoke-static {p1, v0}, Lcom/oneplus/lib/app/appcompat/MenuWrapperFactory;->getAbsoluteGravity(II)I
...
.method public getDrawerElevation()F
    ...
    iget p0, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mDrawerElevation:F
...
.method public getDrawerLockMode(Landroid/view/View;)I
    ...
    invoke-static {v0, p1, v1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline15(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method getDrawerViewAbsoluteGravity(Landroid/view/View;)I
    ...
    invoke-static {p1, p0}, Lcom/oneplus/lib/app/appcompat/MenuWrapperFactory;->getAbsoluteGravity(II)I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mStatusBarBackground:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v1, v1, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$LayoutParams;->isPeeking:Z
...
.method protected onMeasure(II)V
    ...
    check-cast v11, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$LayoutParams;

    const/4 v12, 0x3

    if-eqz v1, :cond_c

    iget v13, v11, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout$LayoutParams;->gravity:I

    invoke-static {v13, v5}, Lcom/oneplus/lib/app/appcompat/MenuWrapperFactory;->getAbsoluteGravity(II)I

    move-result v13

    invoke-static {v10}, Lcom/oneplus/support/core/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
    ...
    iget-object v14, v0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mLastInsets:Ljava/lang/Object;
    ...
    iget-object v12, v0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mLastInsets:Ljava/lang/Object;
    ...
    :cond_c
    :goto_6
    invoke-virtual {v0, v10}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->isContentView(Landroid/view/View;)Z
    ...
    :cond_d
    invoke-virtual {v0, v10}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->isDrawerView(Landroid/view/View;)Z

    move-result v12

    if-eqz v12, :cond_16

    sget-boolean v12, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->SET_DRAWER_SHADOW_FROM_ELEVATION:Z
    ...
    iget v13, v0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mDrawerElevation:F
    ...
    :cond_e
    invoke-virtual {v0, v10}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->getDrawerViewAbsoluteGravity(Landroid/view/View;)I
    ...
    :goto_9
    iget v7, v0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mMinDrawerMargin:I
...
.method public onRtlPropertiesChanged(I)V
    ...
    sget-boolean p1, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->SET_DRAWER_SHADOW_FROM_ELEVATION:Z
    ...
    iget-object v0, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowStart:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_2

    invoke-direct {p0, v0, p1}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mirror(Landroid/graphics/drawable/Drawable;I)Z

    iget-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowStart:Landroid/graphics/drawable/Drawable;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowEnd:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_2

    invoke-direct {p0, v0, p1}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mirror(Landroid/graphics/drawable/Drawable;I)Z

    iget-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowEnd:Landroid/graphics/drawable/Drawable;

    goto :goto_0

    :cond_2
    iget-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowLeft:Landroid/graphics/drawable/Drawable;

    :goto_0
    iput-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowLeftResolved:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iget-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowRight:Landroid/graphics/drawable/Drawable;

    :goto_1
    iput-object p1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mShadowRightResolved:Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mChildrenCanceledTouch:Z
...
.method public setDrawerElevation(F)V
    ...
    invoke-virtual {p0, v0}, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->isDrawerView(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget v1, p0, Lcom/oneplus/support/drawerlayout/widget/DrawerLayout;->mDrawerElevation:F

    invoke-static {v0, v1}, Lcom/oneplus/support/core/view/ViewCompat;->setElevation(Landroid/view/View;F)V
...
.method public setDrawerLockMode(II)V
    ...
    invoke-static {p2, v0}, Lcom/oneplus/lib/app/appcompat/MenuWrapperFactory;->getAbsoluteGravity(II)I
